...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
	    ...
	    <legend align=left><font style=\"color:black;font-style:italic;font-size:0.825em;\">[user: $_COOKIE[nama], $_COOKIE[gelar]]</font></legend>";
			echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">EDIT FORMULIR PENILAIAN DOPS<br>(Directly Observed Procedural Skill)</font></h4>";
			...
			echo "<tr>";
				...
				echo "<td><textarea name=\"lokasi\" value=\"$data_dops[lokasi]\" style=\"width:97%;font-family:Tahoma;font-size:1em\" required>$data_dops[lokasi]</textarea></td>";
			echo "</tr>";
			...
			echo "<tr>";
				...
				echo "<td><input type=\"text\" name=\"tgl_mulai\" class=\"tgl_mulai\" value=\"$data_dops[tgl_mulai]\" style=\"font-size:0.85em\" required/></td>";
			echo "</tr>";
			//Tgl selesai kegiatan
			echo "<tr>";
				echo "<td>Tanggal selesai kegiatan (yyyy-mm-dd)</td>";
				echo "<td><input type=\"text\" name=\"tgl_selesai\" class=\"tgl_selesai\" value=\"$data_dops[tgl_selesai]\" style=\"font-size:0.85em\" required/></td>";
			echo "</tr>";
			//Dokter Pembimbing
			echo "<tr>";
