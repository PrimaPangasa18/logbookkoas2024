...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR NILAI PORTOFOLIO LAPORAN KASUS<p>Kedokteran Keluarga dengan Kunjungan Rumah</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td style=\"width:60%\"><textarea name=\"lokasi\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Lokasi Kegiatan Kepaniteraan KDK >>\" required></textarea></td>";
		echo "</tr>";
		...
		echo "<tr>";
			echo "<td>Kasus</td>";
			echo "<td>";
			echo "<select class=\"select_art\" name=\"kasus\" id=\"kasus\" required>";
			echo "<option value=\"\"><< Pilihan Kasus >></option>";
			echo "<option value=\"Ibu\">Ibu</option>";
			echo "<option value=\"Bayi/Balita\">Bayi/Balita</option>";
			echo "<option value=\"Remaja\">Remaja</option>";
			echo "<option value=\"Dewasa\">Dewasa</option>";
			echo "<option value=\"Lansia\">Lansia</option>";
			echo "</select></td>";
		echo "</tr>";
		...
		if ($_POST[usulkan]=="USULKAN")
		{
			...
			$insert_kasus=mysqli_query($con,"INSERT INTO `kdk_nilai_kasus`
				...
				VALUES
				( '$_POST[nim]', '$_POST[dosen]', '$lokasi', '$_POST[tgl_mulai]','$_POST[tgl_selesai]','$_POST[kasus]',
