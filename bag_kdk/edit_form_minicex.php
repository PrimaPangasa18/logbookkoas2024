	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT PENILAIAN MINI-CEX</h2>
						<br>
						<?php
						$id = $_GET['id'];
						$id_state = "M121";
						...
						echo "<option value=\"$data_minicex[instansi]\">$data_minicex[instansi]</option>";
						if ($data_minicex['instansi'] != "Puskesmas") echo "<option value=\"Puskesmas\">Puskesmas</option>";
						if ($data_minicex['instansi'] != "Klinik Pratama") echo "<option value=\"Klinik Pratama\">Klinik Pratama</option>";
						echo "</select></td>";
						echo "</tr>";
						//Lokasi Puskesmas/Klinik
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Nama Puskesmas / Klinik Pratama</strong></td>";
						echo "<td><textarea name=\"lokasi\" style=\" width: 100%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" value=\"$data_minicex[lokasi]\" required>$data_minicex[lokasi]</textarea></td>";
						echo "</tr>";
						//DPJP
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						...
						$dosen_db = mysqli_fetch_array(mysqli_query($con, "SELECT `nip`,`nama`,`gelar` FROM `dosen` WHERE `nip`='$data_minicex[dosen]'"));
						$dosen = mysqli_query($con, "SELECT `username`,`nama` FROM `admin` WHERE `level`='4' OR (`level`='6' AND `stase`='$id_stase') ORDER BY `nama`");
						echo "<option value=\"$data_minicex[dosen]\">$dosen_db[nama], $dosen_db[gelar] ($dosen_db[nip])</option>";
			...
			";
				...
				`dosen`='$_POST[dosen]',`no_ujian`='$_POST[no_ujian]',
