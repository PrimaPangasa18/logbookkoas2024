...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">EDIT PENILAIAN MINI-CEX</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"lokasi\" value=\"$data_minicex[lokasi]\" style=\"width:97%;font-family:Tahoma;font-size:1em\" required>$data_minicex[lokasi]</textarea></td>";
		echo "</tr>";
		//DPJP
		echo "<tr>";
