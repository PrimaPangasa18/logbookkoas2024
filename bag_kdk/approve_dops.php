		...
		<div class="main">
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">APPROVAL PENILAIAN DOPS<br>(DIRECTLY OBSERVED PROCEDURAL SKILL)</h2>
						<br>
						<?php
						$id = $_GET['id'];
						$id_stase = "M121";
						...
						echo "<td style=\"width:60%; font-weight:600;\">$data_dops[instansi]</td>";
						echo "</tr>";
						//Lokasi Puskesmas/Klinik
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Nama Puskesmas / Klinik Pratama</strong></td>";
						echo "<td style=\"font-weight:600;\">$data_dops[lokasi]</td>";
						echo "</tr>";
			...
			";
						...
						if ($_POST['approve'] == "APPROVE") {
							$dops = mysqli_fetch_array(mysqli_query($con, "SELECT `dosen` FROM `kdk_nilai_dops` WHERE `id`='$_POST[id]'"));
							$user_dosen = mysqli_fetch_array(mysqli_query($con, "SELECT `password` FROM `admin` WHERE `username`='$dops[dosen]'"));
							$data_dosen = mysqli_fetch_array(mysqli_query($con, "SELECT `pin`,`qr` FROM `dosen` WHERE `nip`='$dops[dosen]'"));
