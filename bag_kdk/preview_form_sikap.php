...
<head>
	...
	<title>On-line Preview Sikap Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('../images/undip_watermark_color.png'), url('../images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PREVIEW NILAI SIKAP/PERILAKU</h2>
						<br>
						<?php
						$id = $_GET['id'];
						...
						echo "<td style=\"width:60%; font-weight:600;\">$data_sikap[instansi]</td>";
						echo "</tr>";
						//Lokasi Puskesmas/Klinik
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Nama Puskesmas / Klinik Pratama</strong></td>";
						echo "<td style=\"font-weight:600;\">$data_sikap[lokasi]</td>";
						echo "</tr>";
						...
						echo "<td><strong>DISIPLIN</strong><br><span style=\"font-weight:600; font-size:0.9em; color:red;\">(tepat waktu, mengikuti tata tertib)</span></td>";
						echo "<td align=center><strong>15%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_sikap[aspek_1]</td>";
						echo "</tr>";
						//No 2
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>2</strong></td>";
						echo "<td><strong>KERJASAMA</strong><br><span style=\"font-weight:600; font-size:0.9em; color:red;\">(dengan teman, pembimbing dan tenaga kesehatan lain)</span></td>";
						echo "<td align=center><strong>15%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_sikap[aspek_2]</td>";
						echo "</tr>";
						//No 3
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>3</strong></td>";
						echo "<td><strong>KETELITIAN</strong></td>";
						echo "<td align=center><strong>15%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_sikap[aspek_3]</td>";
						echo "</tr>";
						//No 4
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>4</strong></td>";
						echo "<td><strong>INISIATIF / KREATIVITAS</strong><br><span style=\"font-weight:600; font-size:0.9em; color:red;\">(mengambil keputusan, menyelesaikan masalan, dll)</span></td>";
						echo "<td align=center><strong>15%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_sikap[aspek_4]</td>";
						echo "</tr>";
						//No 5
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>5</strong></td>";
						echo "<td><strong>SOPAN SANTUN<br></strong><span style=\"font-weight:600; font-size:0.9em; color:red;\">(dengan pasien, pengunjung dan tenaga kesehatan lain)</span></td>";
						echo "<td align=center><strong>15%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_sikap[aspek_5]</td>";
						echo "</tr>";
						//No 6
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>6</strong></td>";
						echo "<td><strong>TANGGUNG JAWAB</strong><br><span style=\"font-weight:600; font-size:0.9em; color:red;\">(menyelesaikan tugas kelompok, tugas individu dan tugas lain dari pembimbing)</span></td>";
						echo "<td align=center><strong>15%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_sikap[aspek_6]</td>";
						echo "</tr>";
						//No 7
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>7</strong></td>";
						echo "<td><strong>KERAMAHAN<br></strong><span style=\"font-weight:600; font-size:0.9em; color:red;\">(dengan pasien, pengunjung dan tenaga kesehatan lain)</span></td>";
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_sikap[aspek_7]</td>";
						echo "</tr>";
						//Rata-Rata Nilai
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=3 align=right><strong>Rata-Rata Nilai <span class=\"text-danger\">(Jumlah Bobot x Nilai)</span></strong></td>";
						echo "<td align=center style=\"font-weight:600; color:blue;\">$data_sikap[nilai_rata]</td>";
						echo "</tr>";
						echo "</table><br>";
						...
						<textarea name=\"umpan_balik\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_sikap[umpan_balik]</textarea></td>";
						echo "</tr>";
						echo "<tr  class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Saran:</strong><br>
						<textarea name=\"saran\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_sikap[saran]</textarea></td>";
						echo "</tr>";
