...
<head>
	...
	<title>On-line Edit Laporan Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI PORTOFOLIO LAPORAN KASUS<br>KEDOKTERAN KELUARGA DENGAN KUNJUNGAN RUMAH</h2>
						<br>
						<?php
						$id_stase = "M121";
						$id = $_GET['id'];
						...
						echo "<td style=\"width:60%\"><textarea name=\"lokasi\" value=\"$data_kasus[lokasi]\" style=\" width: 100%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" required>$data_kasus[lokasi]</textarea></td>";
						echo "</tr>";
						...
						<input type=\"text\" class=\"form-select tgl_mulai\" name=\"tgl_mulai\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" value=\"$data_kasus[tgl_mulai]\" /></td>";
						echo "</tr>";
						//Tgl selesai kegiatan
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Tanggal selesai kegiatan <span class=\"text-danger\">(yyyy-mm-dd)</span></strong></td>";
						echo "<td class=\"td_mid\">
						<input type=\"text\" class=\"form-select tgl_selesai\" name=\"tgl_selesai\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" value=\"$data_kasus[tgl_selesai]\" /></td>";
						echo "</tr>";
						//Pilihan Kasus
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Kasus</strong></td>";
						echo "<td style=\"font-weight:600;\">";
						echo "<select class=\"form-select\" name=\"kasus\" id=\"kasus\" required>";
						echo "<option value=\"$data_kasus[kasus]\">$data_kasus[kasus]</option>";
						if ($data_kasus['kasus'] != "Ibu") echo "<option value=\"Ibu\">Ibu</option>";
						if ($data_kasus['kasus'] != "Bayi/Balita") echo "<option value=\"Bayi/Balita\">Bayi/Balita</option>";
						if ($data_kasus['kasus'] != "Remaja") echo "<option value=\"Remaja\">Remaja</option>";
						if ($data_kasus['kasus'] != "Dewasa") echo "<option value=\"Dewasa\">Dewasa</option>";
						if ($data_kasus['kasus'] != "Lansia") echo "<option value=\"Lansia\">Lansia</option>";
						echo "</select></td>";
						echo "</tr>";
						...
						$data_dosen_db = mysqli_fetch_array(mysqli_query($con, "SELECT `nip`,`nama`,`gelar` FROM `dosen` WHERE `nip`='$data_kasus[dosen]'"));
						echo "<option value=\"$data_kasus[dosen]\">$data_dosen_db[nama], $data_dosen_db[gelar] ($data_dosen_db[nip])</option>";
				...
				`nim`='$_POST[nim]',`dosen`='$_POST[dosen]',`lokasi`='$lokasi',`tgl_mulai`='$_POST[tgl_mulai]',`tgl_selesai`='$_POST[tgl_selesai]',`kasus`='$_POST[kasus]',
