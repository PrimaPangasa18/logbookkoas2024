...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<tr>";
			...
			echo "<td style=\"width:60%\"><textarea name=\"lokasi\" value=\"$data_kasus[lokasi]\" style=\"width:97%;font-family:Tahoma;font-size:1em\" required>$data_kasus[lokasi]</textarea></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td><input type=\"text\" name=\"tgl_mulai\" class=\"tgl_mulai\" value=\"$data_kasus[tgl_mulai]\" style=\"font-size:0.85em\" required/></td>";
		echo "</tr>";
		//Tgl selesai kegiatan
		echo "<tr>";
			echo "<td>Tanggal selesai kegiatan (yyyy-mm-dd)</td>";
			echo "<td><input type=\"text\" name=\"tgl_selesai\" class=\"tgl_selesai\" value=\"$data_kasus[tgl_selesai]\" style=\"font-size:0.85em\" required/></td>";
		echo "</tr>";
		//Pilihan Kasus
		echo "<tr>";
			echo "<td>Kasus</td>";
