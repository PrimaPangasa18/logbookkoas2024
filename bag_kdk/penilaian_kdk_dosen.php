...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==4)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">PENILAIAN KEPANITERAAN KEDOKTERAN KELUARGA</font></h4>";
		...
		echo "</center><br><a href=\"#lap_kasus\"><i>Penilaian Laporan Kasus</i></a><br>";
		echo "<a href=\"#sikap\"><i>Penilaian Sikap/Perilaku</i></a><br>";
		echo "<a href=\"#dops\"><i>Penilaian DOPS</i></a><br>";
		echo "<a href=\"#minicex\"><i>Penilaian MINI-CEX</i></a><br>";
		...
		echo "<thead>
					<th style=\"width:5%\">No</th>
					<th style=\"width:15%\">Tanggal Pengisian</th>
					<th style=\"width:20%\">Lokasi / Instansi</th>
