					...
					<div class="mb-3">
						...
						<center>
									...
									<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
										<table class="table table-bordered" style="width: 1000px;">
											<tr class="table-primary" style="border-width: 1px; border-color: #000;">
												<td class="align-middle" style="width: 200px;"><strong>Kepaniteraan <span>(STASE)</span></strong></td>
							...
							if ($_POST['submit'] == "SUBMIT")
								echo "
						<script>
						window.location.href=\"nilai_akhir_umum.php?stase=\"+\"$_POST[stase]\"+\"&angk=\"+\"$_POST[angk_mhsw]\"+\"&grup=\"+\"$_POST[grup]\"+\"&tglawal=\"+\"$_POST[tgl_awal]\"+\"&tglakhir=\"+\"$_POST[tgl_akhir]\";
						</script>
						";
							?>
						</center>
