...
<?php
	...
	{
		include "menu2.php";
		echo "<div class=\"text_header\">TAMBAH DAFTAR KETRAMPILAN</div>";
		echo "<br><br><br><fieldset class=\"fieldset_art\">
	    	<legend align=left><font style=\"color:black;font-style:italic;font-size:0.825em;\">[user: $_COOKIE[nama], $_COOKIE[gelar]]</font></legend>";
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">TAMBAH DAFTAR KETRAMPILAN</font></h4>";
	  ...
	  echo "<textarea name=\"ketrampilan\" rows=\"1\" class=\"select_art\" style=\"border:0.5px solid grey;border-radius:5px;\" placeholder=\"Ketikkan nama ketrampilan\"></textarea>";
	  echo "</td>";
	  echo "</tr>";
