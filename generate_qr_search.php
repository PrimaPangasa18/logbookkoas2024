    ...
    <div class="main">
      ...
      <main class="content px-3 py-4">
        <div class="container-fluid">
          <div class="mb-3">
            <h3 class="fw-bold fs-4 mb-3">GENERATE QR CODE DOSEN/RESIDEN</h3>
            <br>
            <h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">GENERATE QR CODE DOSEN/RESIDEN</h2>
            <br>
            <?php
            ...
            if ($_POST['cari'] == "CARI") {
              ...
              if ($jml >= 1) {
                ...
                while ($data = mysqli_fetch_array($user_kunci)) {
                  ...
                  echo '<td style="text-align:center"><a href="generate_qr_admin.php?user_name=' . urlencode($data_dosen['nip']) . '" class="btn btn-outline-primary">' . htmlspecialchars($data_dosen['nip']) . '</a></td>';
