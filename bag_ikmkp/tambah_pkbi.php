...
<head>
	...
	<title>On-line Tambah PKBI Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI KEGIATAN DI PKBI<br>KEPANITERAAN (STASE) IKM-KP</h2>
						<br>
						<?php
						$id_stase = "M095";
						...
						echo "<form id=\"pkbi\" method=\"POST\" action=\"$_SERVER[PHP_SELF]\">";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_pkbi = mysqli_query($con, "INSERT INTO `ikmkp_nilai_pkbi`
				( `nim`, `dosen`, `aspek_1`, `aspek_2`,
					`aspek_3`, `aspek_4`, `aspek_5`, `nilai_total`,
					`umpan_balik`,`saran`,
					`tgl_isi`,`tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]', '$_POST[dosen]','$aspek1','$aspek2',
					'$aspek3','$aspek4','$aspek5','$total',
					'$umpan_balik','$saran',
					'$tgl','2000-01-01','0')");
