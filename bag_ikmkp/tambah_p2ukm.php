...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR NILAI KEGIATAN DI P2UKM MLONGGO<p>Kepaniteraan (Stase) IKM-KP</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td>";
			echo "<select class=\"select_art\" name=\"penilaian\" id=\"penilaian\" required>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"total\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"total\" value=\"0\" required/></td>";
		echo "</tr>";
		echo "</table><br>";
