...
<head>
	...
	<title>On-line Tambah P2UKM Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI KEGIATAN DI P2UKM MLONGGO<br>KEPANITERAAN (STASE) IKM-KP</h2>
						<br>
						<?php
						$id_stase = "M095";
						...
						echo "<option value=\"\"><< Jenis Penilaian >></option>";
						...
						echo "<option value=\"\"><< Dosen Pembimbing >></option>";
						...
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"total\" style=\"width:55%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"total\" value=\"0\" required disabled/></td>";
						echo "</tr>";
						echo "</table><br>";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_p2ukm = mysqli_query($con, "INSERT INTO `ikmkp_nilai_p2ukm`
				( `nim`, `dosen`, `jenis_penilaian`,`aspek_1`, `aspek_2`,
					`aspek_3`, `aspek_4`, `aspek_5`, `aspek_6`, `aspek_7`,`nilai_total`,
					`umpan_balik`,`saran`,
					`tgl_isi`,`tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]', '$_POST[dosen]','$_POST[penilaian]','$aspek1','$aspek2',
					'$aspek3','$aspek4','$aspek5','$aspek6','$aspek7','$total',
					'$umpan_balik','$saran',
					'$tgl','2000-01-01','0')");
