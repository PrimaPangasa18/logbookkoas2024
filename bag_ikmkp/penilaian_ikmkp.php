...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">FORM PENILAIAN KEPANITERAAN (STASE) IKM-KP</font></h4><br>";
		$id_stase = "M095";
		...
		if ($cek_stase>=1)
		{
			echo "</center><br><a href=\"#pkbi\"><i>Pengisian Formulir Penilaian Kegiatan di PKBI</i></a><br>";
			echo "<a href=\"#p2ukm\"><i>Pengisian Formulir Penilaian Kegiatan di P2UKM</i></a><br>";
			echo "<a href=\"#test\"><i>Preview Nilai Penugasan dan Test</i></a><br>";
			echo "<a href=\"#komprehensip\"><i>Pengisian Formulir Penilaian Ujian Komprehensip</i></a><br><br>";

			//Pengisian Formulir Penilaian Kegiatan di PKBI
			echo "<a id=\"pkbi\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Pengisian Formulir Penilaian Kegiatan di PKBI</font></a><br><br>";
			...
			else
			{
				...
				while ($data_pkbi=mysqli_fetch_array($nilai_pkbi))
				{
					...
					if ($data_pkbi[status_approval]=='0') echo "<a href=\"approve_pkbi.php?id=$data_pkbi[id]\"><input type=\"button\" name=\"approve\".\"$data_pkbi[id]\" style=\"color:red\" value=\"APPROVE\"></a>";
					echo "</td>";
					echo "<td align=center>";
					if ($data_pkbi[status_approval]=='0')
					{
						echo "<font style=\"color:red\">BELUM DISETUJUI</font><br><br>";
						echo "<a href=\"edit_form_pkbi.php?id=$data_pkbi[id]\"><input type=\"button\" class=\"submit2\" name=\"edit\".\"$data_pkbi[id]\" value=\"EDIT\"></a><p>";
						echo "<a href=\"preview_form_pkbi.php?id=$data_pkbi[id]\"><input type=\"button\" class=\"submit2\" name=\"preview\".\"$data_pkbi[id]\" value=\"PREVIEW\"></a><p>";
						echo "<a href=\"hapus_form_pkbi.php?id=$data_pkbi[id]\"><input type=\"button\" class=\"submit2\" name=\"hapus\".\"$data_pkbi[id]\" value=\"HAPUS\"></a>";
					}
					else
					{
						...
						echo "<br><br><a href=\"view_form_pkbi.php?id=$data_pkbi[id]\"><input type=\"button\" class=\"submit2\" name=\"view\".\"$data_pkbi[id]\" value=\"VIEW\"></a><p>";
					}
					echo "</td>";
					echo "</tr>";
					$no++;
			...
			echo "</table>";
			if ($cek_nilai_pkbi<1)
			echo "<br><center><a href=\"tambah_pkbi.php\"><input type=\"button\" class=\"submit1\" name=\"tambah\" value=\"TAMBAH\"></a>";
			...
			echo "<br><center><a href=\"cetak_pkbi.php\" target=\"_BLANK\"><input type=\"button\" class=\"submit1\" name=\"cetak\" value=\"CETAK\"></a>";
			echo "</center><br><br>";

			//Pengisian Formulir Penilaian Kegiatan di P2UKM
			echo "<a id=\"p2ukm\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Pengisian Formulir Penilaian Kegiatan di P2UKM</font></a><br><br>";
			...
			else
			{
				...
				while ($data_p2ukm=mysqli_fetch_array($nilai_p2ukm))
				{
					...
					echo "<td>$data_dosen[nama], $data_dosen[gelar] (NIP. $data_dosen[nip])<br><br>";
					if ($data_p2ukm[status_approval]=='0') echo "<a href=\"approve_p2ukm.php?id=$data_p2ukm[id]\"><input type=\"button\" name=\"approve\".\"$data_p2ukm[id]\" style=\"color:red\" value=\"APPROVE\"></a>";
					echo "</td>";
					echo "<td align=center>";
					if ($data_p2ukm[status_approval]=='0')
					{
						echo "<font style=\"color:red\">BELUM DISETUJUI</font><br><br>";
						echo "<a href=\"edit_form_p2ukm.php?id=$data_p2ukm[id]\"><input type=\"button\" class=\"submit2\" name=\"edit\".\"$data_p2ukm[id]\" value=\"EDIT\"></a><p>";
						echo "<a href=\"preview_form_p2ukm.php?id=$data_p2ukm[id]\"><input type=\"button\" class=\"submit2\" name=\"preview\".\"$data_p2ukm[id]\" value=\"PREVIEW\"></a><p>";
						echo "<a href=\"hapus_form_p2ukm.php?id=$data_p2ukm[id]\"><input type=\"button\" class=\"submit2\" name=\"hapus\".\"$data_p2ukm[id]\" value=\"HAPUS\"></a>";
					}
					else
					{
						echo "<font style=\"color:green\">DISETUJUI</font><br>";
						echo "per tanggal<br>";
						echo "$tanggal_approval";
						echo "<br><br><a href=\"view_form_p2ukm.php?id=$data_p2ukm[id]\"><input type=\"button\" class=\"submit2\" name=\"view\".\"$data_p2ukm[id]\" value=\"VIEW\"></a><p>";
					}
					echo "</td>";
					echo "</tr>";
					$no++;
			...
			echo "</table>";
			echo "<br><center><a href=\"tambah_p2ukm.php\"><input type=\"button\" class=\"submit1\" name=\"tambah\" value=\"TAMBAH\"></a>";
			...
			echo "&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"cetak_p2ukm.php\" target=\"_BLANK\"><input type=\"button\" class=\"submit1\" name=\"cetak\" value=\"CETAK\"></a>";
			echo "</center><br><br>";

			//Preview Nilai Penugasan dan Test (id test lihat tabel jenis_test)
			echo "<a id=\"test\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Preview Nilai Penugasan dan Test</font></a><br><br>";
			...
			echo "<a id=\"komprehensip\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Pengisian Formulir Penilaian Ujian Komprehensip</font></a><br><br>";
			...
			else
			{
			  ...
			  while ($data_komprehensip=mysqli_fetch_array($nilai_komprehensip))
			  {
			    ...
			    echo "<td>$data_dosen[nama], $data_dosen[gelar] (NIP. $data_dosen[nip])<br><br>";
			    if ($data_komprehensip[status_approval]=='0') echo "<a href=\"approve_komprehensip.php?id=$data_komprehensip[id]\"><input type=\"button\" name=\"approve\".\"$data_komprehensip[id]\" style=\"color:red\" value=\"APPROVE\"></a>";
			    echo "</td>";
			    echo "<td align=center>";
			    if ($data_komprehensip[status_approval]=='0')
			    {
			      echo "<font style=\"color:red\">BELUM DISETUJUI</font><br><br>";
			      echo "<a href=\"edit_form_komprehensip.php?id=$data_komprehensip[id]\"><input type=\"button\" class=\"submit2\" name=\"edit\".\"$data_komprehensip[id]\" value=\"EDIT\"></a><p>";
			      echo "<a href=\"preview_form_komprehensip.php?id=$data_komprehensip[id]\"><input type=\"button\" class=\"submit2\" name=\"preview\".\"$data_komprehensip[id]\" value=\"PREVIEW\"></a><p>";
			      echo "<a href=\"hapus_form_komprehensip.php?id=$data_komprehensip[id]\"><input type=\"button\" class=\"submit2\" name=\"hapus\".\"$data_komprehensip[id]\" value=\"HAPUS\"></a>";
			    }
			    else
			    {
			      echo "<font style=\"color:green\">DISETUJUI</font><br>";
			      echo "per tanggal<br>";
			      echo "$tanggal_approval";
			      echo "<br><br><a href=\"view_form_komprehensip.php?id=$data_komprehensip[id]\"><input type=\"button\" class=\"submit2\" name=\"view\".\"$data_komprehensip[id]\" value=\"VIEW\"></a><p>";
			    }
			    echo "</td>";
			    echo "</tr>";
			    $no++;
			...
			echo "</table>";
			if ($cek_nilai_komprehensip<1)
			echo "<br><center><a href=\"tambah_nilai_komprehensip.php\"><input type=\"button\" class=\"submit1\" name=\"tambah\" value=\"TAMBAH\"></a>";
			...
			echo "<br><center><a href=\"cetak_komprehensip.php\" target=\"_BLANK\"><input type=\"button\" class=\"submit1\" name=\"cetak\" value=\"CETAK\"></a>";

			echo "<br><br><br><center><a href=\"cetak_nilai_ikmkp.php\" target=\"_BLANK\"><input type=\"button\" id=\"cetak_nilai\" class=\"submit1\" name=\"cetak_nilai\" value=\"CETAK NILAI\"></a>";
			echo "</center><br><br>";
