...
<head>
	...
	<title>On-line Tambah Ujian Komprehensip Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI UJIAN KOMPREHENSIP<br>KEPANITERAAN (STASE) IKM-KP</h2>
						<br>
						<?php
						$id_stase = "M095";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_komprehensip = mysqli_query($con, "INSERT INTO `ikmkp_nilai_komprehensip`
				( `nim`, `dosen`,`aspek_1`, `aspek_2`,
					`aspek_3`, `aspek_4`, `nilai_total`,
					`umpan_balik`,`saran`,
