...
<head>
	...
	<title>On-line Preview PKBI Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PREVIEW NILAI KEGIATAN DI PKBI<p>KEPANITERAAN (STASE) IKM-KP</h2>
						<br>
						<?php
						$id = $_GET['id'];
						$data_mhsw = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM `biodata_mhsw` WHERE `nim`='$_COOKIE[user]'"));
						...
						echo "<td align=center style=\"font-weight:600;\">$data_pkbi[aspek_1]</td>";
						echo "</tr>";
						//No 2
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>20%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_pkbi[aspek_2]</td>";
						echo "</tr>";
						//No 3
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>20%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_pkbi[aspek_3]</td>";
						echo "</tr>";
						//No 4
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>20%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_pkbi[aspek_4]</td>";
						echo "</tr>";
						//No 5
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>20%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_pkbi[aspek_5]</td>";
						echo "</tr>";
						//Nilai Total
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=3 align=right><strong>Total Nilai <span class=\"text-danger\">(Bobot x Nilai)</span></strong></td>";
						echo "<td align=center style=\"font-weight:600; color:blue\">$data_pkbi[nilai_total]</td>";
						echo "</tr>";
						echo "</table><br>";
						...
						<textarea name=\"umpan_balik\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_pkbi[umpan_balik]</textarea></td>";
						echo "</tr>";
						echo "<tr  class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Saran:</strong><br>
						<textarea name=\"saran\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_pkbi[saran]</textarea></td>";
						echo "</tr>";
						echo "<tr  class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">
