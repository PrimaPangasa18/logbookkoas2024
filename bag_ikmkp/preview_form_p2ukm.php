...
error_reporting("E_ALL ^ E_NOTICE");
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">PREVIEW NILAI KEGIATAN DI P2UKM MLONGGO<p>Kepaniteraan (Stase) IKM-KP</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td align=center>$data_p2ukm[aspek_1]</td>";
		echo "</tr>";
		//No 2
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center>$data_p2ukm[aspek_2]</td>";
		echo "</tr>";
		//No 3
		echo "<tr>";
			...
			echo "<td align=center>$data_p2ukm[aspek_3]</td>";
		echo "</tr>";
		//No 4
		echo "<tr>";
			...
			echo "<td align=center>20%</td>";
			echo "<td align=center>$data_p2ukm[aspek_4]</td>";
		echo "</tr>";
		//No 5
		echo "<tr>";
			...
			echo "<td align=center>20%</td>";
			echo "<td align=center>$data_p2ukm[aspek_5]</td>";
		echo "</tr>";
		//No 6
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center>$data_p2ukm[aspek_6]</td>";
		echo "</tr>";
		//No 7
		echo "<tr>";
			...
			echo "<td>Sikap</td>";
			echo "<td align=center>10%</td>";
			echo "<td align=center>$data_p2ukm[aspek_7]</td>";
		echo "</tr>";
		//Nilai Total
		echo "<tr>";
			echo "<td colspan=3 align=right>Total Nilai (Bobot x Nilai)</td>";
			echo "<td align=center>$data_p2ukm[nilai_total]</td>";
		echo "</tr>";
		echo "</table><br>";
		...
		echo "<table border=1 style=\"width:70%;background:rgb(244, 241, 217);\">";
		echo "<tr>";
		  echo "<td>Umpan Balik:<br><textarea name=\"umpan_balik\" rows=5 style=\"width:100%;font-family:Tahoma;font-size:1em\" disabled>$data_p2ukm[umpan_balik]</textarea></td>";
		echo "</tr>";
		echo "<tr>";
		  echo "<td>Saran:<br><textarea name=\"saran\" rows=5 style=\"width:100%;font-family:Tahoma;font-size:1em\" disabled>$data_p2ukm[saran]</textarea></td>";
		echo "</tr>";
