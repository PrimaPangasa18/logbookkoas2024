...
<head>
	...
	<title>On-line Edit Ujian Komprehensip Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('../images/undip_watermark_color.png'), url('../images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT NILAI UJIAN KOMPREHENSIP<br>KEPANITERAAN (STASE) IKM-KP</h2>
						<br>
						<?php
						$id_stase = "M095";
						$id = $_GET['id'];
						...
						$data_dosen_isian = mysqli_fetch_array(mysqli_query($con, "SELECT `nip`,`nama`,`gelar` FROM `dosen` WHERE `nip`='$data_komprehensip[dosen]'"));
