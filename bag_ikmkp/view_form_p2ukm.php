...
<head>
	...
	<title>On-line View P2UKM Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">NILAI KEGIATAN DI P2UKM MLONGGO<br>KEPANITERAAN (STASE) IKM-KP</h2>
						<br>
						<?php
						$id = $_GET['id'];
