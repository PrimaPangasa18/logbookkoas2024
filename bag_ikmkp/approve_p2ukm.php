...
<head>
	...
	<title>On-line Approval P2UKM Logbook Koas Pendidikan Dokter FK-UNDIP</title>
		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">APPROVAL NILAI KEGIATAN DI P2UKM MLONGGO<br>KEPANITERAAN (STASE) IKM-KP</h2>
						<br>
						<?php
						$id = $_GET['id'];
						...
						echo "<td style=\" font-weight:600;\">$data_p2ukm[jenis_penilaian]</td>";
						echo "</tr>";
						//Dosen Pembimbing
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
			...
			";
						...
						if ($_POST['approve'] == "APPROVE") {
							$dosen_p2ukm = mysqli_fetch_array(mysqli_query($con, "SELECT `dosen` FROM `ikmkp_nilai_p2ukm` WHERE `id`='$_POST[id]'"));
							$user_dosen = mysqli_fetch_array(mysqli_query($con, "SELECT `password` FROM `admin` WHERE `username`='$dosen_p2ukm[dosen]'"));
							$data_dosen = mysqli_fetch_array(mysqli_query($con, "SELECT `pin`,`qr` FROM `dosen` WHERE `nip`='$dosen_p2ukm[dosen]'"));
				...
				window.location.href = \"approve_p2ukm.php?id=\"+\"$_POST[id]\";
        </script>
				";
							}
						}
