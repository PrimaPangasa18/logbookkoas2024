				...
				<div class="container-fluid">
					<div class="mb-3">
						...
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color: #0a3967">
							REKAP UMUM EVALUASI KEPANITERAAN (STASE) - EVALUASI
						</h2>
						<br><br>
						<div class="table-responsive">
								...
								<center>
									<table class="table table-bordered" style="width: auto">
										<tr style="border-width: 1px; border-color: #000;" class="table-primary">
											<td class="align-middle" style="width: 300px;"><strong>Kepaniteraan <span class="text-danger">(STASE)</strong></span></td>
										...
										<tr style="border-width: 1px; border-color: #000;" class="table-primary">
											...
											<td><input type="text" class="form-select input-tanggal" name="tgl_awal" placeholder="Tanggal Awal (yyy-mm-dd)" required required /></td>
										</tr>
										<tr style="border-width: 1px; border-color: #000;" class="table-success">
											<td><strong>Tanggal Akhir</strong></td>
											<td>
												<input type="text" class="form-select input-tanggal" name="tgl_akhir" placeholder="Tanggal Akhir (yyy-mm-dd)" required required />
							...
							if (isset($_POST['submit']) && $_POST['submit'] == "SUBMIT") {
								echo "
            <script>
						window.location.href=\"rekap_umumevalstase_admin.php?grup=\"+\"$_POST[grup]\"+\"&stase=\"+\"$_POST[stase]\"+\"&angk=\"+\"$_POST[angk_mhsw]\"+\"&tglawal=\"+\"$_POST[tgl_awal]\"+\"&tglakhir=\"+\"$_POST[tgl_akhir]\";
						</script>
            ";
							}
							?>
