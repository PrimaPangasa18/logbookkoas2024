...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==2)
	{
		...
		echo "<table>";
		echo "<tr><td>Nama Dosen/Residen</td>";
		echo "<td>: $biodata_dosen[nama], $biodata_dosen[gelar]</td>";
		echo "</tr>";
		echo "<tr><td>Username Dosen/Residen</td>";
		echo "<td>: $biodata_dosen[nip]</td>";
		echo "</tr>";
		echo "</table>";
		echo "<br><br>";
		...
		while ($data1=mysqli_fetch_array($data_penyakit))
		{
			...
			echo "<tr class=\"$kelas\">";
				...
				if ($data1[status]==0)
				{
					...
					echo "&nbsp;&nbsp;<a href=\"dosen_approve.php?dosen=$user_dosen&mhsw=$mhsw_filter&stase=$stase_filter&tgl_kegiatan=$tanggal_filter&appstatus=$status_filter&jurnal=penyakit&id=$data1[id]&status=1\"><input type=\"button\" name=\"approve\" style=\"color:red\" value=\"APPROVE\"></a>";
				}
				else
				{
					echo "<font style=\"color:green\">Approved</font>";
					echo "&nbsp;&nbsp;<a href=\"dosen_approve.php?dosen=$user_dosen&mhsw=$mhsw_filter&stase=$stase_filter&tgl_kegiatan=$tanggal_filter&appstatus=$status_filter&jurnal=penyakit&id=$data1[id]&status=0\"><input type=\"button\" name=\"unapprove\" style=\"color:green\" value=\"UNAPPROVE\"></a>";
				}
				echo "</i></td>";
			echo "</tr>";
			$no++;
		...
		while ($data2=mysqli_fetch_array($data_ketrampilan))
		{
			...
			echo "<tr class=\"$kelas\">";
				...
				{
					echo "<font style=\"color:red\">Not-Approved</font>";
					echo "&nbsp;&nbsp;<a href=\"dosen_approve.php?dosen=$user_dosen&mhsw=$mhsw_filter&stase=$stase_filter&tgl_kegiatan=$tanggal_filter&appstatus=$status_filter&jurnal=ketrampilan&id=$data2[id]&status=1\"><input type=\"button\" name=\"approve\" style=\"color:red\" value=\"APPROVE\"></a>";
				}
				else
				{
					echo "<font style=\"color:green\">Approved</font>";
					echo "&nbsp;&nbsp;<a href=\"dosen_approve.php?dosen=$user_dosen&mhsw=$mhsw_filter&stase=$stase_filter&tgl_kegiatan=$tanggal_filter&appstatus=$status_filter&jurnal=ketrampilan&id=$data2[id]&status=0\"><input type=\"button\" name=\"unapprove\" style=\"color:green\" value=\"UNAPPROVE\"></a>";
				}
				echo "</i></td>";
			echo "</tr>";
			$no++;
