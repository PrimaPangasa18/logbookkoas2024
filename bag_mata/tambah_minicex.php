			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI UJIAN MINI-CEX<br>KEPANITERAAN (STASE) ILMU KESEHATAN MATA</h2>
						<br>
						<?php
						$id_stase = "M104";
						...
						echo "<td class=\"td_mid\" style=\"font-weight:600;\"><input type=\"number\" step=\"5\" min=\"0\" max=\"3600\" name=\"waktu_obs\" style=\"text-align:center;width:20%; height:30px;border:0.2px solid black;border-radius:3px;font-size:1.0em\" placeholder=\"0-3600\" required/>&nbsp;&nbsp;Menit</td>";
						echo "</tr>";
						//Waktu Umpan Balik
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td class=\"td_mid\"><strong>Waktu Umpan Balik</strong></td>";
						echo "<td class=\"td_mid\" style=\"font-weight:600;\"><input type=\"number\" step=\"5\" min=\"0\" max=\"3600\" name=\"waktu_ub\" style=\"text-align:center;width:20%; height:30px;border:0.2px solid black;border-radius:3px;font-size:1.0em\" placeholder=\"0-3600\" required/>&nbsp;&nbsp;Menit</td>";
						echo "</tr>";
						//Dosen Penguji
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						...
						<input type=\"radio\" name=\"observasi11\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked />&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi11\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek11\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek11\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 1.2.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi12\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi12\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek12\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek12\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 1.3.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi13\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi13\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek13\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek13\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 1.4.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi14\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi14\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek14\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek14\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 1.5.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi15\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi15\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek15\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek15\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 1.6.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi16\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi16\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek16\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek16\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 1.7.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi17\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi17\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek17\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek17\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi21\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi21\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek21\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek21\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 2.2.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi22\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi22\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek22\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek22\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 2.3.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi23\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi23\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek23\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek23\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 2.4.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi24\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi24\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek24\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek24\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi31\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi31\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek31\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek31\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 3.2.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi32\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi32\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek32\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek32\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 3.3.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi33\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi33\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek33\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek33\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 3.4.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi34\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi34\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek34\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek34\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 3.5.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi35\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi35\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek35\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek35\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 3.6.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi36\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi36\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek36\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek36\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi41\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi41\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek41\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek41\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 4.2.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi42\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi42\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek42\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek42\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 4.3.
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">
						<input type=\"radio\" name=\"observasi43\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" checked/>&nbsp;&nbsp;Ya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"observasi43\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;Tidak
						</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek43\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek43\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						...
						<textarea name=\"saran\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\"></textarea></td>";
						echo "</tr>";
						echo "</table><br>";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_minicex = mysqli_query($con, "INSERT INTO `mata_nilai_minicex`
				( `nim`, `dosen`, `tgl_ujian`,
					`aspek_11`, `observasi_11`, `aspek_12`, `observasi_12`,
					`aspek_13`, `observasi_13`, `aspek_14`, `observasi_14`,
					`aspek_15`, `observasi_15`, `aspek_16`, `observasi_16`,
					`aspek_17`, `observasi_17`, `aspek_21`, `observasi_21`,
					`aspek_22`, `observasi_22`, `aspek_23`, `observasi_23`,
					`aspek_24`, `observasi_24`, `aspek_31`, `observasi_31`,
					`aspek_32`, `observasi_32`, `aspek_33`, `observasi_33`,
					`aspek_34`, `observasi_34`, `aspek_35`, `observasi_35`,
					`aspek_36`, `observasi_36`, `aspek_41`, `observasi_41`,
					`aspek_42`, `observasi_42`, `aspek_43`, `observasi_43`,
					`saran`, `waktu_obs`, `waktu_ub`, `nilai_rata`,
					`tgl_isi`, `tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]','$_POST[dosen]','$_POST[tanggal_ujian]',
					'$aspek11', '$_POST[observasi11]', '$aspek12', '$_POST[observasi12]',
					'$aspek13', '$_POST[observasi13]', '$aspek14', '$_POST[observasi14]',
					'$aspek15', '$_POST[observasi15]', '$aspek16', '$_POST[observasi16]',
					'$aspek17', '$_POST[observasi17]', '$aspek21', '$_POST[observasi21]',
					'$aspek22', '$_POST[observasi22]', '$aspek23', '$_POST[observasi23]',
					'$aspek24', '$_POST[observasi24]', '$aspek31', '$_POST[observasi31]',
					'$aspek32', '$_POST[observasi32]', '$aspek33', '$_POST[observasi33]',
					'$aspek34', '$_POST[observasi34]', '$aspek35', '$_POST[observasi35]',
					'$aspek36', '$_POST[observasi36]', '$aspek41', '$_POST[observasi41]',
					'$aspek42', '$_POST[observasi42]', '$aspek43', '$_POST[observasi43]',
					'$saran','$_POST[waktu_obs]','$_POST[waktu_ub]','$rata_nilai',
					'$tgl','2000-01-01','0')");
