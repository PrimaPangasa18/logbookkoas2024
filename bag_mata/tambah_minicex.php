...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR NILAI UJIAN MINI-CEX<p>Kepaniteraan (Stase) Ilmu Kesehatan Mata</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td class=\"td_mid\"><input type=\"text\" class=\"tanggal_ujian\" name=\"tanggal_ujian\" style=\"font-size:1em;font-family:TAHOMA;padding:0 0 0 7px;height:27px;border:0.5px solid grey;border-radius:5px;\" placeholder=\"yyyy-mm-dd\" required/></td>";
		echo "</tr>";
		//Waktu Observasi
		echo "<tr>";
			echo "<td class=\"td_mid\">Waktu Observasi</td>";
			echo "<td class=\"td_mid\"><input type=\"number\" step=\"5\" min=\"0\" max=\"3600\" name=\"waktu_obs\" style=\"width:20%;font-size:0.85em;text-align:center\" placeholder=\"0-3600\" required/>&nbsp;&nbsp;menit</td>";
		echo "</tr>";
		//Waktu Umpan Balik
		echo "<tr>";
			echo "<td class=\"td_mid\">Waktu Umpan Balik</td>";
			echo "<td class=\"td_mid\"><input type=\"number\" step=\"5\" min=\"0\" max=\"3600\" name=\"waktu_ub\" style=\"width:20%;font-size:0.85em;text-align:center\" placeholder=\"0-3600\" required/>&nbsp;&nbsp;menit</td>";
		echo "</tr>";
		//Dosen Penguji
		echo "<tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek15\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek15\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 1.6.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek16\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek16\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 1.7.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek17\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek17\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek21\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek21\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 2.2.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek22\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek22\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 2.3.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek23\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek23\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 2.4.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek24\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek24\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek31\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek31\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 3.2.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek32\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek32\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 3.3.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek33\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek33\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 3.4.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek34\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek34\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 3.5.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek35\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek35\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 3.6.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek36\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek36\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek41\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek41\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 4.2.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek42\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek42\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 4.3.
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek43\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek43\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		...
		//Komentar / Saran
		echo "<tr>";
			echo "<td colspan=4>Komentar / Saran:<br><textarea name=\"saran\" rows=5 style=\"width:100%;font-family:Tahoma;font-size:1em\"></textarea></td>";
		echo "</tr>";
		echo "</table><br>";
