				...
				WHERE `id`='$_POST[id]'");
							...
							while ($i < 6) {
								if (!empty($_POST["penyanggah" . "$i"]) and $_POST["penyanggah" . "$i"] != "") {
									...
									$data_penyanggah = mysqli_query($con, "SELECT `id` FROM `mata_nilai_penyanggah` WHERE `nim`='$penyanggah' AND `dosen`='$_POST[dosen]' AND `presenter`='$_POST[nim]' AND `jenis_presentasi`='Kasus Besar'");
							...
							VALUES
							( '$_POST[id]','$penyanggah','$_POST[nim]','Kasus Besar','$_POST[tanggal_penyajian]',
