...
<head>
	...
	<title>On-line Edit Presentasi Kasus Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT NILAI PRESENTASI KASUS BESAR<br>KEPANITERAAN (STASE) ILMU KESEHATAN MATA</h2>
						<br>
						<?php
						$id_stase = "M104";
						$id = $_GET['id'];
				...
				`judul_presentasi`='$judul',`tgl_penyajian`='$_POST[tanggal_penyajian]',`dosen`='$_POST[dosen]',
