<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND ($_COOKIE['level']==1 OR $_COOKIE['level']==2 OR $_COOKIE['level']==3 OR $_COOKIE['level']==5))
	{
		...
		while ($data_minicex = mysqli_fetch_array($daftar_minicex))
		{
			...
			if ($data_minicex[observasi_11]=="1") $obs11 = "Ya"; else $obs11 = "Tidak";
			if ($data_minicex[observasi_12]=="1") $obs12 = "Ya"; else $obs12 = "Tidak";
			if ($data_minicex[observasi_13]=="1") $obs13 = "Ya"; else $obs13 = "Tidak";
			if ($data_minicex[observasi_14]=="1") $obs14 = "Ya"; else $obs14 = "Tidak";
			if ($data_minicex[observasi_15]=="1") $obs15 = "Ya"; else $obs15 = "Tidak";
			if ($data_minicex[observasi_16]=="1") $obs16 = "Ya"; else $obs16 = "Tidak";
			if ($data_minicex[observasi_17]=="1") $obs17 = "Ya"; else $obs17 = "Tidak";

			if ($data_minicex[observasi_21]=="1") $obs21 = "Ya"; else $obs21 = "Tidak";
			if ($data_minicex[observasi_22]=="1") $obs22 = "Ya"; else $obs22 = "Tidak";
			if ($data_minicex[observasi_23]=="1") $obs23 = "Ya"; else $obs23 = "Tidak";
			if ($data_minicex[observasi_24]=="1") $obs24 = "Ya"; else $obs24 = "Tidak";

			if ($data_minicex[observasi_31]=="1") $obs31 = "Ya"; else $obs31 = "Tidak";
			if ($data_minicex[observasi_32]=="1") $obs32 = "Ya"; else $obs32 = "Tidak";
			if ($data_minicex[observasi_33]=="1") $obs33 = "Ya"; else $obs33 = "Tidak";
			if ($data_minicex[observasi_34]=="1") $obs34 = "Ya"; else $obs34 = "Tidak";
			if ($data_minicex[observasi_35]=="1") $obs35 = "Ya"; else $obs35 = "Tidak";
			if ($data_minicex[observasi_36]=="1") $obs36 = "Ya"; else $obs36 = "Tidak";

			if ($data_minicex[observasi_41]=="1") $obs41 = "Ya"; else $obs41 = "Tidak";
			if ($data_minicex[observasi_42]=="1") $obs42 = "Ya"; else $obs42 = "Tidak";
			if ($data_minicex[observasi_43]=="1") $obs43 = "Ya"; else $obs43 = "Tidak";
			if ($data_minicex[observasi_44]=="1") $obs44 = "Ya"; else $obs44 = "Tidak";
