...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">APPROVAL NILAI PRESENTASI KASUS BESAR<p>Kepaniteraan (Stase) Ilmu Kesehatan Mata</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td class=\"td_mid\"><input type=\"text\" class=\"tanggal_penyajian\" name=\"tanggal_penyajian\" style=\"font-size:1em;font-family:TAHOMA;padding:0 0 0 7px;height:27px;border:0.5px solid grey;border-radius:5px;\" value=\"$data_presentasi[tgl_penyajian]\" /></td>";
		echo "</tr>";
		//Judul
		echo "<tr>";
			echo "<td>Judul Presentasi Kasus</td>";
			echo "<td><textarea name=\"judul_presentasi\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Judul Presentasi Kasus >>\" required>$data_presentasi[judul_presentasi]</textarea></td>";
		echo "</tr>";
		//Dosen Penilai
		echo "<tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_total\" style=\"width:100%;font-size:0.85em;text-align:center\" value=\"$data_presentasi[nilai_total]\" id=\"nilai_total\" required/></td>";
		echo "</tr>";
		echo "</table><br>";
		...
		while ($i<6)
		{
			echo "<tr>";
				...
				echo "<td class=\"td_mid\">Penyanggah-$i: ";
					...
					echo "</select>";
				echo "</td>";
				if ($data_presentasi[$nilai_penyanggah_i]=="-") echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"$nilai\" style=\"width:100%;font-size:0.85em;text-align:center\" placeholder=\"0-100\" /></td>";
				else echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"$nilai\" style=\"width:100%;font-size:0.85em;text-align:center\" value=\"$data_presentasi[$nilai_penyanggah_i]\" /></td>";
			echo "</tr>";
			$i++;
		}
		echo "</table><br>";
