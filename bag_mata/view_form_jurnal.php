			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">NILAI PRESENTASI JOURNAL READING<p>KEPANITERAAN (STASE) ILMU KESEHATAN MATA</h2>
						<br>
						<?php
						$id_stase = "M104";
						$id = $_GET['id'];
						...
						echo "<td style=\"font-weight:600;\">$data_jurnal[judul_presentasi]</td>";
						echo "</tr>";
						//Dosen Penilai
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						while ($i < 6) {
							...
							echo "</td>";
							echo "<td align=center style=\"font-weight:600;\">$data_jurnal[$nilai_penyanggah_i]</td>";
							echo "</tr>";
							$i++;
						}
