...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR NILAI PRESENTASI JOURNAL READING<p>Kepaniteraan (Stase) Ilmu Kesehatan Mata</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"judul_presentasi\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Judul Artikel >>\" required></textarea></td>";
		echo "</tr>";
		//Dosen Penilai
		echo "<tr>";
