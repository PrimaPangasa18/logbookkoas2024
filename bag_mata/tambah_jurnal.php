			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI PRESENTASI JOURNAL READING<br>KEPANITERAAN (STASE) ILMU KESEHATAN MATA</h2>
						<br>
						<?php
						$id_stase = "M104";
						...
						echo "<td class=\"td_mid\"><input type=\"text\" class=\"form-select tanggal_penyajian\" name=\"tanggal_penyajian\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" placeholder=\"yyyy-mm-dd\" /></td>";
						echo "</tr>";
						//Judul
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Judul Artikel</strong></td>";
						echo "<td><textarea name=\"judul_presentasi\" style=\" width: 100%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" placeholder=\"<< Judul Artikel >>\" required></textarea></td>";
						echo "</tr>";
						//Dosen Penilai
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_total\" style=\"width:55%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"nilai_total\" value=\"0\" required disabled/></td>";
						echo "</tr>";
						echo "</table><br>";
						...
						while ($i < 6) {
							...
							echo "</select>";
							echo "</td>";
							echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"$nilai\" style=\"margin-top:17px;width:55%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" placeholder=\"0-100\" /></td>";
							echo "</tr>";
							$i++;
						}
						echo "</table><br>";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_jurnal = mysqli_query($con, "INSERT INTO `mata_nilai_jurnal`
