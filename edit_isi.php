		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						<h3 class="fw-bold fs-4 mb-3">EDIT ISI LOGBOOK - PENYAKIT</h3>
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT ISI LOGBOOK KEPANITERAAN (STASE) - PENYAKIT</h2>
						<br>
						<?php
								...
								<tr class="table-primary" style="border-width: 1px; border-color: #000;">
									...
									<td style="width:500px">
										<div id="my_kelas" role="dialog" class="fix_style">
											<?php
											if ($data_logbook['kelas'] == "1") {
												$awal = 0;
												$akhir = 6;
											}
											if ($data_logbook['kelas'] == "2") {
												$awal = 7;
												$akhir = 9;
											}
											if ($data_logbook['kelas'] == "3") {
												$awal = 10;
												$akhir = 11;
											}
											if ($data_logbook['kelas'] == "4") {
												$awal = 12;
												$akhir = 13;
											}
											if ($data_logbook['kelas'] == "5") {
												$awal = 14;
												$akhir = 15;
											}
											if ($data_logbook['kelas'] == "6") {
												$awal = 16;
												$akhir = 23;
											}
											...
											echo "<div id=\"hide_jam\" ><span style=\"font-weight:500\">Jam Mulai/Selesai Kegiatan:</span><p>";
											...
											echo '<input type="number" class="form-control thin-border" step="1" min="' . $awal . '" max="' . $akhir . '" name="jam_mulai" style="font-size:0.85em;text-align:center;border: 2px solid black;" value="' . $data_jam_mulai . '"  required />';
											echo '</div>';
											echo '<div class="col-3" style="font-weight:500; color:darkgreen;">Menit Mulai</div>';
											echo '<div class="col-3">';
											echo '<input type="number" class="form-control " step="1" min="0" max="59" name="menit_mulai" style="font-size:0.85em;text-align:center;border: 2px solid black;" value="' . $data_menit_mulai . '"  required />';
											echo '</div>';
											echo '</div>';
											//Jam selesai
											echo '<div class="row mb-3">';
											...
											echo '<div class="col-3">';
											echo '<input type="number" class="form-control thin-border" step="1" min="' . $awal . '" max="' . $akhir . '" name="jam_selesai" style="font-size:0.85em;text-align:center;border: 2px solid black;" value="' . $data_jam_selesai . '" required />';
											echo '</div>';
											echo '<div class="col-3" style="font-weight:500; color:darkgreen;">Menit Selesai</div>';
											echo '<div class="col-3">';
											echo '<input type="number" class="form-control " step="1" min="0" max="59" name="menit_selesai" style="font-size:0.85em;text-align:center;border: 2px solid black;" value="' . $data_menit_selesai . '" required />';
											echo '</div>';
											echo '</div>';
											echo "</table></div>";
											?>
						...
						<center>
								...
								<tr class="table-primary" style="border-width: 1px; border-color: #000;">
									...
									<td style="width:500px">
										<div id="my_penyakit1" role="dialog" class="fix_style">
											...
											$data_penyakit1 = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM `daftar_penyakit` WHERE `id`='$data_logbook[penyakit1]'"));
											...
											echo "<option value=\"$data_penyakit1[id]\">$data_penyakit1[penyakit] (Level: $data_penyakit1[skdi_level]/$data_penyakit1[k_level]/$data_penyakit1[ipsg_level]/$data_penyakit1[kml_level])</option>";
								...
								<tr class="table-primary" style="border-width: 1px; border-color: #000;">
									...
									<td style="width:500px">
										<div id="my_penyakit2" role="dialog" class="fix_style">
											<?php
											$data_penyakit2 = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM `daftar_penyakit` WHERE `id`='$data_logbook[penyakit2]'"));
											...
											echo "<option value=\"$data_penyakit2[id]\">$data_penyakit2[penyakit] (Level: $data_penyakit2[skdi_level]/$data_penyakit2[k_level]/$data_penyakit2[ipsg_level]/$data_penyakit2[kml_level])</option>";
								...
								<tr class="table-primary" style="border-width: 1px; border-color: #000;">
									...
									<td style="width:500px">
										<div id="my_penyakit3" role="dialog" class="fix_style">
											<?php
											$data_penyakit3 = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM `daftar_penyakit` WHERE `id`='$data_logbook[penyakit3]'"));
											...
											echo "<option value=\"$data_penyakit3[id]\">$data_penyakit3[penyakit] (Level: $data_penyakit3[skdi_level]/$data_penyakit3[k_level]/$data_penyakit3[ipsg_level]/$data_penyakit3[kml_level])</option>";
								...
								<tr class="table-primary" style="border-width: 1px; border-color: #000;">
									...
									<td style="width:500px">
										<div id="my_penyakit4" role="dialog" class="fix_style">
											<?php
											$data_penyakit4 = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM `daftar_penyakit` WHERE `id`='$data_logbook[penyakit4]'"));
											...
											echo "<option value=\"$data_penyakit4[id]\">$data_penyakit4[penyakit] (Level: $data_penyakit4[skdi_level]/$data_penyakit4[k_level]/$data_penyakit4[ipsg_level]/$data_penyakit4[kml_level])</option>";
								...
								<tr class="table-success" style="border-width: 1px; border-color: #000;">
									...
									<td style="width:500px">
										<div id="my_dosen" role="dialog" class="fix_style">
											<?php
											echo "<select class=\"form-select\" name=\"dosen\" id=\"dosen\" required>";
							...
							<button type="submit" class="btn btn-success" name="ubah" value="UBAH">
								<i class="fa-solid fa-shuffle me-2"></i> UBAH
							</button>
						</center>
					</div>
					<?php
			...
			";
					...
					if ($_POST['ubah'] == "UBAH") {
						...
						$kelas = $_POST['kelas'];
						$update_db = mysqli_query($con, "UPDATE `jurnal_penyakit`
				SET
				...
				`penyakit3`='$_POST[penyakit3]',
				`penyakit4`='$_POST[penyakit4]',
				`dosen`='$_POST[dosen]'
