...
<head>
	...
	<title>On-line Tambah Penyakit Logbook Koas Pendidikan Dokter FK-UNDIP</title>
		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						<h3 class="fw-bold fs-4 mb-3">TAMBAH DAFTAR PENYAKIT</h3>
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">TAMBAH DAFTAR PENYAKIT</h2>
						<br>
						<?php
						if (empty($_POST['submit'])) {
							...
							echo "<td  style=\"width:30%\"><strong>Nama Penyakit</td>";
							echo "<td style=\"width:70%\">";
							echo "<textarea name=\"penyakit\" rows=\"1\" class=\"form-control\" style=\"border:0.5px solid grey;border-radius:5px; font-weight:600;\" placeholder=\"Ketikkan nama penyakit\"></textarea>";
							echo "</td>";
							echo "</tr>";
							//Level Penyakit SKDI
							...
							while ($data = mysqli_fetch_array($daftar_stase)) {
								...
								echo "<td style=\"vertical-align:middle;width:15%; font-weight:600;\">
				...
				'$_POST[include_M121]', '$_POST[target_M121]')");
							echo "<center>";
							echo "<br>
							<span style=\"color:darkblue;font-weight:600;\">Nama penyakit berhasil ditambahkan!<span><br>";
							echo "<br>";
							...
							echo "<td style=\"width:50%;font-weight:600;\">$_POST[penyakit]</td>";
							echo "</tr>";
							echo "<tr  class=\"table-warning\" style =\"border-width: 1px; border-color: #000;\">";
