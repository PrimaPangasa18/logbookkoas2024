...
<body>
	<div class="wrapper">
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">REKAP EVALUASI AKHIR STASE - UMUM<br>KOMENTAR, KRITIK DAN SARAN</h2>
						<br>
						<?php
						$id_stase = $_GET['stase'];
        ...
        <th style=\"width:25%;text-align:center;\">Nama Mahasiswa</th>
        <th style=\"width:10%;text-align:center;\">NIM</th>
        <th style=\"width:10%;text-align:center;\">Angkatan</th>
        <th style=\"width:50%;text-align:center;\">Komentar, Kritik, dan Saran</th>
    </thead>";
						$id = 1;
						$kelas = "ganjil";
						while ($nim_mhsw = mysqli_fetch_array($mhsw)) {
							...
							$komentar = mysqli_fetch_array($data_evaluasi);
							...
							echo "<td style=\"font-weight:600;\">$data_mhsw[nama]</td>";
							echo "<td style=\"text-align:center; font-weight:600; color:blue;\">$nim_mhsw[nim]</td>";
							echo "<td style=\"text-align:center; font-weight:600; color:darkred;\">$data_mhsw[angkatan]</td>";
							if ($jml_data_evaluasi > 0) echo "<td style=\"font-weight:600;\">$komentar[komentar]</td>";
							else echo "<td style=\"color: red; font-weight:600;\"><span>Belum Mengisi Evaluasi</span></td>";
							echo "</tr>";
			...
			<center>
				<form action="export_rekap_evaluasi_kritik_saran.php" method="get">
