            ...
            <div class="container mt-5">
              ...
              if (isset($_POST['cari']) && $_POST['cari'] === "CARI") {
                ...
                if ($jml >= 1) {
                  ...
                  echo '<small class="text-danger" style="font-weight:700">(Klik username untuk melihat rekap evaluasi kepaniteraan/stase per individu)</small>';
                  echo '<p></p>';
                  ...
                  while ($data = mysqli_fetch_array($user_kunci)) {
                    ...
                    echo '<td style="text-align:center"><a href="rekap_evaluasi_admin.php?user_name=' . urlencode($data['username']) . '" class="btn btn-outline-primary">' . htmlspecialchars($data['username']) . '</a></td>';
