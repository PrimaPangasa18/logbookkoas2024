...
if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND ($_COOKIE['level']==1 OR $_COOKIE['level']==2 OR $_COOKIE['level']==3))
{
  ...
  if ($_POST['cari']=="CARI")
  {
    ...
    if ($jml>=1)
    {
      ...
      echo "<tr>";
        echo "<td>";
        echo "<font style=\"font-size:0.625em\"><i>(Klik username untuk melihat rekap evaluasi kepaniteraan/stase per individu)</i></font>";
        echo "</td>";
      echo "</tr>";
      echo "</table><br>";
      ...
      while ($data=mysqli_fetch_array($user_kunci))
      {
        ...
        echo "<tr class=\"genap\">";
          ...
          echo "<td><a href=\"rekap_evaluasi_admin.php?user_name=$data[username]\">$data[username]</a></td>";
