...
<head>
	...
	<title>On-line Rekap Nilai Akhir Logbook Koas Pendidikan Dokter FK-UNDIP</title>
		...
		<div class="main">
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						<h3 class="fw-bold fs-4 mb-3">REKAP NILAI AKHIR BAGIAN / KEPANITERAAN (STASE)</h3>
						<br />
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color: #0a3967">
							REKAP NILAI AKHIR BAGIAN / KEPANITERAAN (STASE)
						</h2>
						<br><br>
						<?php
					...
					('$i','$data_mhsw[nim]','$nama_mhsw','$_COOKIE[user]')");
						...
						<td style=\"width:70%; font-weight:600;\">: <span style=\"color:darkgreen;\">$stase[kepaniteraan]</span></td>";
						echo "</tr>";
						...
						<td style=\" font-weight:600;\">:<span style=\"color:red;\"> $jml_mhsw</span> Orang</td>";
						echo "</tr>";
						...
						echo "<span style=\"font-weight: 700; font-family:'Poppins'\">Rumus Nilai Akhir:</span><br><br>";
						echo "&nbsp;&nbsp;<span style=\"font-weight: 700;\">Nilai Akhir = <span style=\"color: blue;\">Rasio Ketuntasan</span> x <span style=\"color: red;\">Nilai Bagian</span></span><br><br>";
						echo "&nbsp;&nbsp;<span style=\"font-weight: 500;\">Grade Ketuntasan <span style=\"color: green;\">&ge; 70%</span> => Rasio Ketuntasan <span style=\"color: green;\">= 100%</span></span><br>";
						echo "&nbsp;&nbsp;<span style=\"font-weight: 500;\"><span style=\"color: blue;\">60% &le;</span> Grade Ketuntasan <span style=\"color: blue;\"> < 70%</span> => Rasio Ketuntasan <span style=\"color: blue;\">= 80%</span></span><br>";
						echo "&nbsp;&nbsp;<span style=\"font-weight: 500;\"><span style=\"color: purple;\">50% &le;</span> Grade Ketuntasan <span style=\"color: purple;\"> < 60%</span> => Rasio Ketuntasan <span style=\"color: purple;\">= 60%</span></span><br>";
						echo "&nbsp;&nbsp;<span style=\"font-weight: 500;\">Grade Ketuntasan <span style=\"color: red;\"> < 50%</span> => Rasio Ketuntasan <span style=\"color: red;\">= 40%</span> </span><br><br>";
						echo "&nbsp;&nbsp;<span style=\"font-weight: 700; color:red;\">Ctt: Grade Ketuntasan = (Grade Jurnal Penyakit + Grade Jurnal Ketrampilan)/2</span>";
						echo "</div><br><br>";
						echo "</center>";
						...
						<th style=\"width:12%;text-align:center;\">Jurnal Penyakit</th>
						<th style=\"width:12%;text-align:center;\">Jurnal Ketrampilan</th>
						<th style=\"width:12%;text-align:center;\">Penilaian Bagian</th>
						...
						if ($id_stase == "M091") {
							...
							while ($data_mhsw = mysqli_fetch_array($data_mhsw_all)) {
								...
								<span style=\"color: darkgreen;\">Angkatan $angk_mhsw[angkatan]</span></td>";
								...
								echo "<td align=center style=\"font-weight:600;\">$grade_penyakit%</td>";
								//--------------------

								//Grade Jurnal Ketrampian
								$grade_ketrampilan = ketuntasan_ketrampilan($con, $include_id, $target_id, $data_mhsw['nim'], $_COOKIE['user']);
								echo "<td align=center style=\"font-weight:600;\">$grade_ketrampilan%</td>";
								//--------------------
								...
								echo "<td align=center style=\"font-weight:600;\">$nilai_bagian</td>";
								//--------------------
								...
								echo "<td align=center style=\"font-weight:600;\">$nilai_akhir</td>";
