<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND ($_COOKIE['level']==1 OR $_COOKIE['level']==2 OR $_COOKIE['level']==3 OR $_COOKIE['level']==5))
	{
		...
		for ($i=$amp1;$i>=1;$i--)
		{
			...
			$kolom1 = array ('item'=>"");
			$tabel1[1] = array ('item'=>"REKAP LOGBOOK KOAS PENDIDIKAN PROFESI DOKTER");
			$tabel1[2] = array ('item'=>"FAKULTAS KEDOKTERAN - UNIVERSITAS DIPONEGORO");
			$tabel1[3] = array ('item'=>"");
			$tabel1[4] = array ('item'=>"$judul");
			...
			$tabel2[3] = array ('item'=>"Kepaniteraan (Stase)", 'isi'=>": "."$data_stase[kepaniteraan]");
			$tabel2[4] = array ('item'=>"Periode Kegiatan", 'isi'=>": "."$periode");
			...
			if ($jenis=="penyakit")
			$tabel_header[1] = array ('NO'=>'<b>No</b>','ITEM'=>'<b>Penyakit</b>','LEVEL'=>'<b>Level S/K/I/M</b>','TARGET'=>'<b>Target</b>','C1'=>'<b>C1</b>','C2'=>'<b>C2</b>','C3'=>'<b>C3</b>','C4A'=>'<b>C4</b>','CMK'=>'<b>CM</b>','CU'=>'<b>CU</b>','GRADE'=>'<b>Grade</b>');
			if ($jenis=="ketrampilan")
			$tabel_header[1] = array ('NO'=>'<b>No</b>','ITEM'=>'<b>Ketrampilan</b>','LEVEL'=>'<b>Level S/K/I/M</b>','TARGET'=>'<b>Target</b>','C1'=>'<b>C1</b>','C2'=>'<b>C2</b>','C3'=>'<b>C3</b>','C4A'=>'<b>C4</b>','CMK'=>'<b>CM</b>','CU'=>'<b>CU</b>','GRADE'=>'<b>Grade</b>');
			$pdf->ezTable($tabel_header,$kolom_header,"",
			array('maxWidth'=>540,'width'=>520,'fontSize'=>8,'showHeadings'=>0,'shaded'=>0,'showLines'=>2,'titleFontSize'=>9, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 1 ,'showBgCol'=> 0,
			'cols'=>array('NO'=>array('width'=>30,'justification'=>'center'),'ITEM'=>array('justification'=>'center'),'TARGET'=>array('width'=>35,'justification'=>'center'),'LEVEL'=>array('width'=>65,'justification'=>'center'),
			...
			while ($data=mysqli_fetch_array($query))
			{
				if ($jenis=="penyakit")
				{
					...
					if ($jml_U==0) $jml_U="";
					$baris = array ('NO'=>$j,'ITEM'=>$data['penyakit'],'LEVEL'=>$data['skdi_level']."/".$data['k_level']."/".$data['ipsg_level']."/".$data['kml_level'],'TARGET'=>$data[$target_id],
				...
				if ($jenis=="ketrampilan")
				{
					...
					if ($jml_MKM==0) $jml_MKM="";
					if ($jml_U==0) $jml_U="";
					$baris = array ('NO'=>$j,'ITEM'=>$data['ketrampilan'],'LEVEL'=>$data['skdi_level']."/".$data['k_level']."/".$data['ipsg_level']."/".$data['kml_level'],'TARGET'=>$data[$target_id],
									'C1'=>$jml_1,'C2'=>$jml_2,'C3'=>$jml_3,'C4A'=>$jml_4A,'CMK'=>$jml_MKM,'CU'=>$jml_U,'GRADE'=>'<b>'.$bintang.'</b>');
				}
				$tabel3[1]=$baris;
				$no++;
				...
				{
					if ($bintang=="******")
					$pdf->ezTable($tabel3,$kolom_header,"",
						array('maxWidth'=>540,'width'=>520,'fontSize'=>8,'showHeadings'=>0,'shaded'=>$shaded,'showLines'=>2,'titleFontSize'=>9, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 1 ,'showBgCol'=> 1, 'shadeCol2' => array(0.9,0.9,0.9),
						'cols'=>array('NO'=>array('width'=>30,'justification'=>'center'),'TARGET'=>array('width'=>35,'justification'=>'center'),'LEVEL'=>array('width'=>65,'justification'=>'center'),
						'C1'=>array('width'=>25,'justification'=>'center'),'C2'=>array('width'=>25,'justification'=>'center'),'C3'=>array('width'=>25,'justification'=>'center'),
			...
			if ($i==$amp1)
			{
				...
				$tabel9[1] = array ('item1'=>"Keterangan Umum:",'item2'=>"Keterangan Grade:");
				...
				$tabel8_1[1] = array ('item'=>"Level S/K/I/M",'ket1'=>": Level SKDI/Kepmenkes/IPSG/Muatan Lokal",'grade'=>"******",'ket2'=>": Ada target kegiatan, target telah tercapai");
				$pdf->ezTable($tabel8_1,$kolom8,"",
				array('maxWidth'=>540,'width'=>520,'fontSize'=>6,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0 ,'showBgCol'=> 1,
				'cols'=>array('item'=>array('width'=>50),'ket1'=>array('width'=>210),'grade'=>array('width'=>25,'bgcolor'=>array(0, 150/250, 0)))));

				$tabel8_2[1] = array ('item'=>"C1",'ket1'=>": Capaian Kegiatan Level 1",'grade'=>"****",'ket2'=>": Ada target kegiatan, kegiatan sesuai level belum sampai 50%");
				$pdf->ezTable($tabel8_2,$kolom8,"",
				array('maxWidth'=>540,'width'=>520,'fontSize'=>6,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0 ,'showBgCol'=> 1,
				'cols'=>array('item'=>array('width'=>50),'ket1'=>array('width'=>210),'grade'=>array('width'=>25,'bgcolor' => array(0, 250/250, 0)))));

				$tabel8_3[1] = array ('item'=>"C2",'ket1'=>": Capaian Kegiatan Level 2",'grade'=>"**",'ket2'=>": Ada target kegiatan, kegiatan belum sesuai level");
				$pdf->ezTable($tabel8_3,$kolom8,"",
				array('maxWidth'=>540,'width'=>520,'fontSize'=>6,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0 ,'showBgCol'=> 1,
				'cols'=>array('item'=>array('width'=>50),'ket1'=>array('width'=>210),'grade'=>array('width'=>25,'bgcolor' => array(250/250, 250/250, 0)))));

				$tabel8_4[1] = array ('item'=>"C3",'ket1'=>": Capaian Kegiatan Level 3/3A/3B",'grade'=>"",'ket2'=>": Ada target kegiatan, belum ada kegiatan");
				$pdf->ezTable($tabel8_4,$kolom8,"",
				array('maxWidth'=>540,'width'=>520,'fontSize'=>6,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0 ,'showBgCol'=> 1,
				'cols'=>array('item'=>array('width'=>50),'ket1'=>array('width'=>210),'grade'=>array('width'=>25,'bgcolor' => array(250/250, 75/250, 0)))));

				$tabel8_5[1] = array ('item'=>"C4",'ket1'=>": Capaian Kegiatan Level 4/4A",'grade'=>"",'ket2'=>": Tidak ada target kegiatan, belum ada kegiatan");
				$pdf->ezTable($tabel8_5,$kolom8,"",
				array('maxWidth'=>540,'width'=>520,'fontSize'=>6,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0 ,'showBgCol'=> 1,
				'cols'=>array('item'=>array('width'=>50),'ket1'=>array('width'=>210),'grade'=>array('width'=>25,'bgcolor' => array(0.95, 0.95, 0.95)))));

				$tabel8_6[1] = array ('item'=>"CM",'ket1'=>": Capaian Kegiatan Masalah Kesehatan Masyarakat",'grade'=>" ",'ket2'=>" ");
				$pdf->ezTable($tabel8_6,$kolom8,"",
				array('maxWidth'=>540,'width'=>520,'fontSize'=>6,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0 ,'showBgCol'=> 0,
				'cols'=>array('item'=>array('width'=>50),'ket1'=>array('width'=>210),'grade'=>array('width'=>25))));

				$tabel8_7[1] = array ('item'=>"CU",'ket1'=>": Capaian Kegiatan Ujian",'grade'=>" ",'ket2'=>" ");
				$pdf->ezTable($tabel8_7,$kolom8,"",
				array('maxWidth'=>540,'width'=>520,'fontSize'=>6,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0 ,'showBgCol'=> 0,
				'cols'=>array('item'=>array('width'=>50),'ket1'=>array('width'=>210),'grade'=>array('width'=>25))));
				...
				if ($cetak=="tengah") $tabel4[1] = array ('item'=>"Ketuntasan Tengah Kepaniteraan/Stase",'nilai'=>": <b>$ketuntasan_rata %</b>");
				if ($cetak=="akhir") $tabel4[1] = array ('item'=>"Ketuntasan Akhir Kepaniteraan/Stase",'nilai'=>": <b>$ketuntasan_rata %</b>");
				$tabel4[2] = array ('item'=>"Ekivalensi Grade Huruf",'nilai'=>": <b>$grade</b>");
				$tanggal_cetak = tanggal_indo($tgl_cetak);
				$tabel4[3] = array ('item'=>"Tanggal Cetak Rekap",'nilai'=>": <b>$tanggal_cetak</b>");
				$pdf->ezTable($tabel4,$kolom4,"",
				array('maxWidth'=>520,'width'=>500,'fontSize'=>10,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0 ,
				...
				if ($cetak=="akhir")
				{
					...
					$tabel5[1] = array ('item1'=>"Semarang, "."......................... $tahun",'item2'=>"Semarang, "."......................... $tahun");
					$tabel5[2] = array ('item1'=>"Ketua Bagian/Koordinator Pendidikan Klinik",'item2'=>"Dosen Wali,");
					$tabel5[3] = array ('item1'=>"",'item2'=>"");
					$tabel5[4] = array ('item1'=>"",'item2'=>"");
					$tabel5[5] = array ('item1'=>"",'item2'=>"");
					$tabel5[6] = array ('item1'=>"(___________________________)",'item2'=>"($nama_dosenwali)");
					$tabel5[7] = array ('item1'=>"NIP.",'item2'=>" $nip_dosenwali");
				...
				else
				{
					$pdf->ezSetDy(-30,'');
					$kolom5 = array ('item'=>"");
					$tabel5[1] = array ('item'=>"Semarang, "."............................. $tahun");
					$tabel5[2] = array ('item'=>"");
					$tabel5[3] = array ('item'=>"Koordinator Pendidikan Klinik/Mentor");
					$tabel5[4] = array ('item'=>"");
					$tabel5[5] = array ('item'=>"");
					$tabel5[6] = array ('item'=>"");
					$tabel5[7] = array ('item'=>"(___________________________)");
					$tabel5[8] = array ('item'=>"NIP.");
					$pdf->ezTable($tabel5,$kolom5,"",
					array('maxWidth'=>520,'width'=>500,'fontSize'=>10,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0 ,
				...
				$pdf->ezSetDy(-20,'');
				$kolom6 = array ('item'=>"");
				$tabel6[1] = array ('item'=>"Komentar/Catatan:");
				$pdf->ezTable($tabel6,$kolom6,"",
				array('maxWidth'=>520,'width'=>500,'fontSize'=>8,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 0,
				'cols'=>array('item'=>array('justification'=>'left'))));
				$pdf->ezSetDy(-10,'');
				$kolom7 = array ('item'=>"");
				for ($dot=1;$dot<=5;$dot++)
					$tabel7[$dot] = array ('item'=>"................................................................................................................................................................................");
				$pdf->ezTable($tabel7,$kolom7,"",
				array('maxWidth'=>520,'width'=>500,'fontSize'=>10,'showHeadings'=>0,'shaded'=>0,'showLines'=>0,'titleFontSize'=>12, 'xPos' => 'center','xOrientation' => 'center','rowGap' => 4,
				'cols'=>array('item'=>array('justification'=>'left'))));
			}
		...
		ob_end_clean();
		$pdf->ezStream(array("Content-Disposition"=>"Rekap Jurnal $id_stase $mhsw_nim.pdf"));
