...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">FORM PENILAIAN KEPANITERAAN (STASE) ILMU PENYAKIT DALAM</font></h4><br>";
		$id_stase = "M091";
		...
		if ($cek_stase>=1)
		{
			echo "</center><br><a href=\"#minicex\"><i>Pengisian Formulir Penilaian Mini-Cex</i></a><br>";
			echo "<a href=\"#kasus\"><i>Pengisian Formulir Penilaian Penyajian Kasus Besar</i></a><br>";
			echo "<a href=\"#ujian\"><i>Pengisian Formulir Penilaian Ujian Akhir</i></a><br>";
			echo "<a href=\"#test\"><i>Preview Nilai Ujian Tulis MCQ</i></a><br><br>";
			...
			echo "<a id=\"ujian\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Pengisian Formulir Penilaian Ujian Akhir</font></a><br><br>";
			...
			echo "<br><br><br><center><a href=\"cetak_nilai_ipd.php\" target=\"_BLANK\"><input type=\"button\" id=\"cetak_nilai\" class=\"submit1\" name=\"cetak_nilai\" value=\"CETAK NILAI\"></a>";
			echo "</center><br><br>";
