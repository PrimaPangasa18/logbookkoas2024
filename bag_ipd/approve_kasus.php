...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">APPROVAL NILAI PENYAJIAN KASUS BESAR<p>KEPANITERAAN (STASE) ILMU PENYAKIT DALAM</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek1\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek1\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_1]\" required/></td>";
		echo "</tr>";
		//Aspek Naskah
		echo "<tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek2\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek2\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_2]\" required/></td>";
		echo "</tr>";
		//No 3
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek3\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek3\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_3]\" required/></td>";
		echo "</tr>";
		//Aspek Diskusi
		echo "<tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek4\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek4\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_4]\" required/></td>";
		echo "</tr>";
		//No 5
		echo "<tr>";
			echo "<td align=center>5</td>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek5\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek5\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_5]\" required/></td>";
		echo "</tr>";
		//No 6
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek6\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek6\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_6]\" required/></td>";
		echo "</tr>";
		//No 7
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek7\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek7\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_7]\" required/></td>";
		echo "</tr>";
		//No 8
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek8\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek8\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_8]\" required/></td>";
		echo "</tr>";
		//No 9
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek9\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek9\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_9]\" required/></td>";
		echo "</tr>";
		//No 10
		echo "<tr>";
			echo "<td align=center>10</td>";
			...
			echo "<td align=center>5%</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek10\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek10\" onkeyup=\"sum();\" onchange=\"sum();\" value=\"$data_kasus[aspek_10]\" required/></td>";
		echo "</tr>";
		//Nilai Rata-Rata
		echo "<tr>";
