...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==4)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">PENILAIAN KEPANITERAAN (STASE) ILMU PENYAKIT DALAM</font></h4>";
		...
		echo "</center><br><a href=\"#minicex\"><i>Penilaian Mini-Cex</i></a><br>";
		echo "<a href=\"#kasus\"><i>Penilaian Penyajian Kasus Besar</i></a><br>";
		echo "<a href=\"#ujian\"><i>Penilaian Ujian Akhir</i></a><br><br>";

		//Penilaian MINI-CEX
		echo "<a id=\"minicex\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian MINI-CEX</font></a><br><br>";
		...
		echo "<a id=\"ujian\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Ujian Akhir</font></a><br><br>";
