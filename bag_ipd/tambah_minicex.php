...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR PENILAIAN MINI-CEX<p>KEPANITERAAN (STASE) ILMU PENYAKIT DALAM</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"ruangan\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Nama Ruangan / Bangsal >>\" required></textarea></td>";
		echo "</tr>";
		//Umur Pasien
		echo "<tr>";
			echo "<td>Umur Pasien</td>";
			echo "<td><input type=\"number\" step=\"1\" min=\"0\" max=\"150\" name=\"umur_pasien\" style=\"width:20%;font-size:0.85em\" placeholder=\"0-150\" required/>&nbsp;&nbsp;tahun</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"diagnosis\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Problem / Diagnosis Pasien >>\" required></textarea></td>";
		echo "</tr>";
		echo "</table><br><br>";
		...
		echo "<table border=1 style=\"width:70%;background:rgb(244, 241, 217);\">";
		echo "<tr>";
			echo "<td>Umpan Balik Terhadap Mini-Cex:<br><textarea name=\"umpan_balik\" rows=5 style=\"width:100%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Umpan Balik >>\"></textarea></td>";
		echo "</tr>";
		echo "<tr>";
