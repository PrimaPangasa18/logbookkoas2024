...
<head>
	...
	<title>On-line Preview Mini Cex Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PREVIEW NILAI MINI-CEX<br>KEPANITERAAN (STASE) ILMU PENYAKIT DALAM</h2>
						<br>
						<?php
						$id_stase = "M091";
						$id = $_GET['id'];
						...
						echo "<td style=\" font-weight:600; color:darkgreen\">$data_minicex[ruangan]</td>";
						echo "</tr>";
						//Umur Pasien
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td>";
						if ($data_minicex['jk_pasien'] == "Laki-Laki") echo "<input type=\"radio\" name=\"jk_pasien\" style=\" transform: scale(1.2); margin-right: 5px;\" value=\"Laki-Laki\" checked/><label style=\" margin-right: 30px;\" for=\"jk_laki\">Laki-Laki</label>";
						else echo "<input type=\"radio\" style=\" transform: scale(1.2); margin-right: 5px;\" name=\"jk_pasien\" value=\"Laki-Laki\" disabled/><label style=\" margin-right: 30px;\" for=\"jk_laki\">Laki-Laki</label>";
						if ($data_minicex['jk_pasien'] == "Perempuan") echo "<input type=\"radio\" style=\" transform: scale(1.2); margin-right: 5px;\" name=\"jk_pasien\" value=\"Perempuan\" checked/><label for=\"jk_perempuan\">Perempuan</label>";
						else echo "<input type=\"radio\" style=\" transform: scale(1.2); margin-right: 5px;\" name=\"jk_pasien\" value=\"Perempuan\" disabled/><label for=\"jk_perempuan\">Perempuan</label>";
						echo "</td>";
						echo "</tr>";
						//Problem / Diagnosis Pasien
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Problem / Diagnosis Pasien</strong></td>";
						echo "<td><textarea name=\"diagnosis\" style=\" width: 100%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\"  disabled>$data_minicex[diagnosis]</textarea></td>";
						echo "</tr>";
						echo "</table><br><br>";
						...
						echo "<td align=center style=\" color:blue; \"><strong>$data_minicex[nilai_rata]</strong></td>";
						echo "</tr>";
						echo "</table><br><br>";
						...
						<textarea name=\"umpan_balik\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_minicex[umpan_balik]</textarea></td>";
						echo "</tr>";
						echo "<tr  class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
