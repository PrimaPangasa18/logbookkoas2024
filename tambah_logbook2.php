		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						<h3 class="fw-bold fs-4 mb-3">ISI LOGBOOK - KETRAMPILAN KLINIK</h3>
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">ISI LOGBOOK KEPANITERAAN (STASE) - KETRAMPILAN KLINIK</h2>
						<br>
						<?php
						...
						<div class="table-responsive">
							...
							<center>
								<div class="alert alert-warning" role="alert" style="width: 60%; margin: auto;">
									<!-- Keterampilan (Level)-->
									<span style="font-weight: 600; font-family:'Poppins'; color:darkblue">Ketrampilan (Level SKDI/Kepmenkes/IPSG/Muatan Lokal)</span>
								</div>
							</center>
							<br><br>
							<center>
