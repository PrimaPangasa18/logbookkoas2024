...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND ($_COOKIE['level']==1 OR $_COOKIE['level']==2 OR $_COOKIE['level']==3))
	{
	  ...
	  if ($_COOKIE['level']==3) {include "menu3.php";}
		...
		echo "<div class=\"text_header\" id=\"top\">REKAP INDIVIDU LOGBOOK</div>";
		...
		$jml_mhsw = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `$stase_id` WHERE `nim`='$mhsw_nim'"));
		...
		*/
		...
		echo "<table style=\"border:1;\">";
			...
			if ($jml_mhsw>=1)
			{
				...
				$status_stase = $data_stase_mhsw[status];
			}
			else
			{
		...
		while ($data=mysqli_fetch_array($daftar_penyakit))
		{
			...
			{
				$jml_MKM = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_penyakit_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
			...
			{
				$jml_1 = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_penyakit_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
					AND (`penyakit1`='$data[id]' OR `penyakit2`='$data[id]' OR `penyakit3`='$data[id]' OR `penyakit4`='$data[id]')
					AND (`kegiatan`='1' OR `kegiatan`='2')
					AND `status`='1' AND `evaluasi`='1' AND `username`='$_COOKIE[user]'"));
				$jml_2 = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_penyakit_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
					AND (`penyakit1`='$data[id]' OR `penyakit2`='$data[id]' OR `penyakit3`='$data[id]'  OR `penyakit4`='$data[id]')
					AND (`kegiatan`='3' OR `kegiatan`='4' OR `kegiatan`='5' OR `kegiatan`='6')
					AND `status`='1' AND `evaluasi`='1' AND `username`='$_COOKIE[user]'"));
				$jml_3 = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_penyakit_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
					AND (`penyakit1`='$data[id]' OR `penyakit2`='$data[id]' OR `penyakit3`='$data[id]'  OR `penyakit4`='$data[id]')
					AND (`kegiatan`='7' OR `kegiatan`='8' OR `kegiatan`='9')
					AND `status`='1' AND `evaluasi`='1' AND `username`='$_COOKIE[user]'"));
				$jml_4A = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_penyakit_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
					AND (`penyakit1`='$data[id]' OR `penyakit2`='$data[id]' OR `penyakit3`='$data[id]'  OR `penyakit4`='$data[id]')
					AND `kegiatan`='10'
					AND `status`='1' AND `evaluasi`='1' AND `username`='$_COOKIE[user]'"));
				$jml_U = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_penyakit_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
					AND (`penyakit1`='$data[id]' OR `penyakit2`='$data[id]' OR `penyakit3`='$data[id]'  OR `penyakit4`='$data[id]')
		...
		while ($data=mysqli_fetch_array($daftar_ketrampilan))
		{
			...
			if ($data[skdi_level]=="MKM" OR $data[k_level]=="MKM" OR $data[ipsg_level]=="MKM" OR $data[kml_level]=="MKM")
			{
			  $jml_MKM = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_ketrampilan_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
			...
			{
			  $jml_1 = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_ketrampilan_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
			    AND (`ketrampilan1`='$data[id]' OR `ketrampilan2`='$data[id]' OR `ketrampilan3`='$data[id]' OR `ketrampilan4`='$data[id]')
			    AND (`kegiatan`='1' OR `kegiatan`='2')
			    AND `status`='1' AND `evaluasi`='1' AND `username`='$_COOKIE[user]'"));
			  $jml_2 = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_ketrampilan_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
			    AND (`ketrampilan1`='$data[id]' OR `ketrampilan2`='$data[id]' OR `ketrampilan3`='$data[id]'  OR `ketrampilan4`='$data[id]')
			    AND (`kegiatan`='3' OR `kegiatan`='4' OR `kegiatan`='5' OR `kegiatan`='6')
			    AND `status`='1' AND `evaluasi`='1' AND `username`='$_COOKIE[user]'"));
			  $jml_3 = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_ketrampilan_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
			    AND (`ketrampilan1`='$data[id]' OR `ketrampilan2`='$data[id]' OR `ketrampilan3`='$data[id]'  OR `ketrampilan4`='$data[id]')
			    AND (`kegiatan`='7' OR `kegiatan`='8' OR `kegiatan`='9')
			    AND `status`='1' AND `evaluasi`='1' AND `username`='$_COOKIE[user]'"));
			  $jml_4A = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_ketrampilan_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
			    AND (`ketrampilan1`='$data[id]' OR `ketrampilan2`='$data[id]' OR `ketrampilan3`='$data[id]'  OR `ketrampilan4`='$data[id]')
			    AND `kegiatan`='10'
			    AND `status`='1' AND `evaluasi`='1' AND `username`='$_COOKIE[user]'"));
			  $jml_U = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `jurnal_ketrampilan_dummy` WHERE `nim`='$mhsw_nim' AND `stase`='$id_stase'
			    AND (`ketrampilan1`='$data[id]' OR `ketrampilan2`='$data[id]' OR `ketrampilan3`='$data[id]'  OR `ketrampilan4`='$data[id]')
			    AND (`kegiatan`='11' OR `kegiatan`='12')
			    AND `status`='1' AND `evaluasi`='1' AND `username`='$_COOKIE[user]'"));
			  $jml_MKM = 0;
		...
		{
			echo "<font style=\"color:green\">Sudah terisi ... </font><a href=\"lihat_evaluasi.php?id=$id_stase&nim=$mhsw_nim&menu=rekap\">LIHAT EVALUASI</a><br><br>";
		}
		else {
			echo "<br><font style=\"color:red\"><< BELUM MENGISI EVALUASI AKHIR!!! >></font><br><br>";
			echo "<a class=\"blink\"><font style=\"color:red\">Catatan: Rekap Akhir Kepaniteraan/Stase hanya bisa dicetak setelah mahasiswa mengisi evaluasi akhir Kepaniteraan/Stase!</a></font><br><br>";
		}
		...
		echo "<tr>";
			...
			if ($tengah_stase=="1")
				echo "<a href='cetak_setting.php?jenis=penyakit&cetak=tengah&id=$id_stase&nim=$mhsw_nim' target=\"_blank\"><img style=\"border:0;\" src=\"images\printer_run.png\" width=\"40px\" height=\"40px\" title=\"Cetak rekap ke pdf\"></a>";
				else
				echo "<img style=\"border:0;\" src=\"images\printer_stop.png\" width=\"40px\" height=\"40px\" title=\"Cetak rekap ke pdf\">";
			echo "</td>";
			echo "<td align=center>";
			if ($tengah_stase=="1")
				echo "<a href='cetak_setting.php?jenis=ketrampilan&cetak=tengah&id=$id_stase&nim=$mhsw_nim' target=\"_blank\"><img style=\"border:0;\" src=\"images\printer_run.png\" width=\"40px\" height=\"40px\" title=\"Cetak rekap ke pdf\"></a>";
				else
				echo "<img style=\"border:0;\" src=\"images\printer_stop.png\" width=\"40px\" height=\"40px\" title=\"Cetak rekap ke pdf\">";
			echo "</td>";
			echo "<td align=center>";
			if ($akhir_stase=="1")
				echo "<a href='cetak_setting.php?jenis=penyakit&cetak=akhir&id=$id_stase&nim=$mhsw_nim' target=\"_blank\"><img style=\"border:0;\" src=\"images\printer_run.png\" width=\"40px\" height=\"40px\" title=\"Cetak rekap ke pdf\"></a>";
				else
				echo "<img style=\"border:0;\" src=\"images\printer_stop.png\" width=\"40px\" height=\"40px\" title=\"Cetak rekap ke pdf\">";
			echo "</td>";
			echo "<td align=center>";
			if ($akhir_stase=="1")
				echo "<a href='cetak_setting.php?jenis=ketrampilan&cetak=akhir&id=$id_stase&nim=$mhsw_nim' target=\"_blank\"><img style=\"border:0;\" src=\"images\printer_run.png\" width=\"40px\" height=\"40px\" title=\"Cetak rekap ke pdf\"></a>";
				else
				echo "<img style=\"border:0;\" src=\"images\printer_stop.png\" width=\"40px\" height=\"40px\" title=\"Cetak rekap ke pdf\">";
			echo "</td>";
		echo "</tr>";
