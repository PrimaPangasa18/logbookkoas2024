			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PREVIEW NILAI JOURNAL READING<br>KEPANITERAAN (STASE) ILMU KEBIDANAN DAN PENYAKIT KANDUNGAN</h2>
						<br>
						<?php
						$id_stase = "M111";
						$id = $_GET['id'];
						...
						echo "<td align=center class=\"td_mid\" style=\"font-weight:600;\">$data_jurnal[aspek_1]</td>";
						echo "</tr>";
						//No 2
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>2</strong></td>";
						echo "<td><strong>Cara Penyajian</strong></td>";
						echo "<td align=center class=\"td_mid\" style=\"font-weight:600;\">$data_jurnal[aspek_2]</td>";
						echo "</tr>";
						//No 3
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>3</strong></td>";
						echo "<td><strong>Penguasaan Materi</strong></td>";
						echo "<td align=center class=\"td_mid\" style=\"font-weight:600;\">$data_jurnal[aspek_3]</td>";
						echo "</tr>";
						//No 4
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>4</strong></td>";
						echo "<td><strong>Keaktifan</strong></td>";
						echo "<td align=center class=\"td_mid\" style=\"font-weight:600;\">$data_jurnal[aspek_4]</td>";
						echo "</tr>";

						//Rata-Rata Nilai
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=2 align=right><strong>Rata-Rata Nilai <span class=\"text-danger\">(Total Nilai / 4)</span></strong></td>";
						echo "<td align=center class=\"td_mid\" style=\"font-weight:600; color:blue;\">$data_jurnal[nilai_rata]</td>";
						echo "</tr>";
						echo "</table><br>";
