...
<head>
	...
	<title>On-line Penilaian Bagian Obsgyn Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PENILAIAN KEPANITERAAN (STASE) ILMU KEBIDANAN DAN PENYAKIT KANDUNGAN</h2>
						<br>
						<?php
						...
						echo "
								...
								<br><br>
								<a href=\"#minicex\" class=\"btn btn-success me-3\">Penilaian Ujian MINI-CEX (Mini Clinical Examination)</a>
								<a href=\"#cbd\" class=\"btn btn-primary me-3\">Penilaian Case-Based Discussion (CBD)</a>
