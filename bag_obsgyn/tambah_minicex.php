			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN UJIAN MINI-CEX<br>KEPANITERAAN (STASE) ILMU KEBIDANAN DAN PENYAKIT KANDUNGAN</h2>
						<br>
						<?php
						$id_stase = "M111";
						...
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek_7\" style=\"width:55%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek_7\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 8
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>8</strong></td>";
						echo "<td><strong>Kompetensi Klinis Keseluruhan</strong></td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek_8\" style=\"width:55%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek_8\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//Rata Nilai
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_minicex = mysqli_query($con, "INSERT INTO `obsgyn_nilai_minicex`
				( `nim`, `dosen`,
					`tgl_ujian`, `diagnosis`, `situasi_ruangan`,
					`aspek_1`, `aspek_2`,
					`aspek_3`, `aspek_4`, `aspek_5`, `aspek_6`,
					`aspek_7`, `aspek_8`, `umpan_balik`,
					`saran`, `waktu_observasi`, `waktu_ub`,
					`nilai_rata`, `tgl_isi`, `tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]','$_POST[dosen]',
					'$_POST[tanggal_ujian]','$diagnosis','$_POST[situasi_ruangan]',
					'$aspek1','$aspek2',
					'$aspek3','$aspek4','$aspek5','$aspek6',
					'$aspek7','$aspek8','$umpan_balik',
