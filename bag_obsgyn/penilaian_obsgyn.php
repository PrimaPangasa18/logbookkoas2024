			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM PENILAIAN KEPANITERAAN (STASE) ILMU KEBIDANAN DAN PENYAKIT KANDUNGAN</h2>
						<br>
						<?php
						$id_stase = "M111";
						...
						if ($cek_stase >= 1) {
							echo "
								...
								<a href=\"#cbd\" class=\"btn btn-primary me-3\">Pengisian Formulir Penilaian Case-Based Discussion (CBD)</a>
								<a href=\"#jurnal\" class=\"btn me-3\" style=\"background-color: #800080; color: white;\">Pengisian Formulir Penilaian Journal Reading</a>
								<br><br>
								<a href=\"#test\" class=\"btn me-3\" style=\"background-color: #A52A2A; color: white;\">Preview Nilai Penugasan dan Test (DOPS/OSCE, MCQ, dan MINI-PAT)</a>
								<br><br>
								";
							echo "</center>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							echo "<a id=\"test\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Preview Nilai Penugasan dan Test (DOPS/OSCE, MCQ, dan MINI-PAT)</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Nilai</th>
							...
							echo "<br><br><br><a href=\"cetak_nilai_obsgyn.php\" target=\"_BLANK\">";
