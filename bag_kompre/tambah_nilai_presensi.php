...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR PENILAIAN PRESENSI / KEHADIRAN</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"lokasi\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Lokasi Kegiatan Kepaniteraan Komprehensip >>\" required></textarea></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td style=\"width:60%\">: <input type=\"number\" step=\"1\" min=\"0\" max=\"100\" name=\"hari_kerja\" style=\"width:25%;font-size:0.85em;text-align:center\" id=\"hari_kerja\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/>&nbsp;&nbsp;hari</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td>: <input type=\"number\" step=\"1\" min=\"0\" max=\"100\" name=\"hari_ijin\" style=\"width:25%;font-size:0.85em;text-align:center\" id=\"hari_ijin\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/>&nbsp;&nbsp;hari</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td>: <input type=\"number\" step=\"1\" min=\"0\" max=\"100\" name=\"hari_alpa\" style=\"width:25%;font-size:0.85em;text-align:center\" id=\"hari_alpa\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/>&nbsp;&nbsp;hari</td>";
		echo "</tr>";
		//Jumlah Hari Masuk
		echo "<tr>";
			...
			echo "<td>: <input type=\"number\" step=\"1\" min=\"0\" max=\"100\" name=\"hari_masuk\" style=\"width:25%;font-size:0.85em;text-align:center\" id=\"hari_masuk\" value=\"0\" required/>&nbsp;&nbsp;hari</td>";
		echo "</tr>";
		echo "</table><br><br>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_masuk\" style=\"width:60%;font-size:0.85em;text-align:center\" id=\"nilai_masuk\" value=\"0\" required/></td>";
		echo "</tr>";
		//No 2
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"5\" min=\"-100\" max=\"0\" name=\"nilai_absen\" style=\"width:60%;font-size:0.85em;text-align:center\" id=\"nilai_absen\" value=\"0\" required/></td>";
		echo "</tr>";
		//No 3
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"2\" min=\"-100\" max=\"0\" name=\"nilai_ijin\" style=\"width:60%;font-size:0.85em;text-align:center\" id=\"nilai_ijin\" value=\"0\" required/></td>";
		echo "</tr>";
		//No 4
		echo "<tr>";
			echo "<td align=right colspan=2>Total Nilai (Skor 1 + Skor 2 + Skor 3)</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_total\" style=\"font-weight:bold;width:60%;font-size:0.85em;text-align:center\" id=\"nilai_total\" value=\"0\" required/></td>";
		echo "</tr>";
		echo "</table><br>";
