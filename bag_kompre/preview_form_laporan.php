...
error_reporting("E_ALL ^ E_NOTICE");
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">PREVIEW NILAI PORTOFOLIO LAPORAN<p>Kepaniteraan Komprehensip di Rumah Sakit / Puskesmas</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td align=center>$data_laporan[aspek1_ind]</td>";
			echo "<td align=center>$data_laporan[aspek1_kelp]</td>";
		echo "</tr>";
		//No 2
		echo "<tr>";
			...
			echo "<td align=center>$data_laporan[aspek2_ind]</td>";
			echo "<td align=center>$data_laporan[aspek2_kelp]</td>";
		echo "</tr>";
		//No 3
		echo "<tr>";
			...
			echo "<td align=center>20%</td>";
			echo "<td align=center>$data_laporan[aspek3_ind]</td>";
			echo "<td align=center>$data_laporan[aspek3_kelp]</td>";
		echo "</tr>";
		//No 4
		echo "<tr>";
			...
			echo "<td align=center>$data_laporan[aspek4_ind]</td>";
			echo "<td align=center>$data_laporan[aspek4_kelp]</td>";
		echo "</tr>";
		//No 5
		echo "<tr>";
			...
			echo "<td align=center>20%</td>";
			echo "<td align=center>$data_laporan[aspek5_ind]</td>";
			echo "<td align=center>$data_laporan[aspek5_kelp]</td>";
		echo "</tr>";
		echo "<tr><td colspan=3 align=right>Rata-Rata Nilai (Jumlah Bobot x Nilai)</td>";
			echo "<td align=center><b>$data_laporan[nilai_rata_ind]</b></td>";
			echo "<td align=center><b>$data_laporan[nilai_rata_kelp]</b></td>";
		echo "</tr>";
		echo "</table><br>";
		...
		echo "<table border=1 style=\"width:70%;background:rgb(244, 241, 217);\">";
		echo "<tr>";
		  echo "<td>Umpan Balik:<br><textarea name=\"umpan_balik\" rows=5 style=\"width:100%;font-family:Tahoma;font-size:1em\" disabled>$data_laporan[umpan_balik]</textarea></td>";
		echo "</tr>";
		echo "<tr>";
		  echo "<td>Saran:<br><textarea name=\"saran\" rows=5 style=\"width:100%;font-family:Tahoma;font-size:1em\" disabled>$data_laporan[saran]</textarea></td>";
		echo "</tr>";
		echo "<tr><td align=right><br><i>Status: <b>BELUM DISETUJUI</b><br>";
		echo "Dosen Pembimbing Lapangan<p>$data_dosen[nama], $data_dosen[gelar]<br>NIP. $data_dosen[nip]</i>";
		echo "</td></tr>";
		echo "</table><br>";
