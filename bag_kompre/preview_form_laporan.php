...
<head>
	...
	<title>On-line Preview Laporan Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PREVIEW NILAI PORTOFOLIO LAPORAN<br>KEPANITERAAN KOMPREHENSIP DI RUMAH SAKIT / PUSKESMAS</h2>
						<br>
						<?php
						$id = $_GET['id'];
						...
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek1_ind]</td>";
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek1_kelp]</td>";
						echo "</tr>";
						//No 2
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek2_ind]</td>";
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek2_kelp]</td>";
						echo "</tr>";
						//No 3
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>20%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek3_ind]</td>";
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek3_kelp]</td>";
						echo "</tr>";
						//No 4
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek4_ind]</td>";
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek4_kelp]</td>";
						echo "</tr>";
						//No 5
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>20%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek5_ind]</td>";
						echo "<td align=center style=\"font-weight:600;\">$data_laporan[aspek5_kelp]</td>";
						echo "</tr>";
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=3 align=right><strong>Rata-Rata Nilai <span class=\"text-danger\">(Jumlah Bobot x Nilai)</span></strong></td>";
						echo "<td align=center style=\"font-weight:600; color:blue;\">$data_laporan[nilai_rata_ind]</td>";
						echo "<td align=center style=\"font-weight:600; color:blue;\">$data_laporan[nilai_rata_kelp]</td>";
						echo "</tr>";
						echo "</table><br>";
						...
						<textarea name=\"umpan_balik\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_laporan[umpan_balik]</textarea></td>";
						echo "</tr>";
						echo "<tr  class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Saran:</strong><br>
						<textarea name=\"saran\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_laporan[saran]</textarea></td>";
						echo "</tr>";

						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">
						<td  align=right><br><span style=\"font-weight:600;\">Status: </span><strong class=\"text-danger\" >BELUM DISETUJUI</strong><br>";
						echo "<span style=\"font-weight:600;\">Dosen Pembimbing Lapangan:<p><span style=\"font-weight:500;\">$data_dosen[nama]</span>, <span style=\"font-weight:500; color:red\">$data_dosen[gelar]</span><br>NIP. <span style=\"font-weight:600; color:blue;\">$data_dosen[nip]</span></span>";
						echo "</td></tr>";
						echo "</table><br>";
