			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI CASE BASED DISCUSSION (CBD)</h2>
						<br>
						<?php
						$id_stase = "M121";
						...
						<input type=\"text\" class=\"form-select tgl_isi\" name=\"tgl_isi\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" value=\"$tgl\" /></td>";
						echo "</tr>";
						//Jam kegiatan
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
