			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PENILAIAN KEPANITERAAN KOMPREHENSIP</h2>
						<br>
						<?php
						...
						echo "
								...
								<br><br>
								<a href=\"#laporan\" class=\"btn btn-success me-3\">Penilaian Laporan</a>
								...
								<br><br>
								<a href=\"#presensi\" class=\"btn me-3\" style=\"background-color: #A52A2A; color: white;\">Penilaian Presensi / Kehadiran</a>
								<br><br>
								";
						echo "</center>";
						...
						//Penilaian Laporan
						echo "<br><br>";
						echo "<a id=\"laporan\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Laporan</a><br><br>";
					...
					<th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						if ($cek_nilai_laporan < 1) {
							...
							while ($data_laporan = mysqli_fetch_array($nilai_laporan)) {
								...
								echo "<td style=\"font-weight:600;\">Instansi: $data_laporan[instansi]<br>Lokasi: $data_laporan[lokasi]</td>";
								...
								<span style=\"color:red;\">NIM: $data_mhsw[nim]</span><br><br>";
								...
								if ($data_laporan['status_approval'] == '0') {
									...
									echo "<br><br>
										<a href=\"approve_laporan_dosen.php?id=$data_laporan[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"approve_$data_laporan[id]\" value=\"VIEW & APPROVE\">
									...
									echo "<br><br>
										<a href=\"view_form_laporan.php?id=$data_laporan[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
									...
									echo "<br><br>
									<a href=\"unapprove_laporan_dosen.php?id=$data_laporan[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"unapprove\".\"$data_laporan[id]\"  value=\"UNAPPROVE\">
					...
					<th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						if ($cek_nilai_sikap < 1) {
							...
							while ($data_sikap = mysqli_fetch_array($nilai_sikap)) {
								...
								echo "<td style=\"text-align:center; font-weight:600;\">$no</td>";
								echo "<td style=\"text-align:center;color:darkblue; font-weight:600;\">$tanggal_isi</td>";
								echo "<td style=\"font-weight:600;\">Instansi: $data_sikap[instansi]<br>Lokasi: $data_sikap[lokasi]<br>";
								echo "Nilai: $data_sikap[nilai_rata]</td>";
								echo "<td align=center style=\"font-weight:600;\">$tanggal_mulai<br>s.d.<br>$tanggal_selesai</td>";
								echo "<td style=\"font-weight:600;\"><span style=\"color:purple;\">Nama Mahasiswa: $data_mhsw[nama]</span><br>
								<span style=\"color:red;\">NIM: $data_mhsw[nim]</span><br></td>";
								echo "<td align=center>";
