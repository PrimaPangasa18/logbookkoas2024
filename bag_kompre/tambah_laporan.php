...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR NILAI PORTOFOLIO LAPORAN<p>Kepaniteraan Komprehensip di Rumah Sakit / Puskesmas</font></h4>";
		...
		//Lokasi RS/Puskesmas
		echo "<tr>";
			echo "<td style=\"width:40%\">Nama Rumah Sakit / Puskesmas</td>";
			echo "<td style=\"width:60%\"><textarea name=\"lokasi\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Lokasi Kegiatan Kepaniteraan Komprehensip >>\" required></textarea></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek1_ind\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek1_ind\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek1_kelp\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek1_kelp\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 2
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek2_ind\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek2_ind\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek2_kelp\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek2_kelp\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 3
		echo "<tr>";
			...
			echo "<td align=center>20%</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek3_ind\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek3_ind\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek3_kelp\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek3_kelp\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 4
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek4_ind\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek4_ind\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek4_kelp\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek4_kelp\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		//No 5
		echo "<tr>";
			...
			echo "<td align=center>20%</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek5_ind\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek5_ind\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek5_kelp\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"aspek5_kelp\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
		echo "</tr>";
		echo "<tr>";
			echo "<td colspan=3 align=right>Rata-Rata Nilai (Jumlah Bobot x Nilai)</td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_rata_ind\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"nilai_rata_ind\" value=\"0\" required/></td>";
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_rata_kelp\" style=\"width:100%;font-size:0.85em;text-align:center\" id=\"nilai_rata_kelp\" value=\"0\" required/></td>";
		echo "</tr>";
		echo "</table><br>";
