			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT NILAI PORTOFOLIO LAPORAN<br>KEPANITERAAN KOMPREHENSIP DI RUMAH SAKIT / PUSKESMAS</h2>
						<br>
						<?php
						$id_stase = "M121";
						$id = $_GET['id'];
						...
						echo "<option value=\"$data_laporan[instansi]\">$data_laporan[instansi]</option>";
						if ($data_laporan['instansi'] != "Puskesmas") echo "<option value=\"Puskesmas\">Puskesmas</option>";
						if ($data_laporan['instansi'] != "Rumah Sakit") echo "<option value=\"Rumah Sakit\">Rumah Sakit</option>";
						echo "</select></td>";
						echo "</tr>";
						//Lokasi Puskesmas/Klinik
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Nama Rumah Sakit / Puskesmas</strong></td>";
						echo "<td style=\"width:60%\"><textarea name=\"lokasi\" style=\" width: 100%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" required>$data_laporan[lokasi]</textarea></td>";
						echo "</tr>";
						...
						<input type=\"text\" class=\"form-select tgl_mulai\" name=\"tgl_mulai\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" value=\"$data_laporan[tgl_mulai]\"  /></td>";
						echo "</tr>";
						//Tgl selesai kegiatan
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Tanggal selesai kegiatan <span class=\"text-danger\">(yyyy-mm-dd)</span></strong></td>";
						echo "<td class=\"td_mid\">
						<input type=\"text\" class=\"form-select tgl_selesai\" name=\"tgl_selesai\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" value=\"$data_laporan[tgl_selesai]\" /></td>";
						echo "</tr>";
						...
						$data_dosen_db = mysqli_fetch_array(mysqli_query($con, "SELECT `nip`,`nama`,`gelar` FROM `dosen` WHERE `nip`='$data_laporan[dosen]'"));
						echo "<option value=\"$data_laporan[dosen]\">$data_dosen_db[nama], $data_dosen_db[gelar] ($data_dosen_db[nip])</option>";
				...
				`dosen`='$_POST[dosen]',
				`lokasi`='$lokasi',`instansi`='$_POST[instansi]',
