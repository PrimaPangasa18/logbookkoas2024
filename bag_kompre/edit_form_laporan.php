...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">EDIT NILAI PORTOFOLIO LAPORAN<p>Kepaniteraan Komprehensip di Rumah Sakit / Puskesmas</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"lokasi\" value=\"$data_laporan[lokasi]\" style=\"width:97%;font-family:Tahoma;font-size:1em\" required>$data_laporan[lokasi]</textarea></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td><input type=\"text\" name=\"tgl_mulai\" class=\"tgl_mulai\" value=\"$data_laporan[tgl_mulai]\" style=\"font-size:0.85em\" required/></td>";
		echo "</tr>";
		//Tgl selesai kegiatan
		echo "<tr>";
			echo "<td>Tanggal selesai kegiatan (yyyy-mm-dd)</td>";
			echo "<td><input type=\"text\" name=\"tgl_selesai\" class=\"tgl_selesai\" value=\"$data_laporan[tgl_selesai]\" style=\"font-size:0.85em\" required/></td>";
		echo "</tr>";
