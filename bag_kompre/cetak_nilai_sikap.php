...
if (empty($_COOKIE['user']) || empty($_COOKIE['pass'])) {
	...
	if (!empty($_COOKIE['user']) and !empty($_COOKIE['pass']) and ($_COOKIE['level'] == 1 or $_COOKIE['level'] == 2 or $_COOKIE['level'] == 3 or $_COOKIE['level'] == 5)) {
		...
		$daftar_sikap = mysqli_query($con, "SELECT * FROM `kompre_nilai_sikap` WHERE `nim`='$nim_mhsw_kompre' AND `status_approval`='1' ORDER BY `tgl_approval` ASC");
		...
		while ($data_sikap = mysqli_fetch_array($daftar_sikap)) {
			...
			$kolom1 = array('item' => "");
			$tabel1[1] = array('item' => "NILAI SIKAP KEPANITERAAN KOMPREHENSIP");
			...
			$tabel2[5] = array('item' => "Lokasi Puskesmas/Rumah Sakit", 'isi' => ": " . "$data_sikap[lokasi]");
		...
		$kolom7 = array('item' => "");
		$tabel7[1] = array('item' => "RATA-RATA NILAI SIKAP KEPANITERAAN KOMPREHENSIP");
		...
		$tabel11[1] = array('TOTAL' => 'Rata-Rata Nilai (Jumlah Bobot x Nilai):', 'NILAI' => "<b>$total_sikap_puskesmas</b>");
		$pdf->ezTable(
			$tabel11,
			$kolom11,
			"",
		...
		//Rekap rumkit
		$kolom8b = array('ITEM' => '');
		$tabel8b[1] = array('ITEM' => '<b>Rekap Rata-Rata Nilai Sikap di Rumah Sakit</b>');
		$pdf->ezTable(
			$tabel8b,
			$kolom8b,
			"",
		...
		$tabel10a[1] = array('NO' => '1', 'ASPEK' => $aspek1, 'BOBOT' => '15%', 'NILAI' => $rata_aspek1_rumkit);
		$tabel10a[2] = array('NO' => '2', 'ASPEK' => $aspek2, 'BOBOT' => '15%', 'NILAI' => $rata_aspek2_rumkit);
		$tabel10a[3] = array('NO' => '3', 'ASPEK' => $aspek3, 'BOBOT' => '15%', 'NILAI' => $rata_aspek3_rumkit);
		$tabel10a[4] = array('NO' => '4', 'ASPEK' => $aspek4, 'BOBOT' => '15%', 'NILAI' => $rata_aspek4_rumkit);
		$tabel10a[5] = array('NO' => '5', 'ASPEK' => $aspek5, 'BOBOT' => '15%', 'NILAI' => $rata_aspek5_rumkit);
		$tabel10a[6] = array('NO' => '6', 'ASPEK' => $aspek6, 'BOBOT' => '15%', 'NILAI' => $rata_aspek6_rumkit);
		$tabel10a[7] = array('NO' => '7', 'ASPEK' => $aspek7, 'BOBOT' => '10%', 'NILAI' => $rata_aspek7_rumkit);
		$pdf->ezTable(
			$tabel10a,
			$kolom10a,
			"",
		...
		$tabel11a[1] = array('TOTAL' => 'Rata-Rata Nilai (Jumlah Bobot x Nilai):', 'NILAI' => "<b>$total_sikap_rumkit</b>");
		$pdf->ezTable(
			$tabel11a,
			$kolom11a,
			"",
