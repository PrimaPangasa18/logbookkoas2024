			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM APPROVAL JURNAL LOGBOOK KETERAMPILAN</h2>
						<br>
						<?php
						$id_logbook = $_GET['id'];
						$jurnal = mysqli_fetch_array(mysqli_query($con, "SELECT `stase`,`dosen` FROM `jurnal_ketrampilan` WHERE `id`='$id_logbook'"));
							...
							<table class="table table-bordered">
								<tbody>
									...
									<tr class="table-warning" style="border-width: 1px; border-color: #000;">
										...
										<td>
											<div class="position-relative">
												<input type="password" name="dosenpass" class="form-control" autocomplete="off" style="font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;" readonly onfocus="this.removeAttribute('readonly');" id="dosenpass" />
									...
									<tr class="table-primary" style="border-width: 1px; border-color: #000;">
										...
										<td>
											<input name="dosenpin" style="font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;" autocomplete="off" type="number" class="form-control" />
										</td>
									</tr>
									<tr class="table-warning" style="border-width: 1px; border-color: #000;">
						...
						if ($_POST['approve'] == "APPROVE") {
							$jurnal = mysqli_fetch_array(mysqli_query($con, "SELECT `dosen` FROM `jurnal_ketrampilan` WHERE `id`='$_POST[id_logbook]'"));
							...
							if (($_POST['dosenpass'] != "" && $dosenpass_md5 == $user_dosen['password'])
								...
								$update_status = mysqli_query($con, "UPDATE `jurnal_ketrampilan` SET `status`='1' WHERE `id`='$_POST[id_logbook]'");
						...
						?>
							...
							?>
								<script type="text/javascript">
									...
									window.location.href = 'approve2.php?id=' + idlog;
								</script>
						<?php
							}
						}
