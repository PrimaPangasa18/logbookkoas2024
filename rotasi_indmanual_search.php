        ...
        <div class="container-fluid">
          <div class="mb-3">
            ...
            <h2 class="fw-bold fs-4 mb-3 text-center" style="color: #0a3967">
              ROTASI INDIVIDU KEPANITERAAN (STASE) - TAMBAHAN/PENGGANTI
            </h2>
            <br>
            <?php
            ...
            <div class="container mt-5">
              ...
              if (isset($_POST['cari']) && $_POST['cari'] === "CARI") {
                ...
                if ($jml >= 1) {
                  ...
                  echo '<small class="text-danger" style="font-weight:700">(Klik tombol Username untuk edit rotasi kepaniteraan/stase secara manual)</small>';
                  echo '<p></p>';
                  ...
                  while ($data = mysqli_fetch_array($user_kunci)) {
                    ...
                    echo '<td style="text-align:center"><a href="rotasi_indmanual.php?user_name=' . urlencode($data['username']) . '" class="btn btn-outline-primary">' . htmlspecialchars($data['username']) . '</a></td>';
