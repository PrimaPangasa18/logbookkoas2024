  ...
  <div class="wrapper">
    ...
    <legend align=left><font style=\"color:black;font-style:italic;font-size:0.825em;\">[user: $_COOKIE[nama], $_COOKIE[gelar]]</font></legend>";
      ...
      if ($_POST['cari'] == "CARI") {
        ...
        if ($jml >= 1) {
          echo "<font style=\"font-size:0.625em\"><i>(Klik username untuk edit rotasi kepaniteraan/stase secara manual)</i></font><p>";
          ...
          while ($data = mysqli_fetch_array($user_kunci)) {
            ...
            echo "<td><a href=\"rotasi_indmanual.php?user_name=$data[username]\">$data[username]</a></td>";
