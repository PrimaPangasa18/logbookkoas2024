...
if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND ($_COOKIE['level']==1 OR $_COOKIE['level']==2 OR $_COOKIE['level']==5))
{
  ...
  <img id="preview" src=<?="foto/$biodata_mhsw[foto]"?> width="150px" height="auto"/><br/>
    <input type="file" id="image" name="foto_profile" style="display: none;" accept="image/*"/><br/>
    <a style="color:green;font-size:0.875em" href="javascript:changeProfile()">Ganti</a> |
    <a style="color:red;font-size:0.875em" href="javascript:removeImage()">Hapus</a><br/><br/>
