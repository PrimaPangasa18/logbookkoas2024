		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						<h3 class="fw-bold fs-4 mb-3">EDIT KETRAMPILAN</h3>
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT KETRAMPILAN</h2>
						<br>
						<?php
						...
						echo "<textarea name=\"ketrampilan\" rows=\"1\" class=\"form-control\" style=\"border:0.5px solid grey;border-radius:5px; font-weight:600;\">$data_ketrampilan[ketrampilan]</textarea>";
						echo "</td>";
						echo "</tr>";
						...
						while ($data = mysqli_fetch_array($daftar_stase)) {
							...
							if ($data_ketrampilan[$nama_cek] == '1') {
								...
								echo "<input type=\"text\" class=\"form-control\" style=\"width:100%;text-align:center; border:2px solid black;border-radius:5px;\" name=\"$target\" id=\"$target\" value=\"$data_ketrampilan[$target]\"></td>";
							} else {
