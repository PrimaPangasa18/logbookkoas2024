...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">APPROVAL NILAI UJIAN MINI-CEX<p>Kepaniteraan (Stase) Neurologi</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td class=\"td_mid\"><input type=\"text\" class=\"periode_awal\" name=\"periode_awal\" style=\"font-size:1em;font-family:TAHOMA;padding:0 0 0 7px;height:27px;border:0.5px solid grey;border-radius:5px;\" value=\"$data_minicex[tgl_awal]\" />";
			echo " s.d. <input type=\"text\" class=\"periode_akhir\" name=\"periode_akhir\" style=\"font-size:1em;font-family:TAHOMA;padding:0 0 0 7px;height:27px;border:0.5px solid grey;border-radius:5px;\" value=\"$data_minicex[tgl_akhir]\" /></td>";
		echo "</tr>";
		//Tanggal Ujian
		echo "<tr>";
    ...
    echo "</form>";
		...
		{
			$dosen_minicex = mysqli_fetch_array(mysqli_query($con,"SELECT `dosen` FROM `neuro_nilai_minicex` WHERE `id`='$_POST[id]'"));
