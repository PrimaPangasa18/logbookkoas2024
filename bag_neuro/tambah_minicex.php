			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN UJIAN MINI-CEX<br>KEPANITERAAN (STASE) NEUROLOGI</h2>
						<br>
						<?php
						$id_stase = "M092";
						...
						echo "<td style=\"font-weight:600;\"><input type=\"number\" step=\"1\" min=\"0\" max=\"150\" name=\"umur_pasien\" style=\"width:20%;font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px; text-align:center;\" placeholder=\"0-150\" required/>&nbsp;&nbsp;Tahun</td>";
						echo "</tr>";
						...
						echo "<td><textarea name=\"diagnosis\" style=\"width:100%; font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" placeholder=\"<< Problem Pasien/Diagnosis >>\" required></textarea></td>";
						echo "</tr>";
						//Tingkat Kerumitan
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_minicex = mysqli_query($con, "INSERT INTO `neuro_nilai_minicex`
				( `nim`, `dosen`, `tgl_awal`, `tgl_akhir`,
					`tgl_ujian`, `diagnosis`, `situasi_ruangan`, `jk_pasien`,
					`umur_pasien`, `tingkat_kerumitan`, `aspek_1`, `aspek_2`,
					`aspek_3`, `aspek_4`, `aspek_5`, `aspek_6`,
					`aspek_7`, `aspek_8`, `ub_bagus`, `ub_perbaikan`,
					`saran`, `waktu_observasi`, `waktu_ub`,
					`nilai_rata`, `tgl_isi`, `tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]','$_POST[dosen]','$_POST[periode_awal]','$_POST[periode_akhir]',
					'$_POST[tanggal_ujian]','$diagnosis','$_POST[situasi_ruangan]','$_POST[jk_pasien]',
					'$umur_pasien','$_POST[tingkat_kerumitan]','$aspek1','$aspek2',
					'$aspek3','$aspek4','$aspek5','$aspek6',
					'$aspek7','$aspek8','$ub_bagus','$ub_perbaikan',
