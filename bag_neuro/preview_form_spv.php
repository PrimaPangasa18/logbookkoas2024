...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">PREVIEW NILAI UJIAN SPV<p>Kepaniteraan (Stase) Neurologi</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td class=\"td_mid\"><b>$data_spv[nilai]</b></td>";
		echo "</tr>";
		//Catatan Penguji
		echo "<tr>";
			echo "<td colspan=2>Catatan Penguji:<p>";
			echo "<textarea name=\"catatan\" rows=5 style=\"width:100%;font-family:Tahoma;font-size:1em\" disabled>$data_spv[catatan]</textarea></td>";
		echo "</tr>";
