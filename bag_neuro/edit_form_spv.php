...
<head>
	...
	<title>On-line Edit Ujian SPV Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT NILAI UJIAN SPV<br>KEPANITERAAN (STASE) NEUROLOGI</h2>
						<br>
						<?php
						$id = $_GET['id'];
						...
						echo "<td class=\"td_mid\"><input type=\"text\" class=\"form-select tanggal_ujian\" name=\"tanggal_ujian\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" value=\"$data_spv[tgl_ujian]\" /></td>";
						echo "</tr>";
						//Dosen Penguji
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						$data_dosen_isian = mysqli_fetch_array(mysqli_query($con, "SELECT `nip`,`nama`,`gelar` FROM `dosen` WHERE `nip`='$data_spv[dosen]'"));
						...
						//Nilai Ujian SPV
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td class=\"td_mid\"><strong>Nilai Ujian SPV (0-100)</strong></td>";
						echo "<td class=\"td_mid\"><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai\" style=\"text-align:center;width:20%; height:30px;border:0.2px solid black;border-radius:3px;font-size:1.0em\" value=\"$data_spv[nilai]\" required/></td>";
						echo "</tr>";
						//Catatan Penguji
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=2><strong>Catatan Penguji:</strong><p>";
						echo "<textarea name=\"catatan\" rows=5 style=\"width:100%; margin-top:10px;font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\">$data_spv[catatan]</textarea></td>";
						echo "</tr>";
						echo "</table><br><br>";
						echo "<br>
				...
				`dosen`='$_POST[dosen]',`tgl_ujian`='$_POST[tanggal_ujian]',`nilai`='$nilai',
