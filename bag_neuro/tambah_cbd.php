...
<body>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN KASUS CBD<br>KEPANITERAAN (STASE) NEUROLOGI</h2>
						<br>
						<?php
						$id_stase = "M092";
        				...
        				<input type=\"radio\" name=\"kasus_ke\" value=\"1\" style=\"transform: scale(1.2); margin-right: 5px;\" checked/> 
        				<span style=\"margin-left: 5px;\">1</span>
    					</label>
    					<label style=\"margin-right: 20px;\">
        				<input type=\"radio\" name=\"kasus_ke\" value=\"2\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
        				<span style=\"margin-left: 5px;\">2</span>
    					</label>
    					<label style=\"margin-right: 20px;\">
       					<input type=\"radio\" name=\"kasus_ke\" value=\"3\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
        				<span style=\"margin-left: 5px;\">3</span>
   				 		</label>
    					<label style=\"margin-right: 20px;\">
        				<input type=\"radio\" name=\"kasus_ke\" value=\"4\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
        				<span style=\"margin-left: 5px;\">4</span>
    					</label>
    					<label>
        				<input type=\"radio\" name=\"kasus_ke\" value=\"5\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
						...
						echo "<option value=\"\"><< Dosen Pembimbing/Penguji >></option>";
						...
						echo "<td style=\"font-weight:600;\">
   							 <label style=\"margin-right: 20px;\">
        					<input type=\"radio\" name=\"situasi_ruangan\" value=\"IRD\" style=\"transform: scale(1.2); margin-right: 5px;\" checked/> 
        					<span style=\"margin-left: 5px;\">IRD</span>
    						</label>
    						<label style=\"margin-right: 20px;\">
        					<input type=\"radio\" name=\"situasi_ruangan\" value=\"Rawat Jalan\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
        					<span style=\"margin-left: 5px;\">Rawat Jalan</span>
    						</label>
    						<label>
        					<input type=\"radio\" name=\"situasi_ruangan\" value=\"Lain-lain\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
        					<span style=\"margin-left: 5px;\">Lain-lain</span>
    						</label>
							</td>";
						echo "</tr>";
        				...
        				<input type=\"radio\" name=\"fokus_kasus\" value=\"Pembuatan Rekam Medik\" style=\"transform: scale(1.2); margin-right: 5px;\" checked/> 
        				<span style=\"margin-left: 5px;\">Pembuatan Rekam Medik</span>
    					</label>
    					<label style=\"display: block; margin-bottom: 10px;\">
        				<input type=\"radio\" name=\"fokus_kasus\" value=\"Clinical Assesment\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
        				<span style=\"margin-left: 5px;\">Clinical Assesment</span>
    					</label>
    					<label style=\"display: block; margin-bottom: 10px;\">
        				<input type=\"radio\" name=\"fokus_kasus\" value=\"Tata Laksana\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
        				<span style=\"margin-left: 5px;\">Tata Laksana</span>
    					</label>
    					<label style=\"display: block;\">
        				<input type=\"radio\" name=\"fokus_kasus\" value=\"Profesionalisme\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
        				<span style=\"margin-left: 5px;\">Profesionalisme</span>
    					</label>
						</td>";
						echo "</tr>";
						...
						echo "<td style=\"font-weight:600;\">
    					<label style=\"margin-right: 20px;\">
        				<input type=\"radio\" name=\"tingkat_kerumitan\" value=\"Rendah\" style=\"transform: scale(1.2); margin-right: 5px;\" checked/> 
        				<span style=\"margin-left: 5px;\">Rendah</span>
    					</label>
    					<label style=\"margin-right: 20px;\">
        				<input type=\"radio\" name=\"tingkat_kerumitan\" value=\"Sedang\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
        				<span style=\"margin-left: 5px;\">Sedang</span>
    					</label>
    					<label>
        				<input type=\"radio\" name=\"tingkat_kerumitan\" value=\"Tinggi\" style=\"transform: scale(1.2); margin-right: 5px;\"/> 
       				 	<span style=\"margin-left: 5px;\">Tinggi</span>
    					</label>
						</td>";
						echo "</tr>";
    ...
    <label style=\"margin-right: 20px;\">
        <input type=\"radio\" name=\"observasi1\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" checked />
        <span style=\"margin-left: 5px;\">Ya</span>
    </label>
    <label>
        <input type=\"radio\" name=\"observasi1\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" />
        <span style=\"margin-left: 5px;\">Tidak</span>
						...
						echo "<td align=\"center\" style=\"font-weight:600;\">
    <label style=\"margin-right: 20px;\">
        <input type=\"radio\" name=\"observasi2\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" checked />
        <span style=\"margin-left: 5px;\">Ya</span>
    </label>
    <label>
        <input type=\"radio\" name=\"observasi2\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" />
        <span style=\"margin-left: 5px;\">Tidak</span>
    </label>
</td>";
						...
						echo "<td align=\"center\" style=\"font-weight:600;\">
    <label style=\"margin-right: 20px;\">
        <input type=\"radio\" name=\"observasi3\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" checked />
        <span style=\"margin-left: 5px;\">Ya</span>
    </label>
    <label>
        <input type=\"radio\" name=\"observasi3\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" />
        <span style=\"margin-left: 5px;\">Tidak</span>
    </label>
</td>";
						...
						echo "<td align=\"center\" style=\"font-weight:600;\">
    <label style=\"margin-right: 20px;\">
        <input type=\"radio\" name=\"observasi4\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" checked />
        <span style=\"margin-left: 5px;\">Ya</span>
    </label>
    <label>
        <input type=\"radio\" name=\"observasi4\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" />
        <span style=\"margin-left: 5px;\">Tidak</span>
    </label>
</td>";
						...
						echo "<td align=\"center\" style=\"font-weight:600;\">
    <label style=\"margin-right: 20px;\">
        <input type=\"radio\" name=\"observasi5\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" checked />
        <span style=\"margin-left: 5px;\">Ya</span>
    </label>
    <label>
        <input type=\"radio\" name=\"observasi5\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" />
        <span style=\"margin-left: 5px;\">Tidak</span>
    </label>
</td>";
						...
						echo "<td align=\"center\" style=\"font-weight:600;\">
    <label style=\"margin-right: 20px;\">
        <input type=\"radio\" name=\"observasi6\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" checked />
        <span style=\"margin-left: 5px;\">Ya</span>
    </label>
    <label>
        <input type=\"radio\" name=\"observasi6\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" />
        <span style=\"margin-left: 5px;\">Tidak</span>
    </label>
</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek6\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek6\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 7
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=\"center\" style=\"font-weight:600;\">
    <label style=\"margin-right: 20px;\">
        <input type=\"radio\" name=\"observasi7\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" checked />
        <span style=\"margin-left: 5px;\">Ya</span>
    </label>
    <label>
        <input type=\"radio\" name=\"observasi7\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" style=\"transform: scale(1.2); margin-right: 5px;\" />
        <span style=\"margin-left: 5px;\">Tidak</span>
    </label>
</td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek7\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek7\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//Rata Nilai
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td style=\"font-weight:600;\">";
						echo "<input type=\"number\" step=\"5\" min=\"0\" max=\"1500\" name=\"waktu_observasi\" style=\"width:20%;font-family:Poppins;font-size:0.9em;text-align:center;\" placeholder=\"0\" required/>&nbsp;&nbsp;Menit<br>";
						echo "</td>";
						echo "</tr>";
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td>&nbsp;&nbsp;<strong>Memberikan umpan balik</strong></td>";
						echo "<td style=\"font-weight:600;\">";
						echo "<input type=\"number\" step=\"5\" min=\"0\" max=\"1500\" name=\"waktu_ub\" style=\"width:20%;font-family:Poppins;font-size:0.9em;text-align:center;\" placeholder=\"0\" required/>&nbsp;&nbsp;Menit<br>";
						echo "</td>";
						echo "</tr>";
						echo "</table><br>";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_cbd = mysqli_query($con, "INSERT INTO `neuro_nilai_cbd`
