...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR PENILAIAN KASUS CBD<p>Kepaniteraan (Stase) Neurologi</font></h4>";
		...
		echo "<tr>";
			...
			echo "<input type=\"radio\" name=\"kasus_ke\" value=\"1\" checked/>&nbsp;&nbsp;1
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"kasus_ke\" value=\"2\" />&nbsp;&nbsp;2
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"kasus_ke\" value=\"3\" />&nbsp;&nbsp;3
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"kasus_ke\" value=\"4\" />&nbsp;&nbsp;4
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type=\"radio\" name=\"kasus_ke\" value=\"5\" />&nbsp;&nbsp;5";
			echo "</td>";
		echo "</tr>";
