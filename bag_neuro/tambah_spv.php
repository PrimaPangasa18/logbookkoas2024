...
<head>
	...
	<title>On-line Tambah Ujian SPV Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('../images/undip_watermark_color.png'), url('../images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN UJIAN SPV<br>KEPANITERAAN (STASE) NEUROLOGI</h2>
						<br>
						<?php
						$id_stase = "M092";
						...
						echo "<textarea name=\"catatan\" rows=5 style=\"width:100%; margin-top:10px;font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\"></textarea></td>";
						echo "</tr>";
						echo "</table><br><br>";
