			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM PENILAIAN KEPANITERAAN (STASE) NEUROLOGI</h2>
						<br>
						<?php
						$id_stase = "M092";
						...
						if ($cek_stase >= 1) {
							echo "
								...
								<br><br>
								<a href=\"#cbd\" class=\"btn btn-success me-3\">Pengisian Formulir Penilaian Kasus CBD</a>
								<a href=\"#jurnal\" class=\"btn btn-primary me-3\">Pengisian Formulir Penilaian Journal Reading</a>
								<a href=\"#spv\" class=\"btn me-3\" style=\"background-color: #800080; color: white;\">Pengisian Formulir Penilaian Ujian SPV</a>
								<br><br>
								<a href=\"#minicex\" class=\"btn me-3\" style=\"background-color: #A52A2A; color: white;\">Pengisian Formulir Penilaian Ujian Minicex</a>
								<a href=\"#test\" class=\"btn me-3\" style=\"background-color: #00008B; color: white;\">Preview Nilai Penugasan dan Test</a>
								<br><br>
								";
							echo "</center>";
							...
							echo "<br><br>";
							echo "<a id=\"cbd\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Kasus CBD</a><br><br>";
							...
							echo "<a id=\"spv\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Ujian SPV</a><br><br>";
							...
							if ($cek_nilai_spv < 1) {
								...
								while ($data_spv = mysqli_fetch_array($nilai_spv)) {
									...
									if ($data_spv['status_approval'] == '0')
										echo " <a href=\"approve_spv.php?id=$data_spv[id]\">
   												<button type=\"button\"  class=\"btn btn-primary btn-sm\" name=\"approve_$data_spv[id]\" >
    											<i class=\"fas fa-notes-medical me-2\"></i> APPROVE
												</button></a>";
									echo "</td>";
									echo "<td align=center>";
									if ($data_spv['status_approval'] == '0') {
										echo "<font style=\"color:red; font-weight:600;\">BELUM DISETUJUI</font><br><br>";
										echo "<a href=\"edit_form_spv.php?id=$data_spv[id]\">
       										 <button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"edit_$data_spv[id]\" value=\"EDIT\">
            								<i class=\"fas fa-edit me-2\"></i> EDIT
       										</button>
      										</a><p><br>";
										echo "<a href=\"preview_form_spv.php?id=$data_spv[id]\">
        										<button type=\"button\" class=\"btn btn-primary btn-sm\" name=\"preview_$data_spv[id]\" value=\"PREVIEW\">
            								<i class=\"fas fa-eye me-2\"></i> PREVIEW
        									</button>
      										</a><p>";
										echo "<a href=\"hapus_form_spv.php?id=$data_spv[id]\">
        									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"hapus_$data_spv[id]\" value=\"HAPUS\">
            								<i class=\"fas fa-trash-alt me-2\"></i> HAPUS
        									</button>
      										</a>";
									} else {
										...
										echo "<span style=\"color:darkblue; font-weight:600;\">$tanggal_approval</span>";
										echo "<br><br>
										<a href=\"view_form_spv.php?id=$data_spv[id]\">
							...
							echo "</table>";
							if ($cek_nilai_spv < 1)
								echo "<br><center><a href=\"tambah_spv.php\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-success\" name=\"tambah\" value=\"TAMBAH\"><i class=\"fas fa-plus\"></i> TAMBAH</button>
								</a>";
