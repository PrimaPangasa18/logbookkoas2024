			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN JOURNAL READING<br>KEPANITERAAN (STASE) NEUROLOGI</h2>
						<br>
						<?php
						$id_stase = "M092";
						...
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_total\" style=\"width:30%;font-size:0.85em;text-align:center\" value=\"0\" id=\"nilai_total\" required disabled/></td>";
						echo "</tr>";
						echo "</table><br><br>";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_jurnal = mysqli_query($con, "INSERT INTO `neuro_nilai_jurnal`
