...
<head>
	...
	<title>On-line Preview Jurnal Reading Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PREVIEW NILAI JOURNAL READING<br>KEPANITERAAN (STASE) NEUROLOGI</h2>
						<br>
						<?php
						$id_stase = "M092";
						$id = $_GET['id'];
						...
						echo "<td style=\" font-weight:600; color:purple\">$data_jurnal[nama_jurnal]</td>";
						echo "</tr>";
						//Judul Artikel
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><span style=\"color:blue; font-weight:600;\">$data_jurnal[nilai_total]</span></td>";
						echo "</tr>";
						echo "</table><br><br>";
						...
						echo "<span style=\"font-weight:600;\">Dosen Penilai (Tutor):<p><span style=\"font-weight:500;\">$data_dosen[nama]</span>, <span style=\"font-weight:500; color:red\">$data_dosen[gelar]</span><br>NIP. <span style=\"font-weight:600; color:blue;\">$data_dosen[nip]</span></span>";
						echo "</td></tr>";
						echo "</table><br>";
