...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR PENILAIAN UJIAN OSCE<p>KEPANITERAAN (STASE) ANESTESI DAN INTENSIVE CARE</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_total\" style=\"width:100%;font-size:0.85em;text-align:center\" value=\"0\" id=\"nilai_total\" required/></td>";
		echo "</tr>";
		//Catatan Penguji
		echo "<tr>";
