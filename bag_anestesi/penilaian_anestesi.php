...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">FORM PENILAIAN KEPANITERAAN (STASE) ANESTESI DAN INTENSIVE CARE</font></h4><br>";
		$id_stase = "M102";
		...
		if ($cek_stase>=1)
		{
			echo "</center><br><a href=\"#dops\"><i>Pengisian Formulir Penilaian DOPS</i></a><br>";
			...
			echo "<a id=\"dops\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Pengisian Formulir Penilaian DOPS</font></a><br><br>";
			...
			echo "<br><br><br><center><a href=\"cetak_nilai_anestesi.php\" target=\"_BLANK\"><input type=\"button\" id=\"cetak_nilai\" class=\"submit1\" name=\"cetak_nilai\" value=\"CETAK NILAI\"></a>";
			echo "</center><br><br>";
