...
<head>
	...
	<title>On-line Penilaian Bagian Anestesi Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM PENILAIAN KEPANITERAAN (STASE) ANESTESI DAN INTENSIVE CARE</h2>
						<br>
						<?php
						$id_stase = "M102";
						...
						if ($cek_stase >= 1) {
							echo "
								...
								<br><br>
								<a href=\"#dops\" class=\"btn btn-success me-3\">Pengisian Formulir Penilaian DOPS</a>
								<a href=\"#osce\" class=\"btn btn-primary me-3\">Pengisian Formulir Penilaian Ujian OSCE</a>
								<a href=\"#test\" class=\"btn me-3\" style=\"background-color: #800080; color: white;\">Preview Nilai-Nilai Test dan Perilaku</a>
								<br><br>
								";
							echo "</center>";
							echo "<br><br>";
							...
							echo "<a id=\"dops\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian DOPS</a><br><br>";
							$nilai_dops = mysqli_query($con, "SELECT * FROM `anestesi_nilai_dops` WHERE `nim`='$_COOKIE[user]'");
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							$cek_approved_dops = mysqli_num_rows(mysqli_query($con, "SELECT `id` FROM `anestesi_nilai_dops` WHERE `nim`='$_COOKIE[user]' AND `status_approval`='1'"));
							...
							$nilai_osce = mysqli_query($con, "SELECT * FROM `anestesi_nilai_osce` WHERE `nim`='$_COOKIE[user]'");
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							$cek_approved_osce = mysqli_num_rows(mysqli_query($con, "SELECT `id` FROM `anestesi_nilai_osce` WHERE `nim`='$_COOKIE[user]' AND `status_approval`='1'"));
							if ($cek_approved_osce > 0)
								echo "<br><br><center><a href=\"cetak_osce.php\" target=\"_BLANK\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-primary\" name=\"cetak\" value=\"CETAK\"><i class=\"fas fa-print\"></i> CETAK</button>
								</a>";
							echo "</center><br>";
							echo "</center>";
							...
							$nilai_test = mysqli_query($con, "SELECT * FROM `anestesi_nilai_test` WHERE `nim`='$_COOKIE[user]'");
			      ...
			      <th style=\"width:15%; text-align: center;\">Nilai</th>
							...
							echo "</table>";
							echo "<center>";
							$cek_approved_test = mysqli_num_rows(mysqli_query($con, "SELECT `id` FROM `anestesi_nilai_test` WHERE `nim`='$_COOKIE[user]' AND `status_approval`='1'"));
							if ($cek_approved_test > 0)
								echo "<br><center><a href=\"cetak_nilai_test.php\" target=\"_BLANK\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-primary\" name=\"cetak\" value=\"CETAK\"><i class=\"fas fa-print\"></i> CETAK</button>
								</a>";
							echo "<br><br><br><a href=\"cetak_nilai_anestesi.php\" target=\"_BLANK\">";
