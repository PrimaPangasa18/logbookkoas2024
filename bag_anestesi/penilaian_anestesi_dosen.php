			...
			<main class="content px-3 py-4" style="background-image: url('../images/undip_watermark_color.png'), url('../images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PENILAIAN KEPANITERAAN (STASE) ANESTESI DAN INTENSIVE CARE</h2>
						<br>
						<?php
						...
						echo "
								...
								<br><br>
								<a href=\"#dops\" class=\"btn btn-success me-3\">Penilaian DOPS</a>
								<a href=\"#osce\" class=\"btn btn-primary me-3\">Penilaian Ujian OSCE</a>
								<br><br>
								";
						echo "</center>";
						echo "<br><br>";
