...
<body>
	<div class="wrapper">
	    ...
	    <legend align=left><font style=\"color:black;font-style:italic;font-size:0.825em;\">[user: $_COOKIE[nama], $_COOKIE[gelar]]</font></legend>";
			...
			echo "</tr>";
			echo "<tr class=\"ganjil\">";
			echo "<td class=\"td_mid\">Tanggal kegiatan (yyyy-mm-dd)</td><td class=\"td_mid\"><input type=\"text\" class=\"input-tanggal\" name=\"tgl_kegiatan\" value=\"Semua Tanggal\" style=\"font-size:1em;font-family:GEORGIA;padding:0 0 0 7px;height:27px;border:0.5px solid grey;border-radius:5px;\" /></td>";
			echo "</tr>";
			echo "</table>";
