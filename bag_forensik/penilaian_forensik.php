			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM PENILAIAN KEPANITERAAN (STASE) KEDOKTERAN FORENSIK DAN MEDIKOLEGAL</h2>
						<br>
						<?php
						$id_stase = "M112";
						...
						if ($cek_stase >= 1) {
							echo "
								...
								<br><br>
								<a href=\"#visum\" class=\"btn btn-success me-3\">Pengisian Formulir Penilaian Visum Bayangan</a>
								<a href=\"#jaga\" class=\"btn btn-primary me-3\">Pengisian Formulir Penilaian Kegiatan Jaga</a>
								<a href=\"#substase\" class=\"btn me-3\" style=\"background-color: #800080; color: white;\">Pengisian Formulir Penilaian Substase</a>
								<br><br>
								<a href=\"#referat\" class=\"btn me-3\" style=\"background-color: #A52A2A; color: white;\">Pengisian Formulir Penilaian Referat</a>
								<a href=\"#test\" class=\"btn me-3\" style=\"background-color: #00008B; color: white;\">Preview Nilai-Nilai Test dan Perilaku</a>
								<br><br>
								";
							echo "</center>";
							...
							echo "<br><br>";
							echo "<a id=\"visum\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Visum Bayangan</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							if ($cek_nilai_visum < 1) {
								...
								while ($data_visum = mysqli_fetch_array($nilai_visum)) {
									...
									if ($data_visum['status_approval'] == '0')
										echo " <a href=\"approve_visum.php?id=$data_visum[id]\">
   												<button type=\"button\"  class=\"btn btn-primary btn-sm\" name=\"approve_$data_visum[id]\" >
									...
									if ($data_visum['status_approval'] == '0') {
										...
										echo "<a href=\"edit_form_visum.php?id=$data_visum[id]\">
       										 <button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"edit_$data_visum[id]\" value=\"EDIT\">
            								<i class=\"fas fa-edit me-2\"></i> EDIT
       										</button>
      										</a><p><br>";
										echo "<a href=\"preview_form_visum.php?id=$data_visum[id]\">
        										<button type=\"button\" class=\"btn btn-primary btn-sm\" name=\"preview_$data_visum[id]\" value=\"PREVIEW\">
            								<i class=\"fas fa-eye me-2\"></i> PREVIEW
        									</button>
      										</a><p>";
										echo "<a href=\"hapus_form_visum.php?id=$data_visum[id]\">
        									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"hapus_$data_visum[id]\" value=\"HAPUS\">
										...
										echo "<br><br>
										<a href=\"view_form_visum.php?id=$data_visum[id]\">
							...
							if ($cek_nilai_visum < 4)
								echo "<br><center><a href=\"tambah_visum.php\">
							...
							if ($cek_approved_visum > 0)
								echo "<br><br><center><a href=\"cetak_visum.php\" target=\"_BLANK\">
							...
							echo "<a id=\"jaga\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Kegiatan Jaga</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							if ($cek_nilai_jaga < 1) {
								...
								while ($data_jaga = mysqli_fetch_array($nilai_jaga)) {
									...
									if ($data_jaga['status_approval'] == '0')
										echo " <a href=\"approve_jaga.php?id=$data_jaga[id]\">
   												<button type=\"button\"  class=\"btn btn-primary btn-sm\" name=\"approve_$data_jaga[id]\" >
    											<i class=\"fas fa-notes-medical me-2\"></i> APPROVE
												</button></a>";
									echo "</td>";
									echo "<td align=center>";
									if ($data_jaga['status_approval'] == '0') {
										echo "<font style=\"color:red; font-weight:600;\">BELUM DISETUJUI</font><br><br>";
										echo "<a href=\"edit_form_jaga.php?id=$data_jaga[id]\">
       										 <button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"edit_$data_jaga[id]\" value=\"EDIT\">
            								<i class=\"fas fa-edit me-2\"></i> EDIT
       										</button>
      										</a><p><br>";
										echo "<a href=\"preview_form_jaga.php?id=$data_jaga[id]\">
        										<button type=\"button\" class=\"btn btn-primary btn-sm\" name=\"preview_$data_jaga[id]\" value=\"PREVIEW\">
            								<i class=\"fas fa-eye me-2\"></i> PREVIEW
        									</button>
      										</a><p>";
										echo "<a href=\"hapus_form_jaga.php?id=$data_jaga[id]\">
        									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"hapus_$data_jaga[id]\" value=\"HAPUS\">
            								<i class=\"fas fa-trash-alt me-2\"></i> HAPUS
        									</button>
      										</a>";
									} else {
										...
										echo "<span style=\"color:darkblue; font-weight:600;\">$tanggal_approval</span>";
										echo "<br><br>
										<a href=\"view_form_jaga.php?id=$data_jaga[id]\">
							...
							echo "</table>";
							if ($cek_nilai_jaga < 4)
								echo "<br><center><a href=\"tambah_jaga.php\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-success\" name=\"tambah\" value=\"TAMBAH\"><i class=\"fas fa-plus\"></i> TAMBAH</button>
								</a>";
							...
							if ($cek_approved_jaga > 0)
								echo "<br><br><center><a href=\"cetak_jaga.php\" target=\"_BLANK\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-primary\" name=\"cetak\" value=\"CETAK\"><i class=\"fas fa-print\"></i> CETAK</button>
								</a>";
							echo "</center>";
							echo "</center><br><br>";
							...
							echo "<a id=\"substase\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Substase</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							if ($cek_nilai_substase < 1) {
								...
								while ($data_substase = mysqli_fetch_array($nilai_substase)) {
									...
									if ($data_substase['status_approval'] == '0')
										echo " <a href=\"approve_substase.php?id=$data_substase[id]\">
   												<button type=\"button\"  class=\"btn btn-primary btn-sm\" name=\"approve_$data_substase[id]\" >
    											<i class=\"fas fa-notes-medical me-2\"></i> APPROVE
												</button></a>";
									echo "</td>";
									echo "<td align=center>";
									if ($data_substase['status_approval'] == '0') {
										echo "<font style=\"color:red; font-weight:600;\">BELUM DISETUJUI</font><br><br>";
										echo "<a href=\"edit_form_substase.php?id=$data_substase[id]\">
       										 <button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"edit_$data_substase[id]\" value=\"EDIT\">
            								<i class=\"fas fa-edit me-2\"></i> EDIT
       										</button>
      										</a><p><br>";
										echo "<a href=\"preview_form_substase.php?id=$data_substase[id]\">
        										<button type=\"button\" class=\"btn btn-primary btn-sm\" name=\"preview_$data_substase[id]\" value=\"PREVIEW\">
            								<i class=\"fas fa-eye me-2\"></i> PREVIEW
        									</button>
      										</a><p>";
										echo "<a href=\"hapus_form_substase.php?id=$data_substase[id]\">
        									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"hapus_$data_substase[id]\" value=\"HAPUS\">
            								<i class=\"fas fa-trash-alt me-2\"></i> HAPUS
        									</button>
      										</a>";
									} else {
										...
										echo "<span style=\"color:darkblue; font-weight:600;\">$tanggal_approval</span>";
										echo "<br><br>
										<a href=\"view_form_substase.php?id=$data_substase[id]\">
							...
							if ($cek_nilai_substase < 4)
								echo "<br><center><a href=\"tambah_substase.php\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-success\" name=\"tambah\" value=\"TAMBAH\"><i class=\"fas fa-plus\"></i> TAMBAH</button>
								</a>";
							...
							if ($cek_approved_substase > 0)
								echo "<br><br><center><a href=\"cetak_substase.php\" target=\"_BLANK\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-primary\" name=\"cetak\" value=\"CETAK\"><i class=\"fas fa-print\"></i> CETAK</button>
								</a>";
							echo "</center><br><br>";
							echo "</center>";
							...
							echo "<a id=\"referat\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Referat</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							if ($cek_nilai_referat < 1) {
								...
								while ($data_referat = mysqli_fetch_array($nilai_referat)) {
									...
									if ($data_referat['status_approval'] == '0')
										echo " <a href=\"approve_referat.php?id=$data_referat[id]\">
   												<button type=\"button\"  class=\"btn btn-primary btn-sm\" name=\"approve_$data_referat[id]\" >
    											<i class=\"fas fa-notes-medical me-2\"></i> APPROVE
												</button></a>";
									echo "</td>";
									echo "<td align=center>";
									if ($data_referat['status_approval'] == '0') {
										echo "<font style=\"color:red; font-weight:600;\">BELUM DISETUJUI</font><br><br>";
										echo "<a href=\"edit_form_referat.php?id=$data_referat[id]\">
       										 <button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"edit_$data_referat[id]\" value=\"EDIT\">
            								<i class=\"fas fa-edit me-2\"></i> EDIT
       										</button>
      										</a><p><br>";
										echo "<a href=\"preview_form_referat.php?id=$data_referat[id]\">
        										<button type=\"button\" class=\"btn btn-primary btn-sm\" name=\"preview_$data_referat[id]\" value=\"PREVIEW\">
            								<i class=\"fas fa-eye me-2\"></i> PREVIEW
        									</button>
      										</a><p>";
										echo "<a href=\"hapus_form_referat.php?id=$data_referat[id]\">
        									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"hapus_$data_referat[id]\" value=\"HAPUS\">
            								<i class=\"fas fa-trash-alt me-2\"></i> HAPUS
        									</button>
      										</a>";
									} else {
										...
										echo "<span style=\"color:darkblue; font-weight:600;\">$tanggal_approval</span>";
										echo "<br><br>
										<a href=\"view_form_referat.php?id=$data_referat[id]\">
							...
							echo "</table>";
							if ($cek_nilai_referat < 1)
								echo "<br><center><a href=\"tambah_referat.php\" >
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-success\" name=\"tambah\" value=\"TAMBAH\"><i class=\"fas fa-plus\"></i> TAMBAH</button>
								</a>";
							...
							if ($cek_approved_referat > 0)
								echo "<br><br><center><a href=\"cetak_referat.php\" target=\"_BLANK\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-primary\" name=\"cetak\" value=\"CETAK\"><i class=\"fas fa-print\"></i> CETAK</button>
								</a>";
							echo "</center><br><br>";
							echo "</center>";
							...
							echo "<a id=\"test\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Preview Nilai-Nilai Test dan Perilaku</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Nilai</th>
							...
							echo "<br><br><br><a href=\"cetak_nilai_forensik.php\" target=\"_BLANK\">";
