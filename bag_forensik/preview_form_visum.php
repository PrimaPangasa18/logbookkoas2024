...
error_reporting("E_ALL ^ E_NOTICE");
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">PREVIEW NILAI VISUM BAYANGAN<p>KEPANITERAAN (STASE) KEDOKTERAN FORENSIK DAN MEDIKOLEGAL</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td>$data_visum[dosen_ke]</td>";
		echo "</tr>";
		//Dosen Penilai
		echo "<tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center>$data_visum[aspek_1]</td>";
		echo "</tr>";
		//No 2
		echo "<tr>";
			...
			echo "<td align=center>30%</td>";
			echo "<td align=center>$data_visum[aspek_2]</td>";
		echo "</tr>";
		//No 3
		echo "<tr>";
			...
			echo "<td align=center>$data_visum[aspek_3]</td>";
		echo "</tr>";
		//Nilai Rata-Rata
		echo "<tr>";
			echo "<td colspan=3 align=right>Rata-Rata Nilai (Jumlah Bobot x Nilai)</td>";
			echo "<td align=center><b>$data_visum[nilai_rata]</b></td>";
		echo "</tr>";
		//Catatan
		echo "<tr>";
			echo "<td colspan=4><b>Umpan Balik:</b><br><br>";
			echo "Catatan:<br>";
			echo "<textarea name=\"catatan\" style=\"width:100%;font-family:Tahoma;font-size:1em\" rows=5 disabled>$data_visum[catatan]</textarea><br><br>";
			echo "Saran:<br>";
			echo "<textarea name=\"saran\" style=\"width:100%;font-family:Tahoma;font-size:1em\" rows=5 disabled>$data_visum[saran]</textarea>";
			echo "</td>";
		echo "</tr>";
