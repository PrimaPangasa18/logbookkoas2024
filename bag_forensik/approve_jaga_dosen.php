...
<head>
	...
	<title>On-line Approval Kegiatan Jaga Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">APPROVAL NILAI KEGIATAN JAGA<br>KEPANITERAAN (STASE) KEDOKTERAN FORENSIK DAN MEDIKOLEGAL</h2>
						<br>
						<?php
						$id_stase = "M094";
						$id = $_GET['id'];
