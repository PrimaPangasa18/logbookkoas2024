...
<head>
	...
	<title>On-line Edit Substase Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT FORMULIR PENILAIAN SUBSTASE<br>KEPANITERAAN (STASE) KEDOKTERAN FORENSIK DAN MEDIKOLEGAL</h2>
						<br>
						<?php
						$id_stase = "M112";
						$id = $_GET['id'];
						...
						echo "<td>";
						echo "<select class=\"form-select\" name=\"dosen_ke\" id=\"dosen_ke\" required>";
						echo "<option value=\"$data_substase[dosen_ke]\">$data_substase[dosen_ke]</option>";
						...
						$data_dosen_isian = mysqli_fetch_array(mysqli_query($con, "SELECT `nip`,`nama`,`gelar` FROM `dosen` WHERE `nip`='$data_substase[dosen]'"));
