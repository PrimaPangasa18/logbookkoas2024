...
<?php
	...
	{
		include "menu5.php";
		echo "<div class=\"text_header\">ISI EVALUASI KEPANITERAAN (STASE)</div>";
		echo "<br><br><br><fieldset class=\"fieldset_art\">
	    	<legend align=left><font style=\"color:black;font-style:italic;font-size:0.825em;\">[user: $_COOKIE[nama], $_COOKIE[gelar]]</font></legend>";
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">ISI EVALUASI  KEPANITERAAN (STASE)</font></h4>";
		...
		echo "</tr>";
		echo "<tr>";
		echo "<td><textarea name=\"refleksi\" style=\"font-family:Tahoma;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
		echo "</tr>";
		//Komentar
		echo "<tr>";
		...
		echo "</tr>";
		echo "<tr>";
		echo "<td><textarea name=\"komentar\" style=\"font-family:Tahoma;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
		echo "</tr>";
		//Pencapaian
		echo "<tr>";
		echo "<td>";
			...
			echo "<tr><td style=\"width:5%;padding:0 0 0 10px\"><div class=\"clearfix\"><div class=\"radio\">
						<input type=\"radio\" name=\"input_12\" value=\"1\" id=\"1input_12\" required>
			...
			echo "<tr><td style=\"width:5%;padding:0 0 0 10px\"><div class=\"clearfix\"><div class=\"radio\">
						<input type=\"radio\" name=\"input_12\" value=\"2\" id=\"2input_12\">
			...
			echo "<tr><td style=\"width:5%;padding:0 0 0 10px\"><div class=\"clearfix\"><div class=\"radio\">
						<input type=\"radio\" name=\"input_12\" value=\"3\" id=\"3input_12\">
			...
			echo "<tr><td style=\"width:5%;padding:0 0 0 10px\"><div class=\"clearfix\"><div class=\"radio\">
						<input type=\"radio\" name=\"input_12\" value=\"4\" id=\"4input_12\">
		...
		echo "<td>";
			...
			echo "</tr>";
			echo "<tr><td style=\"width:5%;padding:0 0 0 10px\"><div class=\"clearfix\"><div class=\"radio\">
						<input type=\"radio\" name=\"input_13\" value=\"1\" id=\"1input_13\" required>
			...
			echo "<tr><td style=\"width:5%;padding:0 0 0 10px\"><div class=\"clearfix\"><div class=\"radio\">
						<input type=\"radio\" name=\"input_13\" value=\"2\" id=\"2input_13\">
			...
			echo "<tr><td style=\"width:5%;padding:0 0 0 10px\"><div class=\"clearfix\"><div class=\"radio\">
						<input type=\"radio\" name=\"input_13\" value=\"3\" id=\"3input_13\">
			...
			echo "<tr><td style=\"width:5%;padding:0 0 0 10px\"><div class=\"clearfix\"><div class=\"radio\">
						<input type=\"radio\" name=\"input_13\" value=\"4\" id=\"4input_13\">
		...
		for ($x = 1; $x <= 3; $x++)
		{
			...
			echo "&nbsp;&nbsp;<textarea name=\"$tatap_mukax\" style=\"font-family:Tahoma;font-size:0.85em;border:0.5px solid grey;border-radius:5px;\" rows=1 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
			echo "</tr>";
			//Dosen x Umum
			echo "<tr>";
			...
			echo "<td><textarea name=\"$komentar_dosenx\" style=\"font-family:Tahoma;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
			echo "</tr>";
		...
		echo "<textarea name=\"lokasi_luar\" style=\"font-family:Tahoma;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
		echo "</tr>";
		//Lama stase luar
		echo "<tr>";
		...
		echo "</tr>";
		echo "<tr>";
		echo "<td><textarea name=\"like_luar\" style=\"font-family:Tahoma;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
		echo "</tr>";
		...
		echo "</tr>";
		echo "<tr>";
		echo "<td><textarea name=\"unlike_luar\" style=\"font-family:Tahoma;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
		echo "</tr>";
		...
		echo "<br><br><font style=\"font-size:0.675em;color:red;\"><i>(Ctt: Pastikan semua evaluasi terisi agar bisa di-submit!!)</i></font></form></fieldset>";
