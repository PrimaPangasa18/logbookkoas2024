...
<head>
	...
	<title>On-line Rotasi Stase Isi Evaluasi Logbook Koas Pendidikan Dokter FK-UNDIP</title>
		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						<h3 class="fw-bold fs-4 mb-3">ISI EVALUASI KEPANITERAAN (STASE)</h3>
						<br>
						<?php
						$id_stase = $_GET['id'];
						...
						//Refleksi diri
						echo "<tr>";
						echo "<td><font style=\"font-size:0.9em; font-weight:600;\">Tuliskan refleksi diri anda setelah menjalankan stase kepaniteraan ini: </font><font style=\"font-size:0.85em;color:red; \"> *</font></td>";
						echo "</tr>";
						echo "<tr>";
						echo "<td><textarea name=\"refleksi\" style=\"font-family:Poppins;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
						echo "</tr>";
						//Komentar
						echo "<tr>";
						echo "<td><font style=\"font-size:0.9em; font-weight:600;\">Silakan tulis dalam kolom di bawah ini komentar, usul, saran, atau kritik dalam bahasa yang santun: </font><font style=\"font-size:0.85em;color:red; \"> *</font></td>";
						echo "</tr>";
						echo "<tr>";
						echo "<td><textarea name=\"komentar\" style=\"font-family:Poppins;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
						echo "</tr>";
						//Pencapaian
						echo "<tr>";
						echo "<td>";
						...
						for ($x = 1; $x <= 3; $x++) {
							...
							echo "<option value=\"\">< Pilihan Dosen ></option>";
							...
							echo "&nbsp;&nbsp;<textarea name=\"$tatap_mukax\" style=\"font-family:Poppins;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=2 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
							echo "</tr>";
							//Dosen x Umum
							echo "<tr>";
							echo "<td><font style=\"font-size:0.9em; font-weight:600;\">A. Umum </font><font style=\"font-size:0.85em;color:red;; font-weight:600; \"> *</font></td>";
							echo "</tr>";
							echo "<tr>";
							echo "<td>";
							...
							echo "<td><textarea name=\"$komentar_dosenx\" style=\"font-family:Poppins;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
							echo "</tr>";
						...
						//Lokasi stase luar
						echo "<tr>";
						echo "<td><font style=\"font-size:0.85em; font-weight:600;\">Lokasi stase luar </font><font style=\"font-size:0.85em;color:red;font-weight:600; \"> *</font> :<p>";
						echo "<textarea name=\"lokasi_luar\" style=\"font-family:Poppins;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
						echo "</tr>";
						//Lama stase luar
						echo "<tr>";
						echo "<td><font style=\"font-size:0.85em;font-weight:600;\">Lama stase (minggu) </font><font style=\"font-size:0.85em;color:red;font-weight:600; \"> *</font> :<p>";
						echo "<label class=\"select_small\"><select name=\"lama_luar\" id=\"lama_luar\" style=\"width:450px\" required>";
						echo "<option value=\"\">< Pilihan Minggu ></option>";
						for ($mg = 1; $mg <= 8; $mg++)
						...
						echo "</tr>";
						echo "<tr>";
						echo "<td><textarea name=\"like_luar\" style=\"font-family:Poppins;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
						echo "</tr>";
						...
						echo "</tr>";
						echo "<tr>";
						echo "<td><textarea name=\"unlike_luar\" style=\"font-family:Poppins;font-size:0.85em;width:100%;border:0.5px solid grey;border-radius:5px;\" rows=5 placeholder=\"Tulis jawaban Anda\" required></textarea></td>";
						echo "</tr>";
						...
						echo "<br><br><font style=\"font-size:0.9em;color:red; font-weight:600;\"><span>(Ctt: Pastikan semua evaluasi terisi agar bisa di-<span style=\"color:green;\" >submit!</span>)</span></font></form>";
