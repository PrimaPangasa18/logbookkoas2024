...
if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass'])AND $_COOKIE['level']==1)
{
  ...
  echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">ROTASI INDIVIDU KEPANITERAAN (STASE) - HAPUS ROTASI</font></h4><br>";
  echo "</center>";
  ...
  if ($_POST['cari']=="CARI")
  {
    ...
    if ($jml>=1)
    {
      echo "<font style=\"font-size:0.625em\"><i>(Klik username untuk melihat dan menghapus rotasi kepaniteraan/stase secara manual)</i></font><p>";
      ...
      while ($data=mysqli_fetch_array($user_kunci))
      {
        ...
        echo "<tr class=\"genap\">";
          ...
          echo "<td><a href=\"rotasi_inddelete.php?user_name=$data[username]\">$data[username]</a></td>";
