...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==4)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">PENILAIAN KEPANITERAAN (STASE) IKFR</font></h4>";
		...
		echo "</center><br><a href=\"#kasus\"><i>Penilaian Diskusi Kasus</i></a><br>";
		echo "<a href=\"#minicex\"><i>Penilaian Ujian MINI-CEX</i></a><br><br>";

		//Penilaian Diskusi Kasus
		echo "<a id=\"kasus\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Diskusi Kasus</font></a><br><br>";
		...
		else
		{
		  ...
		  while ($data_kasus=mysqli_fetch_array($nilai_kasus))
		  {
		    ...
		    echo "<td>Penilaian Diskusi Kasus<br><br>";
