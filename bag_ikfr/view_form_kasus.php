...
error_reporting("E_ALL ^ E_NOTICE");
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND ($_COOKIE['level']==5 OR $_COOKIE['level']==4))
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">NILAI DISKUSI KASUS<p>Kepaniteraan (Stase) IKFR</font></h4>";
		...
		echo "<tr>";
			...
			echo "Catatan:<br>";
			echo "<textarea name=\"catatan\" style=\"width:97%;font-family:Tahoma;font-size:1em\" rows=5 disabled>$data_kasus[catatan]</textarea><br><br>";
			echo "Saran:<br>";
			echo "<textarea name=\"saran\" style=\"width:97%;font-family:Tahoma;font-size:1em\" rows=5 disabled>$data_kasus[saran]</textarea>";
			echo "</td>";
		echo "</tr>";
