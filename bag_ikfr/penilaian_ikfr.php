			...
			<main class="content px-3 py-4" style="background-image: url('../images/undip_watermark_color.png'), url('../images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM PENILAIAN KEPANITERAAN (STASE) IKFR</h2>
						<br>
						<?php
						$id_stase = "M094";
						...
						if ($cek_stase >= 1) {
							echo "
								...
								<br><br>
								<a href=\"#kasus\" class=\"btn btn-success me-3\">Pengisian Formulir Penilaian Diskusi Kasus</a>
								<a href=\"#minicex\" class=\"btn btn-primary me-3\">Pengisian Formulir Penilaian Ujian MINI-CEX</a>
							...
							echo "<a id=\"kasus\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Diskusi Kasus</a><br><br>";
							$nilai_kasus = mysqli_query($con, "SELECT * FROM `ikfr_nilai_kasus` WHERE `nim`='$_COOKIE[user]'");
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							$cek_approved_kasus = mysqli_num_rows(mysqli_query($con, "SELECT `id` FROM `ikfr_nilai_kasus` WHERE `nim`='$_COOKIE[user]' AND `status_approval`='1'"));
							...
							$nilai_minicex = mysqli_query($con, "SELECT * FROM `ikfr_nilai_minicex` WHERE `nim`='$_COOKIE[user]'");
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							$cek_approved_minicex = mysqli_num_rows(mysqli_query($con, "SELECT `id` FROM `ikfr_nilai_minicex` WHERE `nim`='$_COOKIE[user]' AND `status_approval`='1'"));
							...
							$nilai_test = mysqli_query($con, "SELECT * FROM `ikfr_nilai_test` WHERE `nim`='$_COOKIE[user]'");
			      ...
			      <th style=\"width:15%;text-align:center;\">Nilai</th>
							...
							echo "<center>";
							echo "<br>";
							$cek_approved_test = mysqli_num_rows(mysqli_query($con, "SELECT `id` FROM `ikfr_nilai_test` WHERE `nim`='$_COOKIE[user]' AND `status_approval`='1'"));
							if ($cek_approved_test > 0)
								echo "<br><a href=\"cetak_nilai_test.php\" target=\"_BLANK\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-primary\" name=\"cetak\" value=\"CETAK\"><i class=\"fas fa-print\"></i> CETAK</button>
								</a>";
							echo "<br><br><br><a href=\"cetak_nilai_ikfr.php\" target=\"_BLANK\">";
