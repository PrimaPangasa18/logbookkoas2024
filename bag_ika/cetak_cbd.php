<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND ($_COOKIE['level']==1 OR $_COOKIE['level']==2 OR $_COOKIE['level']==3 OR $_COOKIE['level']==5))
	{
		...
		while ($data_cbd = mysqli_fetch_array($daftar_cbd))
		{
		  ...
		  if ($data_cbd[observasi_1]=="1") $obs1 = "Ya"; else $obs1 = "Tidak";
		  if ($data_cbd[observasi_2]=="1") $obs2 = "Ya"; else $obs2 = "Tidak";
		  if ($data_cbd[observasi_3]=="1") $obs3 = "Ya"; else $obs3 = "Tidak";
		  if ($data_cbd[observasi_4]=="1") $obs4 = "Ya"; else $obs4 = "Tidak";
		  if ($data_cbd[observasi_5]=="1") $obs5 = "Ya"; else $obs5 = "Tidak";
		  if ($data_cbd[observasi_6]=="1") $obs6 = "Ya"; else $obs6 = "Tidak";
		  if ($data_cbd[observasi_7]=="1") $obs7 = "Ya"; else $obs7 = "Tidak";
