...
if (empty($_COOKIE['user']) || empty($_COOKIE['pass'])) {
	...
	if (!empty($_COOKIE['user']) and !empty($_COOKIE['pass']) and ($_COOKIE['level'] == 1 or $_COOKIE['level'] == 2 or $_COOKIE['level'] == 3 or $_COOKIE['level'] == 5)) {
		...
		while ($data_dops = mysqli_fetch_array($daftar_dops)) {
			...
			//Nilai Aspek 1 - 5
			if ($data_dops['observasi_1'] == "0") $obs1 = "TIDAK";
			else $obs1 = "YA";
			if ($data_dops['observasi_2'] == "0") $obs2 = "TIDAK";
			else $obs2 = "YA";
			if ($data_dops['observasi_3'] == "0") $obs3 = "TIDAK";
			else $obs3 = "YA";
			if ($data_dops['observasi_4'] == "0") $obs4 = "TIDAK";
			else $obs4 = "YA";
			if ($data_dops['observasi_5'] == "0") $obs5 = "TIDAK";
			else $obs5 = "YA";
			if ($data_dops['observasi_6'] == "0") $obs6 = "TIDAK";
			else $obs6 = "YA";
			if ($data_dops['observasi_7'] == "0") $obs7 = "TIDAK";
			else $obs7 = "YA";
			if ($data_dops['observasi_8'] == "0") $obs8 = "TIDAK";
			else $obs8 = "YA";
			if ($data_dops['observasi_9'] == "0") $obs9 = "TIDAK";
			else $obs9 = "YA";
			if ($data_dops['observasi_10'] == "0") $obs10 = "TIDAK";
			else $obs10 = "YA";
			if ($data_dops['observasi_11'] == "0") $obs11 = "TIDAK";
			else $obs11 = "YA";
