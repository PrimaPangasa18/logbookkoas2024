			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</h2>
						<br>
						<?php
						...
						echo "
								...
								<br><br>
								<a href=\"#minicex\" class=\"btn btn-success me-3\">Penilaian Ujian MINI-CEX</a>
								<a href=\"#dops\" class=\"btn btn-primary me-3\">Penilaian Direct Observation of Procedural Skill (DOPS)</a>
								<br><br>
								<a href=\"#cbd\" class=\"btn me-3\" style=\"background-color: #800080; color: white;\">Penilaian Case-Based Discussion (CBD)</a>
								<a href=\"#kasus\" class=\"btn me-3\" style=\"background-color: #A52A2A; color: white;\">Penilaian Penyajian Kasus Besar</a>
								<br><br>
								<a href=\"#jurnal\" class=\"btn me-3\" style=\"background-color: #D2691E; color: white;\">Penilaian Penyajian Journal Reading</a>
								<a href=\"#minipat\" class=\"btn me-3\" style=\"background-color: #FF8C00; color: white;\">Penilaian Mini Peer Assesment Tool (Mini-PAT)</a>
								<br><br>
								<a href=\"#ujian\" class=\"btn me-3\" style=\"background-color: #4B0082; color: white;\">Penilaian Ujian Akhir Kepaniteraan</a>
								<br><br>
								";
						echo "</center>";
						...
						$nilai_minicex = mysqli_query($con, "SELECT * FROM `ika_nilai_minicex` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						if ($cek_nilai_minicex < 1) {
							...
							while ($data_minicex = mysqli_fetch_array($nilai_minicex)) {
								...
								echo "<td style=\"font-weight:600;\">Penilaian Ujian MINI-CEX (Mini Clinical Examination)<br><br>";
						...
						//Penilaian Direct Observation of Procedural Skill (DOPS)
						echo "<a id=\"dops\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">>Penilaian Direct Observation of Procedural Skill (DOPS)</a><br><br>";
						$nilai_dops = mysqli_query($con, "SELECT * FROM `ika_nilai_dops` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						if ($cek_nilai_dops < 1) {
							...
							while ($data_dops = mysqli_fetch_array($nilai_dops)) {
								...
								echo "<td style=\"text-align:center; font-weight:600;\">$no</td>";
								echo "<td style=\"text-align:center;color:darkblue; font-weight:600;\">$tanggal_isi</td>";
								echo "<td style=\"font-weight:600;\">Penilaian Direct Observation of Procedural Skill (DOPS)<br><br>";
						...
						echo "<a id=\"cbd\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Case-Based Discussion (CBD)</a><br><br>";
						$nilai_cbd = mysqli_query($con, "SELECT * FROM `ika_nilai_cbd` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						if ($cek_nilai_cbd < 1) {
							...
							while ($data_cbd = mysqli_fetch_array($nilai_cbd)) {
								...
								if ($data_cbd['status_approval'] == '0') {
									echo "<font style=\"color:red; font-weight:600;\">BELUM DISETUJUI</font>";
									echo "<br><br>
										<a href=\"approve_cbd_dosen.php?id=$data_cbd[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"approve_$data_cbd[id]\" value=\"VIEW & APPROVE\">
            								<i class=\"fas fa-eye me-2\"></i> VIEW & APPROVE
        									</button>
      										</a>";
								} else {
									...
									echo "<span style=\"color:darkblue; font-weight:600;\">$tanggal_approval</span>";
									echo "<br><br>
										<a href=\"view_form_cbd.php?id=$data_cbd[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-success btn-sm\" name=\"view_$data_cbd[id]\" value=\"VIEW\">
            								<i class=\"fas fa-eye me-2\"></i> VIEW
        									</button>
      										</a>";
									echo "<br><br>
									<a href=\"unapprove_cbd_dosen.php?id=$data_cbd[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"unapprove\".\"$data_cbd[id]\"  value=\"UNAPPROVE\">
									<i class=\"fas fa-circle-xmark me-2\"></i> UNAPPROVE
									</button></a>";
								}
								echo "</td>";
						...
						$nilai_kasus = mysqli_query($con, "SELECT * FROM `ika_nilai_kasus` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						//Penilaian Penyajian Journal Reading
						echo "<a id=\"jurnal\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Penyajian Journal Reading</a><br><br>";
						$nilai_jurnal = mysqli_query($con, "SELECT * FROM `ika_nilai_jurnal` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						//Penilaian Mini Peer Assesment Tool (Mini-PAT)
						echo "<a id=\"minipat\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Mini Peer Assesment Tool (Mini-PAT)</a><br><br>";
						$nilai_minipat = mysqli_query($con, "SELECT * FROM `ika_nilai_minipat` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						if ($cek_nilai_minipat < 1) {
							...
							while ($data_minipat = mysqli_fetch_array($nilai_minipat)) {
								...
								if ($data_minipat['status_approval'] == '0') {
									echo "<font style=\"color:red; font-weight:600;\">BELUM DISETUJUI</font>";
									echo "<br><br>
										<a href=\"approve_minipat_dosen.php?id=$data_minipat[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"approve_$data_minipat[id]\" value=\"VIEW & APPROVE\">
            								<i class=\"fas fa-eye me-2\"></i> VIEW & APPROVE
        									</button>
      										</a>";
								} else {
									...
									echo "<span style=\"color:darkblue; font-weight:600;\">$tanggal_approval</span>";
									echo "<br><br>
										<a href=\"view_form_minipat.php?id=$data_minipat[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-success btn-sm\" name=\"view_$data_minipat[id]\" value=\"VIEW\">
            								<i class=\"fas fa-eye me-2\"></i> VIEW
        									</button>
      										</a>";
									echo "<br><br>
									<a href=\"unapprove_minipat_dosen.php?id=$data_minipat[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"unapprove\".\"$data_minipat[id]\"  value=\"UNAPPROVE\">
									<i class=\"fas fa-circle-xmark me-2\"></i> UNAPPROVE
									</button></a>";
								}
								echo "</td>";
						...
						//Penilaian Ujian Akhir Kepaniteraan
						echo "<a id=\"ujian\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Ujian Akhir Kepaniteraan</a><br><br>";
						$nilai_ujian = mysqli_query($con, "SELECT * FROM `ika_nilai_ujian` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						if ($cek_nilai_ujian < 1) {
							...
							while ($data_ujian = mysqli_fetch_array($nilai_ujian)) {
								...
								echo "<td style=\"text-align:center; font-weight:600;\">$no</td>";
								echo "<td style=\"text-align:center;color:darkblue; font-weight:600;\">$tanggal_isi</td>";
								echo "<td style=\"font-weight:600;\">Penilaian Ujian Akhir Kepaniteraan<br><br>";
								echo "<span style=\"color:purple;\">Nama Mahasiswa: $data_mhsw[nama]</span><br><span style=\"color:red;\">NIM: $data_mhsw[nim]</span><br>";
								echo "Tanggal Ujian: $tanggal_ujian<br>";
