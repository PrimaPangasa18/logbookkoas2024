...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==4)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</font></h4>";
		...
		echo "</center><br><a href=\"#minicex\"><i>Penilaian Ujian MINI-CEX (Mini Clinical Examination)</i></a><br>";
		echo "<a href=\"#dops\"><i>Penilaian Direct Observation of Procedural Skill (DOPS)</i></a><br>";
		echo "<a href=\"#cbd\"><i>Penilaian Case-Based Discussion (CBD)</i></a><br>";
		echo "<a href=\"#kasus\"><i>Penilaian Penyajian Kasus Besar</i></a><br>";
		echo "<a href=\"#jurnal\"><i>Penilaian Penyajian Journal Reading</i></a><br>";
		echo "<a href=\"#minipat\"><i>Penilaian Mini Peer Assesment Tool (Mini-PAT)</i></a><br>";
		echo "<a href=\"#ujian\"><i>Penilaian Ujian Akhir Kepaniteraan</i></a><br><br>";
		...
		echo "<a id=\"dops\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Direct Observation of Procedural Skill (DOPS)</font></a><br><br>";
		...
		else
		{
		  ...
		  while ($data_dops=mysqli_fetch_array($nilai_dops))
		  {
		    ...
		    echo "<td align=center>$no</td>";
		    echo "<td>$tanggal_isi</td>";
		    echo "<td>Penilaian Direct Observation of Procedural Skill (DOPS)<br><br>";
		    echo "<i>Nama Mahasiswa: $data_mhsw[nama]<br>NIM: $data_mhsw[nim]<br>";
				echo "Tanggal Ujian: $tanggal_ujian<br>";
		...
		echo "<a id=\"kasus\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Penyajian Kasus Besar</font></a><br><br>";
		...
		echo "<a id=\"jurnal\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Penyajian Journal Reading</font></a><br><br>";
		...
		echo "<a id=\"minipat\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Mini Peer Assesment Tool (Mini-PAT)</font></a><br><br>";
		...
		else
		{
		  ...
		  while ($data_minipat=mysqli_fetch_array($nilai_minipat))
		  {
		    ...
		    {
		      echo "<font style=\"color:red\">BELUM DISETUJUI</font><br><br>";
		      echo "<a href=\"approve_minipat_dosen.php?id=$data_minipat[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\"><input type=\"button\" name=\"approve\".\"$data_minipat[id]\" style=\"color:red\" value=\"VIEW & APPROVE\"></a>";
		    }
		    else
		    {
		      echo "<font style=\"color:green\">DISETUJUI</font><br>";
		      echo "per tanggal<br>";
		      echo "$tanggal_approval<p>";
		      echo "<a href=\"view_form_minipat.php?id=$data_minipat[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\"><input type=\"button\" name=\"view\".\"$data_minipat[id]\" value=\"VIEW\"></a><p>";
		      echo "<a href=\"unapprove_minipat_dosen.php?id=$data_minipat[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\"><input type=\"button\" name=\"unapprove\".\"$data_minipat[id]\" style=\"color:green\" value=\"UNAPPROVE\"></a>";
		    }
		    echo "</td>";
		    echo "</tr>";
		    $no++;
		...
		echo "<a id=\"ujian\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Ujian Akhir Kepaniteraan</font></a><br><br>";
		...
		else
		{
		  ...
		  while ($data_ujian=mysqli_fetch_array($nilai_ujian))
		  {
		    ...
		    echo "<td align=center>$no</td>";
		    echo "<td>$tanggal_isi</td>";
		    echo "<td>Penilaian Ujian Akhir Kepaniteraan<br><br>";
		    echo "<i>Nama Mahasiswa: $data_mhsw[nama]<br>NIM: $data_mhsw[nim]<br>";
		    echo "Tanggal Ujian: $tanggal_ujian<br>";
		    ...
		    {
		      echo "<font style=\"color:red\">BELUM DISETUJUI</font><br><br>";
		      echo "<a href=\"approve_ujian_dosen.php?id=$data_ujian[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\"><input type=\"button\" name=\"approve\".\"$data_ujian[id]\" style=\"color:red\" value=\"VIEW & APPROVE\"></a>";
		    }
		    else
		    {
		      echo "<font style=\"color:green\">DISETUJUI</font><br>";
		      echo "per tanggal<br>";
		      echo "$tanggal_approval<p>";
		      echo "<a href=\"view_form_ujian.php?id=$data_ujian[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\"><input type=\"button\" name=\"view\".\"$data_ujian[id]\" value=\"VIEW\"></a><p>";
		      echo "<a href=\"unapprove_ujian_dosen.php?id=$data_ujian[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\"><input type=\"button\" name=\"unapprove\".\"$data_ujian[id]\" style=\"color:green\" value=\"UNAPPROVE\"></a>";
		    }
		    echo "</td>";
		    echo "</tr>";
		    $no++;
