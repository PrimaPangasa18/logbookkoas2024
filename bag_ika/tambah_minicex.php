			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN MINI-CEX<br>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</h2>
						<br>
						<?php
						$id_stase = "M113";
						...
						echo "<option value=\"\"><< Pilihan Jenis Evaluasi >></option>";
						...
						echo "<td><input type=\"text\" name=\"inisial_pasien\" style=\" width: 70%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" placeholder=\"<< Inisial Pasien >>\" required/></td>";
						echo "</tr>";
						//Umur Pasien
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						<br><textarea name=\"action_plan\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" placeholder=\"<< Rencana Tindak Lanjut >>\"></textarea></td>";
						echo "</tr>";
						echo "</table><br><br>";
			...
			<input type=\"radio\" name=\"kepuasan_residen\" value=\"Baik sekali\" />&nbsp;&nbsp;Baik sekali";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_minicex = mysqli_query($con, "INSERT INTO `ika_nilai_minicex`
				( `nim`, `dosen`, `evaluasi`, `situasi_ruangan`,
					`inisial_pasien`, `umur_pasien`, `jk_pasien`,
					`diagnosis`, `tingkat_kesulitan`, `fokus_kasus`,
				...
				VALUES
				( '$_COOKIE[user]', '$_POST[dosen]', '$_POST[evaluasi]', '$_POST[situasi_ruangan]',
				  '$inisial_pasien','$_POST[umur_pasien]','$_POST[jk_pasien]',
				  '$diagnosis','$_POST[tingkat_kesulitan]', '$_POST[fokus_kasus]',
