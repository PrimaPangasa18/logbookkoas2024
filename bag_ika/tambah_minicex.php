...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR PENILAIAN MINI-CEX<p>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</font></h4>";
		...
		echo "</tr>";
		echo "<tr>";
			echo "<td colspan=2>Rencana tindak lanjut yang disetujui bersama:<br><textarea name=\"action_plan\" rows=5 style=\"width:100%;font-family:Tahoma;font-size:1em\"></textarea></td>";
		echo "</tr>";
		echo "</table><br><br>";
