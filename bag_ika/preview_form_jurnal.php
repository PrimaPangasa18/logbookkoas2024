...
error_reporting("E_ALL ^ E_NOTICE");
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">PREVIEW NILAI PENYAJIAN JOURNAL READING<p>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"jurnal\" style=\"width:97%;font-family:Tahoma;font-size:1em\" disabled>$data_jurnal[jurnal]</textarea></td>";
		echo "</tr>";
		//Tanggal Penyajian
		echo "<tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center>$data_jurnal[aspek_6]</td>";
		echo "</tr>";
		//No 7
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center>$data_jurnal[aspek_7]</td>";
		echo "</tr>";
		//Aspek Diskusi
		echo "<tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center>$data_jurnal[aspek_8]</td>";
		echo "</tr>";
		//No 9
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center>$data_jurnal[aspek_9]</td>";
		echo "</tr>";
		//Nilai Rata-Rata
		echo "<tr>";
			echo "<td colspan=3 align=right>Rata-Rata Nilai (Jumlah Bobot x Nilai)</td>";
			echo "<td align=center>$data_jurnal[nilai_rata]</td>";
		echo "</tr>";
		echo "</table><br>";
