...
<head>
	...
	<title>On-line Preview Journal Reading Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('../images/undip_watermark_color.png'), url('../images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PREVIEW NILAI PENYAJIAN JOURNAL READING<br>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</h2>
						<br>
						<?php
						$id = $_GET['id'];
						$data_mhsw = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM `biodata_mhsw` WHERE `nim`='$_COOKIE[user]'"));
						...
						//Periode Kegiatan
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						$tanggal_awal = tanggal_indo($data_jurnal['tgl_awal']);
						$tanggal_akhir = tanggal_indo($data_jurnal['tgl_akhir']);
						...
						echo "<td><textarea name=\"jurnal\" style=\" width: 100%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\"  disabled>$data_jurnal[jurnal]</textarea></td>";
						echo "</tr>";
						//Tanggal Penyajian
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						$tanggal_penyajian = tanggal_indo($data_jurnal['tgl_penyajian']);
						echo "<td><strong>Tanggal Penyajian</strong></td>";
						echo "<td style=\"font-weight:600;\">$tanggal_penyajian</td>";
						echo "</tr>";
						//Dosen Penilai
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">$data_jurnal[aspek_1]</td>";
						echo "</tr>";
						//No 2
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">$data_jurnal[aspek_2]</td>";
						echo "</tr>";
						//Aspek Naskah
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">$data_jurnal[aspek_3]</td>";
						echo "</tr>";
						//No 4
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_jurnal[aspek_4]</td>";
						echo "</tr>";
						//No 5
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center><strong>5</strong></td>";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_jurnal[aspek_5]</td>";
						echo "</tr>";
						//No 6
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_jurnal[aspek_6]</td>";
						echo "</tr>";
						//No 7
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_jurnal[aspek_7]</td>";
						echo "</tr>";
						//Aspek Diskusi
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">$data_jurnal[aspek_8]</td>";
						echo "</tr>";
						//No 9
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_jurnal[aspek_9]</td>";
						echo "</tr>";
						//Nilai Rata-Rata
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=3 align=right><strong>Rata-Rata Nilai <span class=\"text-danger\">(Jumlah Bobot x Nilai)</span></strong></td>";
						echo "<td align=center style=\"font-weight:600; color:blue;\">$data_jurnal[nilai_rata]</td>";
						echo "</tr>";
						echo "</table><br>";
						...
						<textarea name=\"umpan_balik\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_jurnal[umpan_balik]</textarea></td>";
						echo "</tr>";
						echo "<tr  class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Saran:</strong><br>
						<textarea name=\"saran\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_jurnal[saran]</textarea></td>";
						echo "</tr>";
