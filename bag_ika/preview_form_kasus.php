...
<head>
	...
	<title>On-line Preview Kasus Besar Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PREVIEW NILAI PENYAJIAN KASUS BESAR<br>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</h2>
						<br>
						<?php
						$id = $_GET['id'];
						$data_mhsw = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM `biodata_mhsw` WHERE `nim`='$_COOKIE[user]'"));
						...
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_1]</td>";
						echo "</tr>";
						//No 2
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_2]</td>";
						echo "</tr>";
						//Aspek Naskah
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_3]</td>";
						echo "</tr>";
						//No 4
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>5%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_4]</td>";
						echo "</tr>";
						//No 5
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center><strong>5</strong></td>";
						...
						echo "<td align=center><strong>5%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_5]</td>";
						echo "</tr>";
						//No 6
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>2.5%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_6]</td>";
						echo "</tr>";
						//Aspek Diskusi
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_7]</td>";
						echo "</tr>";
						//No 8
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_8]</td>";
						echo "</tr>";
						//No 9
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_9]</td>";
						echo "</tr>";
						//No 10
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center><strong>10</strong></td>";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_10]</td>";
						echo "</tr>";
						//No 11
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_11]</td>";
						echo "</tr>";
						//No 12
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>5%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_12]</td>";
						echo "</tr>";
						//No 13
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_13]</td>";
						echo "</tr>";
						//No 14
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>5%</strong></td>";
						echo "<td align=center style=\"font-weight:600;\">$data_kasus[aspek_14]</td>";
						echo "</tr>";
						//Nilai Rata-Rata
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=3 align=right><strong>Rata-Rata Nilai <span class=\"text-danger\">(Jumlah Bobot x Nilai)</span></strong></td>";
						echo "<td align=center style=\"font-weight:600; color:blue;\">$data_kasus[nilai_rata]</td>";
						echo "</tr>";
						echo "</table><br>";
