...
<head>
	...
	<title>On-line Tambah Mini-PAT Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN MINI PEER ASSESMENT TOOL (MINI-PAT)<br>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</h2>
						<br>
						<?php
						$id_stase = "M113";
						...
						echo "<td class=\"td_mid\">
						<input type=\"text\" class=\"form-select tgl_penilaian\" name=\"tgl_penilaian\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" placeholder=\"yyyy-mm-dd\" /></td>";
						echo "</tr>";
						//Dosen Penilai
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek8\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek8\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						...
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek9\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek9\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 10
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center><strong>10</strong></td>";
						echo "<td><strong>Komunikasi dengan keluarga pasien</strong></td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"aspek10\" style=\"width:60%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"aspek10\" value=\"0\" onkeyup=\"sum();\" onchange=\"sum();\" required/></td>";
						echo "</tr>";
						//No 11
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_minipat = mysqli_query($con, "INSERT INTO `ika_nilai_minipat`
				( `nim`, `tgl_awal`,`tgl_akhir`,`dosen`,
					...
					`tgl_isi`,`tgl_penilaian`,`tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]','$_POST[tgl_awal]','$_POST[tgl_akhir]','$_POST[dosen]',
					...
					'$aspek15','$aspek16',
					'$nilai_rata','$umpan_balik','$saran',
					'$tgl','$_POST[tgl_penilaian]','2000-01-01','0')");
