...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR PENILAIAN MINI PEER ASSESMENT TOOL (MINI-PAT)<p>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td class=\"td_mid\"><input type=\"text\" class=\"tgl_penilaian\" name=\"tgl_penilaian\" style=\"font-size:1em;font-family:TAHOMA;padding:0 0 0 7px;height:27px;border:0.5px solid grey;border-radius:5px;\" placeholder=\"yyyy-mm-dd\" /></td>";
		echo "</tr>";
		//Dosen Penilai
		echo "<tr>";
