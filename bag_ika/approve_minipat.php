...
<head>
	...
	<title>On-line Approval Mini-PAT Logbook Koas Pendidikan Dokter FK-UNDIP</title>
		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">APPROVAL NILAI MINI PEER ASSESMENT TOOL (MINI-PAT)<br>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</h2>
						<br>
						<?php
						$id = $_GET['id'];
			...
			";
						...
						if ($_POST['approve'] == "APPROVE") {
							$dosen_minipat = mysqli_fetch_array(mysqli_query($con, "SELECT `dosen` FROM `ika_nilai_minipat` WHERE `id`='$_POST[id]'"));
							$user_dosen = mysqli_fetch_array(mysqli_query($con, "SELECT `password` FROM `admin` WHERE `username`='$dosen_minipat[dosen]'"));
							$data_dosen = mysqli_fetch_array(mysqli_query($con, "SELECT `pin`,`qr` FROM `dosen` WHERE `nip`='$dosen_minipat[dosen]'"));
				...
				window.location.href = \"approve_minipat.php?id=\"+\"$_POST[id]\";
        </script>
				";
							}
						}
