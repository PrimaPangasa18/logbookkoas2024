	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT PENILAIAN CASE-BASED DISCUSSION (CBD)<br>(KASUS POLIKLIKNIK)<br>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</h2>
						<br>
						<?php
						$id = $_GET['id'];
						$id_state = "M113";
						...
						<input type=\"text\" class=\"form-select tanggal_ujian\" name=\"tanggal_ujian\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" value=\"$data_cbd[tgl_ujian]\" /></td>";
						echo "</tr>";
			...
			";
				...
				`dosen`='$_POST[dosen]',`poliklinik`='$poliklinik',`situasi_ruangan`='$_POST[situasi_ruangan]',
