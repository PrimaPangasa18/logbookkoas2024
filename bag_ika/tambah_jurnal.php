...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR PENILAIAN PENYAJIAN JOURNAL READING<p>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"jurnal\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Judul Paper/Makalah >>\" required></textarea></td>";
		echo "</tr>";
		//Tanggal Penyajian
		echo "<tr>";
