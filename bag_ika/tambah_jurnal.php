...
<head>
	...
	<title>On-line Tambah Journal Reading Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN PENYAJIAN JOURNAL READING<br>KEPANITERAAN (STASE) ILMU KESEHATAN ANAK</h2>
						<br>
						<?php
						$id_stase = "M113";
						...
						echo "<td><textarea name=\"jurnal\" style=\" width: 100%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" placeholder=\"<< Judul Paper/Makalah >>\" required></textarea></td>";
						echo "</tr>";
						//Tanggal Penyajian
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_jurnal = mysqli_query($con, "INSERT INTO `ika_nilai_jurnal`
				( `nim`, `tgl_awal`,`tgl_akhir`,`dosen`, `jurnal`,
				...
				VALUES
				( '$_POST[nim]','$_POST[tgl_awal]','$_POST[tgl_akhir]','$_POST[dosen]','$jurnal',
