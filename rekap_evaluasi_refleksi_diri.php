...
<body>
	<div class="wrapper">
		...
		<div class="main">
				...
				<div class="container-fluid">
					<div class="mb-3">
						...
						echo "<thead class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">
							...
							<th style=\"width:50%;text-align:center;\">Refleksi Diri</th>
							</thead>";
						$id = 1;
						$kelas = "ganjil";
						while ($nim_mhsw = mysqli_fetch_array($mhsw)) {
							...
							if ($jml_data_evaluasi > 0) echo "<td style=\"font-weight:600;\">$refleksi_diri[refleksi]</td>";
			...
			<center>
				<form action="export_rekap_evaluasi_refleksi_diri.php" method="get">
