...
<head>
	...
	<title>On-line Penilaian Bagian IKGM Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM PENILAIAN KEPANITERAAN (STASE) IKGM</h2>
						<br>
						<?php
						$id_stase = "M106";
						...
						if ($cek_stase >= 1) {
							echo "
								...
								<br><br>
								<a href=\"#kasus\" class=\"btn btn-success me-3\">Pengisian Formulir Penilaian Laporan Kasus</a>
								<a href=\"#jurnal\" class=\"btn btn-primary me-3\">Pengisian Formulir Penilaian Journal Reading</a>
								<a href=\"#responsi\" class=\"btn me-3\" style=\"background-color: #800080; color: white;\">Pengisian Formulir Penilaian Responsi Kasus Kecil</a>
								<br><br>
								<a href=\"#test\" class=\"btn me-3\" style=\"background-color: #A52A2A; color: white;\">Preview Nilai-Nilai Test dan Perilaku</a>
								<br><br>
								";
							echo "</center>";
							...
							echo "<br><br>";
							echo "<a id=\"kasus\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Laporan Kasus</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Nilai</th>
							...
							echo "<br><br><br><a href=\"cetak_nilai_ikgm.php\" target=\"_BLANK\">";
