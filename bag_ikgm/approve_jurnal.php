		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">APPROVAL NILAI JOURNAL READING<br>KEPANITERAAN (STASE) IKGM</h2>
						<br>
						<?php
						$id_stase = "M106";
						$id = $_GET['id'];
						...
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_total\" style=\"width:30%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"nilai_total\" value=\"$data_jurnal[nilai_total]\" required disabled/></td>";
						echo "</tr>";
						echo "</table><br>";
			...
			";
						...
						if ($_POST['approve'] == "APPROVE") {
							$dosen_jurnal = mysqli_fetch_array(mysqli_query($con, "SELECT `dosen` FROM `ikgm_nilai_jurnal` WHERE `id`='$_POST[id]'"));
