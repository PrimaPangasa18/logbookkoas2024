...
<head>
	...
	<title>On-line Tambah Kasus Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN LAPORAN KASUS<br>KEPANITERAAN (STASE) IKGM</h2>
						<br>
						<?php
						$id_stase = "M106";
						...
						echo "<td><textarea name=\"nama_kasus\" style=\" width: 100%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" placeholder=\"<< Nama/Judul Kasus >>\" required></textarea></td>";
						echo "</tr>";
						echo "</table><br><br>";
						...
						<input type=\"radio\" name=\"aspek_1\" value=\"1\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;1 - Hadir, terlambat<br>
						<input type=\"radio\" name=\"aspek_1\" value=\"2\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;2 - Hadir tepat waktu";
						echo "</td>";
						echo "</tr>";
						//No 2
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						<input type=\"radio\" name=\"aspek_2\" value=\"2\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;2 - Kurang aktif<br>
						<input type=\"radio\" name=\"aspek_2\" value=\"3\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;3 - Cukup aktif<br>
						<input type=\"radio\" name=\"aspek_2\" value=\"4\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;4 - Lebih aktif<br>
						<input type=\"radio\" name=\"aspek_2\" value=\"5\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;5 - Sangat aktif";
						echo "</td>";
						echo "</tr>";
						//No 3
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						<input type=\"radio\" name=\"aspek_3\" value=\"2\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;2 - Kurang<br>
						<input type=\"radio\" name=\"aspek_3\" value=\"3\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;3 - Cukup<br>
						<input type=\"radio\" name=\"aspek_3\" value=\"4\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;4 - Baik<br>
						<input type=\"radio\" name=\"aspek_3\" value=\"5\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;5 - Sangat baik";
						echo "</td>";
						echo "</tr>";
						//No 4
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						<input type=\"radio\" name=\"aspek_4\" value=\"2\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;2 - Kurang<br>
						<input type=\"radio\" name=\"aspek_4\" value=\"3\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;3 - Cukup<br>
						<input type=\"radio\" name=\"aspek_4\" value=\"4\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;4 - Baik<br>
						<input type=\"radio\" name=\"aspek_4\" value=\"5\" onkeyup=\"sum();\" onchange=\"sum();\" />&nbsp;&nbsp;5 - Sangat baik";
						echo "</td>";
						echo "</tr>";
						//Total Nilai
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=2 align=right><strong>Total Nilai <span class=\"text-danger\">(10 x Jumlah Poin / 1.7)</span></strong></td>";
						echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_total\" style=\"width:30%;border:0.2px solid black;border-radius:3px;font-size:0.85em;text-align:center\" id=\"nilai_total\" value=\"0\" required disabled/></td>";
						echo "</tr>";
						echo "</table><br>";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_kasus = mysqli_query($con, "INSERT INTO `ikgm_nilai_kasus`
				( `nim`, `dosen`, `tgl_ujian`, `nama_kasus`,
					`aspek_1`, `aspek_2`, `aspek_3`, `aspek_4`,
					`catatan`, `nilai_total`, `tgl_isi`, `tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]','$_POST[dosen]','$_POST[tanggal_ujian]','$nama_kasus',
					'$_POST[aspek_1]','$_POST[aspek_2]','$_POST[aspek_3]','$_POST[aspek_4]',
