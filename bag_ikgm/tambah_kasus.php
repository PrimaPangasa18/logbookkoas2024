...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR PENILAIAN LAPORAN KASUS<p>Kepaniteraan (Stase) IKGM</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"nama_kasus\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Nama/judul kasus >>\" required></textarea></td>";
		echo "</tr>";
		echo "</table><br><br>";
