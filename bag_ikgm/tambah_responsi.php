...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR NILAI RESPONSI KASUS KECIL<p>Kepaniteraan (Stase) IKGM</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td><input type=\"text\" name=\"cm_pasien\" class=\"select_art\" placeholder=\"<< No CM Pasien >>\" required /></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_rata\" style=\"width:100%;font-size:0.85em;text-align:center\" value=\"0\" id=\"nilai_rata\" required/></td>";
		echo "</tr>";
		echo "</table><br>";
