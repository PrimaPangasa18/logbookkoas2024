			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI RESPONSI KASUS KECIL<br>KEPANITERAAN (STASE) IKGM</h2>
						<br>
						<?php
						$id_stase = "M106";
						...
						$kasus_terakhir = mysqli_fetch_array(mysqli_query($con, "SELECT max(`kasus_ke`) FROM `ikgm_nilai_responsi` WHERE `nim`='$data_mhsw[nim]'"));
						...
						echo "<td><input type=\"text\" name=\"nama_pasien\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" class=\"form-control\" placeholder=\"<< Nama Pasien >>\" required /></td>";
						echo "</tr>";
						//No CM Pasien
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>No CM Pasien</strong></td>";
						echo "<td><input type=\"text\" name=\"cm_pasien\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" class=\"form-control\" placeholder=\"<< No CM Pasien >>\" required /></td>";
						echo "</tr>";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_responsi = mysqli_query($con, "INSERT INTO `ikgm_nilai_responsi`
				( `nim`, `dosen`, `kasus_ke`,
					`nama_pasien`,`cm_pasien`,`diagnosis`,
					`aspek_1`, `aspek_2`,`aspek_3`, `aspek_4`,
					`aspek_5`, `aspek_6`, `aspek_7`,`nilai_rata`,
					`umpan_balik`,`saran`,
					`tgl_isi`,`tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]', '$_POST[dosen]','$_POST[kasus_ke]',
					'$nama_pasien','$cm_pasien','$diagnosis',
