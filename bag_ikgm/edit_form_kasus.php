...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">EDIT FORMULIR PENILAIAN LAPORAN KASUS<p>Kepaniteraan (Stase) IKGM</font></h4>";
		...
		if ($_POST[ubah]=="UBAH")
		{
			...
			$update_kasus=mysqli_query($con,"UPDATE `ikgm_nilai_kasus` SET
				`dosen`='$_POST[dosen]',`tgl_ujian`='$_POST[tanggal_ujian]',`nama_kasus`='$nama_kasus',
				`aspek_1`='$_POST[aspek_1]',`aspek_2`='$_POST[aspek_2]',
				`aspek_3`='$_POST[aspek_3]',`aspek_4`='$_POST[aspek_4]',
				`catatan`='$catatan',`nilai_total`='$nilai_total',`tgl_isi`='$tgl'
				WHERE `id`='$_POST[id]'");
