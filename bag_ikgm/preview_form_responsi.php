...
error_reporting("E_ALL ^ E_NOTICE");
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">PREVIEW NILAI RESPONSI KASUS KECIL<p>Kepaniteraan (Stase) IKGM</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td>$data_responsi[nama_pasien]</td>";
		echo "</tr>";
		//No CM Pasien
		echo "<tr>";
			echo "<td>No CM Pasien</td>";
			echo "<td>$data_responsi[cm_pasien]</td>";
		echo "</tr>";
		//Problem/Diagnosis Pasien
		echo "<tr>";
			echo "<td>Problem/Diagnosis Pasien</td>";
			echo "<td><textarea name=\"diagnosis\" style=\"width:97%;font-family:Tahoma;font-size:1em\" disabled>$data_responsi[diagnosis]</textarea></td>";
		echo "</tr>";
