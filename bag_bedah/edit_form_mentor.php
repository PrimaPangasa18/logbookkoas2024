...
<head>
	...
	<title>On-line Edit Nilai Mentor Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI MENTORING<br>KEPANITERAAN (STASE) ILMU BEDAH</h2>
						<br>
						<?php
						$id = $_GET['id'];
						$id_stase = "M101";
						...
						$datadosen = mysqli_fetch_array(mysqli_query($con, "SELECT `nip`,`nama`,`gelar` FROM `dosen` WHERE `nip`='$data_mentor[dosen]'"));
						echo "<option value=\"$data_mentor[dosen]\">$datadosen[nama], $datadosen[gelar] ($datadosen[nip])</option>";
				...
				";
					...
					`dosen`='$_POST[dosen]',`tgl_awal`='$_POST[tgl_awal]',`tgl_akhir`='$_POST[tgl_akhir]',
