...
<head>
	...
	<title>On-line Penilaian Bagian Ilmu Bedah Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM PENILAIAN KEPANITERAAN (STASE) ILMU BEDAH</h2>
						<br>
						<?php
						$id_stase = "M101";
						...
						if ($cek_stase >= 1) {
							echo "
								...
								<br><br>
								<a href=\"#mentor\" class=\"btn btn-success me-3\">Pengisian Formulir Penilaian Mentoring</a>
								<a href=\"#test\" class=\"btn btn-primary me-3\">Preview Nilai-Nilai Pre-Test, Post-Test, Skill Lab dan OSCE</a>					
								<br><br>
								";
							echo "</center>";
							echo "<br><br>";
							...
							echo "<center>";
							echo "<a id=\"mentor\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Mentoring</a><br><br>";
						...
						<th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							if ($cek_nilai_mentor < 1) {
								...
								while ($data_mentor = mysqli_fetch_array($nilai_mentor)) {
									...
									if ($data_mentor['status_approval'] == '0')
										echo " <a href=\"approve_mentor.php?id=$data_mentor[id]\">
   												<button type=\"button\"  class=\"btn btn-primary btn-sm\" name=\"approve_$data_mentor[id]\" >
									...
									if ($data_mentor['status_approval'] == '0') {
										...
										echo "<a href=\"edit_form_mentor.php?id=$data_mentor[id]\">
       										 <button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"edit_$data_mentor[id]\" value=\"EDIT\">
            								<i class=\"fas fa-edit me-2\"></i> EDIT
       										</button>
      										</a><p><br>";
										echo "<a href=\"preview_form_mentor.php?id=$data_mentor[id]\">
        										<button type=\"button\" class=\"btn btn-primary btn-sm\" name=\"preview_$data_mentor[id]\" value=\"PREVIEW\">
            								<i class=\"fas fa-eye me-2\"></i> PREVIEW
        									</button>
      										</a><p>";
										echo "<a href=\"hapus_form_mentor.php?id=$data_mentor[id]\">
        									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"hapus_$data_mentor[id]\" value=\"HAPUS\">
										...
										echo "<br><br>
										<a href=\"view_form_mentor.php?id=$data_mentor[id]\">
        										<button type=\"button\" class=\"btn btn-success btn-sm\" name=\"view_$data_mentor[id]\" value=\"VIEW\">
							...
							if ($cek_all_mentor < 2) {
								echo "<br><center><a href=\"tambah_nilai_mentor.php\" >
								...
								if ($cek_approved_mentor > 0)
									echo "<br><br><center><a href=\"cetak_nilai_mentor.php\" target=\"_BLANK\">
							...
							echo "<a id=\"test\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Preview Nilai-Nilai Pre-Test, Post-Test, Skill Lab dan OSCE</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Nilai</th>
							...
							echo "<br><br><br><a href=\"cetak_nilai_bedah.php\" target=\"_BLANK\">";
