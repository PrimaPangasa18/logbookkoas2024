			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PENILAIAN KEPANITERAAN (STASE) ILMU BEDAH</h2>
						<br>
						<?php
						...
						echo "
								...
								<br><br>
								<a href=\"#mentor\" class=\"btn btn-success me-3\">Penilaian Mentoring</a>
								<br><br>
								";
						echo "</center>";
						echo "<br><br>";
						...
						//Penilaian Mentoring
						echo "<a id=\"mentor\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Mentoring</a><br><br>";
						...
						if ($cek_nilai_mentor < 1) {
							...
							while ($data_mentor = mysqli_fetch_array($nilai_mentor)) {
								...
								if ($data_mentor['status_approval'] == '0') {
									...
									echo "<br><br>
										<a href=\"approve_mentor_dosen.php?id=$data_mentor[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"approve_$data_mentor[id]\" value=\"VIEW & APPROVE\">
									...
									echo "<br><br>
										<a href=\"view_form_mentor.php?id=$data_mentor[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
									...
									echo "<br><br>
									<a href=\"unapprove_mentor_dosen.php?id=$data_mentor[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"unapprove\".\"$data_mentor[id]\"  value=\"UNAPPROVE\">
