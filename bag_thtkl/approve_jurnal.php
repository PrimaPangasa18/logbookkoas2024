...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">APPROVAL NILAI JOURNAL READING<p>Kepaniteraan (Stase) Ilmu Kesehatan THT-KL</font></h4>";
		...
		//Journal Reading Ke-
		echo "<tr>";
			echo "<td>Journal Reading Ke-</td>";
			echo "<td>$data_jurnal[jurnal_ke]</td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td><textarea name=\"nama_jurnal\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Nama Jurnal >>\" required>$data_jurnal[nama_jurnal]</textarea></td>";
		echo "</tr>";
		//Judul Artikel
		echo "<tr>";
			echo "<td>Judul Artikel</td>";
			echo "<td><textarea name=\"judul_paper\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Judul Artikel >>\" required>$data_jurnal[judul_paper]</textarea></td>";
		echo "</tr>";
		echo "</table><br><br>";
		...
		echo "<tr>";
			...
			echo "<td>Menerjemahkan Journal Reading</td>";
		...
		echo "<tr>";
			...
			echo "<td>Relevansi Pembicaraan</td>";
		...
		echo "<tr>";
			...
			echo "<td>Keterampilan Berkomunikasi</td>";
		...
		echo "<tr>";
			...
			echo "<td align=center><input type=\"number\" step=\"0.01\" min=\"0\" max=\"100\" name=\"nilai_rata\" style=\"width:100%;font-size:0.85em;text-align:center\" value=\"$data_jurnal[nilai_rata]\" id=\"nilai_rata\"required/></td>";
		echo "</tr>";
		echo "</table><br>";
