...
error_reporting("E_ALL ^ E_NOTICE");
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">PREVIEW NILAI PRESENTASI KASUS<p>Kepaniteraan (Stase) Ilmu Kesehatan THT-KL</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center>$data_presentasi[aspek_6]</td>";
		echo "</tr>";
		//No 7
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center>$data_presentasi[aspek_7]</td>";
		echo "</tr>";
		//No 8
		echo "<tr>";
			...
			echo "<td align=center>$data_presentasi[aspek_8]</td>";
		echo "</tr>";
		//No 9
		echo "<tr>";
			...
			echo "<td align=center>10%</td>";
			echo "<td align=center>$data_presentasi[aspek_9]</td>";
		echo "</tr>";
		//Nilai Rata-Rata
		echo "<tr>";
			echo "<td colspan=3 align=right>Rata-Rata Nilai (Jumlah Bobot x Nilai)</td>";
			echo "<td align=center><b>$data_presentasi[nilai_rata]</b></td>";
		echo "</tr>";
		echo "</table><br>";
