...
<head>
	...
	<title>On-line Tambah Presentasi Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI PRESENTASI KASUS<br>KEPANITERAAN (STASE) ILMU KESEHATAN THT-KL</h2>
						<br>
						<?php
						$id_stase = "M105";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_presentasi = mysqli_query($con, "INSERT INTO `thtkl_nilai_presentasi`
				( `nim`, `dosen`, `aspek_1`, `aspek_2`,`aspek_3`, `aspek_4`,
					`aspek_5`, `aspek_6`, `aspek_7`,`aspek_8`,`aspek_9`,`nilai_rata`,
					`umpan_balik`,`saran`,
					`tgl_isi`,`tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]', '$_POST[dosen]','$aspek1','$aspek2','$aspek3','$aspek4',
					'$aspek5','$aspek6','$aspek7','$aspek8','$aspek9','$nilai_rata',
					'$umpan_balik','$saran',
					'$tgl','2000-01-01','0')");
