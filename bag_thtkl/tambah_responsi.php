...
<head>
	...
	<title>On-line Tambah Responsi Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI RESPONSI KASUS KECIL<br>KEPANITERAAN (STASE) ILMU KESEHATAN THT-KL</h2>
						<br>
						<?php
						$id_stase = "M105";
						...
						$kasus_terakhir = mysqli_fetch_array(mysqli_query($con, "SELECT max(`kasus_ke`) FROM `thtkl_nilai_responsi` WHERE `nim`='$data_mhsw[nim]'"));
						$kasus_ke = $kasus_terakhir[0] + 1;
						echo "<input type=\"hidden\" name=\"kasus_ke\" value=\"$kasus_ke\">";
						echo "<td style=\" font-weight:600;\">$kasus_ke</td>";
						echo "</tr>";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_responsi = mysqli_query($con, "INSERT INTO `thtkl_nilai_responsi`
				( `nim`, `dosen`, `kasus_ke`,`aspek_1`, `aspek_2`,`aspek_3`, `aspek_4`,
					`aspek_5`, `aspek_6`, `aspek_7`,`nilai_rata`,
					`umpan_balik`,`saran`,
					`tgl_isi`,`tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]', '$_POST[dosen]','$_POST[kasus_ke]','$aspek1','$aspek2','$aspek3','$aspek4',
