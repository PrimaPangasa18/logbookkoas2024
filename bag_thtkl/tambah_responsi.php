...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR NILAI RESPONSI KASUS KECIL<p>Kepaniteraan (Stase) Ilmu Kesehatan THT-KL</font></h4>";
		...
		//Nilai Rata-Rata
		echo "<tr>";
			echo "<td colspan=3 align=center>Rata-Rata Nilai (Jumlah Bobot x Nilai)</td>";
