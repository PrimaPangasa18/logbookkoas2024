...
<head>
	...
	<title>On-line Tambah Jurnal Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI JOURNAL READING<br>KEPANITERAAN (STASE) ILMU KESEHATAN THT-KL</h2>
						<br>
						<?php
						$id_stase = "M105";
						...
						$jurnal_terakhir = mysqli_fetch_array(mysqli_query($con, "SELECT max(`jurnal_ke`) FROM `thtkl_nilai_jurnal` WHERE `nim`='$data_mhsw[nim]'"));
						$jurnal_ke = $jurnal_terakhir[0] + 1;
						echo "<input type=\"hidden\" name=\"jurnal_ke\" value=\"$jurnal_ke\">";
						echo "<td style=\" font-weight:600;\">$jurnal_ke</td>";
						echo "</tr>";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_jurnal = mysqli_query($con, "INSERT INTO `thtkl_nilai_jurnal`
				( `nim`, `dosen`, `jurnal_ke`, `nama_jurnal`, `judul_paper`,
					`aspek_1`, `aspek_2`,`aspek_3`,`nilai_rata`,
					`umpan_balik`,`saran`,
					`tgl_isi`,`tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]', '$_POST[dosen]','$_POST[jurnal_ke]','$nama_jurnal','$judul_paper',
					'$aspek1','$aspek2','$aspek3','$nilai_rata',
					'$umpan_balik','$saran',
					'$tgl','2000-01-01','0')");
