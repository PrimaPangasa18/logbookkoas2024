			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN THT-KL</h2>
						<br>
						<?php
						$id_stase = "M105";
						...
						if ($cek_stase >= 1) {
							echo "
								...
								<br><br>
								<a href=\"#presentasi\" class=\"btn btn-success me-3\">Pengisian Formulir Penilaian Presentasi Kasus</a>
								<a href=\"#responsi\" class=\"btn btn-primary me-3\">Pengisian Formulir Penilaian Responsi Kasus Kecil</a>
								<a href=\"#jurnal\" class=\"btn me-3\" style=\"background-color: #800080; color: white;\">Pengisian Formulir Penilaian Journal Reading</a>
								<br><br>
								<a href=\"#test\" class=\"btn me-3\" style=\"background-color: #A52A2A; color: white;\">Preview Nilai Test</a>
								<a href=\"#osce\" class=\"btn me-3\" style=\"background-color: #00008B; color: white;\">Pengisian Formulir Penilaian Ujian OSCE</a>
								<br><br>
								";
							echo "</center>";
							...
							echo "<br><br>";
							echo "<a id=\"presentasi\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Presentasi Kasus</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							if ($cek_approved_presentasi > 0)
								echo "<br><center><a href=\"cetak_presentasi.php\" target=\"_BLANK\">
							...
							echo "<a id=\"responsi\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Responsi Kasus Kecil</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							if ($cek_nilai_responsi < 1) {
								...
								while ($data_responsi = mysqli_fetch_array($nilai_responsi)) {
									...
									if ($data_responsi['status_approval'] == '0')
										echo " <a href=\"approve_responsi.php?id=$data_responsi[id]\">
   												<button type=\"button\"  class=\"btn btn-primary btn-sm\" name=\"approve_$data_responsi[id]\" >
    											<i class=\"fas fa-notes-medical me-2\"></i> APPROVE
												</button></a>";
									echo "</td>";
									echo "<td align=center>";
									if ($data_responsi['status_approval'] == '0') {
										echo "<font style=\"color:red; font-weight:600;\">BELUM DISETUJUI</font><br><br>";
										echo "<a href=\"edit_form_responsi.php?id=$data_responsi[id]\">
       										 <button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"edit_$data_responsi[id]\" value=\"EDIT\">
            								<i class=\"fas fa-edit me-2\"></i> EDIT
       										</button>
      										</a><p><br>";
										echo "<a href=\"preview_form_responsi.php?id=$data_responsi[id]\">
        										<button type=\"button\" class=\"btn btn-primary btn-sm\" name=\"preview_$data_responsi[id]\" value=\"PREVIEW\">
            								<i class=\"fas fa-eye me-2\"></i> PREVIEW
        									</button>
      										</a><p>";
										echo "<a href=\"hapus_form_responsi.php?id=$data_responsi[id]\">
        									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"hapus_$data_responsi[id]\" value=\"HAPUS\">
            								<i class=\"fas fa-trash-alt me-2\"></i> HAPUS
        									</button>
      										</a>";
									} else {
										...
										echo "<span style=\"color:darkblue; font-weight:600;\">$tanggal_approval</span>";
										echo "<br><br>
										<a href=\"view_form_responsi.php?id=$data_responsi[id]\">
							...
							echo "</table>";
							echo "<br><center><a href=\"tambah_responsi.php\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-success\" name=\"tambah\" value=\"TAMBAH\"><i class=\"fas fa-plus\"></i> TAMBAH</button>
								</a>";
							...
							if ($cek_approved_responsi > 0)
								echo "<br><br><center><a href=\"cetak_responsi.php\" target=\"_BLANK\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-primary\" name=\"cetak\" value=\"CETAK\"><i class=\"fas fa-print\"></i> CETAK</button>
								</a>";
							echo "</center><br><br>";
							echo "</center>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							echo "<a id=\"test\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Preview Nilai Test</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							if ($cek_approved_osce > 0)
								echo "<br><br><a href=\"cetak_osce.php\" target=\"_BLANK\">
								<button type=\"button\" style=\"margin-right: 10px;\" class=\"btn btn-primary\" name=\"cetak\" value=\"CETAK\"><i class=\"fas fa-print\"></i> CETAK</button>
								</a>";
							echo "<br><br><br><a href=\"cetak_nilai_thtkl.php\" target=\"_BLANK\">";
