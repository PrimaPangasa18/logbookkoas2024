...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==4)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN THT-KL</font></h4>";
		...
		echo "</center><br><a href=\"#presentasi\"><i>Penilaian Presentasi Kasus</i></a><br>";
		echo "<a href=\"#responsi\"><i>Penilaian Responsi Kasus Kecil</i></a><br>";
