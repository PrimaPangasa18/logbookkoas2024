...
<head>
	...
	<title>On-line Penilaian Bagian THTKL Logbook Koas Pendidikan Dokter FK-UNDIP</title>
	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN THT-KL</h2>
						<br>
						<?php
						...
						echo "
								...
								<br><br>
								<a href=\"#presentasi\" class=\"btn btn-success me-3\">Penilaian Presentasi Kasus</a>
								<a href=\"#responsi\" class=\"btn btn-primary me-3\">Penilaian Responsi Kasus Kecil</a>
								<a href=\"#jurnal\" class=\"btn me-3\" style=\"background-color: #800080; color: white;\">Penilaian Journal Reading</a>
								<br><br>
								<a href=\"#osce\" class=\"btn me-3\" style=\"background-color: #A52A2A; color: white;\">Penilaian Ujian OSCE</a>
								<br><br>
								";
						echo "</center>";

						//Penilaian Presentasi Kasus
						echo "<a id=\"presentasi\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Presentasi Kasus</a><br><br>";
						$nilai_presentasi = mysqli_query($con, "SELECT * FROM `thtkl_nilai_presentasi` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						echo "<a id=\"responsi\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Responsi Kasus Kecil</a><br><br>";
						$nilai_responsi = mysqli_query($con, "SELECT * FROM `thtkl_nilai_responsi` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						if ($cek_nilai_responsi < 1) {
							...
							while ($data_responsi = mysqli_fetch_array($nilai_responsi)) {
								...
								if ($data_responsi['status_approval'] == '0') {
									echo "<font style=\"color:red; font-weight:600;\">BELUM DISETUJUI</font>";
									echo "<br><br>
										<a href=\"approve_responsi_dosen.php?id=$data_responsi[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"approve_$data_responsi[id]\" value=\"VIEW & APPROVE\">
            								<i class=\"fas fa-eye me-2\"></i> VIEW & APPROVE
        									</button>
      										</a>";
								} else {
									...
									echo "<span style=\"color:darkblue; font-weight:600;\">$tanggal_approval</span>";
									echo "<br><br>
										<a href=\"view_form_responsi.php?id=$data_responsi[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-success btn-sm\" name=\"view_$data_responsi[id]\" value=\"VIEW\">
            								<i class=\"fas fa-eye me-2\"></i> VIEW
        									</button>
      										</a>";
									...
									echo "<br><br>
									<a href=\"unapprove_responsi_dosen.php?id=$data_responsi[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"unapprove\".\"$data_responsi[id]\"  value=\"UNAPPROVE\">
									<i class=\"fas fa-circle-xmark me-2\"></i> UNAPPROVE
									</button></a>";
								}
								echo "</td>";
						...
						$nilai_jurnal = mysqli_query($con, "SELECT * FROM `thtkl_nilai_jurnal` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
	      ...
	      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						echo "<a id=\"osce\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Ujian OSCE</a><br><br>";
						$nilai_osce = mysqli_query($con, "SELECT * FROM `thtkl_nilai_osce` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `tgl_isi`");
						...
						if ($cek_nilai_osce < 1) {
							...
							while ($data_osce = mysqli_fetch_array($nilai_osce)) {
								...
								if ($data_osce['status_approval'] == '0') {
									echo "<font style=\"color:red; font-weight:600;\">BELUM DISETUJUI</font>";
									echo "<br><br>
										<a href=\"approve_osce_dosen.php?id=$data_osce[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-warning btn-sm\" name=\"approve_$data_osce[id]\" value=\"VIEW & APPROVE\">
            								<i class=\"fas fa-eye me-2\"></i> VIEW & APPROVE
        									</button>
      										</a>";
								} else {
									...
									echo "<span style=\"color:darkblue; font-weight:600;\">$tanggal_approval</span>";
									echo "<br><br>
										<a href=\"view_form_osce.php?id=$data_osce[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
        										<button type=\"button\" class=\"btn btn-success btn-sm\" name=\"view_$data_osce[id]\" value=\"VIEW\">
            								<i class=\"fas fa-eye me-2\"></i> VIEW
        									</button>
      										</a>";
									...
									echo "<br><br>
									<a href=\"unapprove_osce_dosen.php?id=$data_osce[id]&mulai=$tgl_mulai&selesai=$tgl_selesai&approval=$approval&mhsw=$mhsw\">
									<button type=\"button\" class=\"btn btn-danger btn-sm\" name=\"unapprove\".\"$data_osce[id]\"  value=\"UNAPPROVE\">
									<i class=\"fas fa-circle-xmark me-2\"></i> UNAPPROVE
									</button></a>";
								}
								echo "</td>";
