...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND ($_COOKIE['level']==1 OR $_COOKIE['level']==2 OR $_COOKIE['level']==3 OR $_COOKIE['level']==5))
	{
	  ...
	  if ($_COOKIE['level']==3) {include "menu3.php";}
		...
		echo "<div class=\"text_header\">CETAK NILAI AKHIR BAGIAN / KEPANITERAAN (STASE)</div>";
		echo "<br><br><br><fieldset class=\"fieldset_art\">
	    <legend align=left><font style=\"color:black;font-style:italic;font-size:0.825em;\">[user: $_COOKIE[nama], $_COOKIE[gelar]]</font></legend>";

		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">CETAK NILAI AKHIR BAGIAN / KEPANITERAAN (STASE)</font></h4><br>";
		...
		{
			echo "<input type=\"hidden\" name=\"mhsw\" value=\"$_COOKIE[user]\" />";
		}
		echo "</table>";
		echo "<br><input type=\"submit\" class=\"submit1\" name=\"preview\" value=\"PREVIEW\">";
		echo "</form>";
		...
		if ($_POST[preview]=="PREVIEW")
		{
			...
			echo "<center><br>";
			echo "<a href=\"cetak_nilai_akhir.php?stase=$_POST[bagian]&nim=$_POST[mhsw]\" target=\"_blank\"><img src=\"pdf.png\" style=\"width:30px;\" title=\"Cetak format pdf\"/></a><br><br>";
			echo "<a href=\"cetak_nilai_akhir.php?stase=$_POST[bagian]&nim=$_POST[mhsw]\" target=\"_blank\">Cetak PDF</a><br><br>";

			echo "<table border=1 style=\"width:70%\">";
			echo "<tr>";
			echo "<td style=\"width:30%\">Nama Mahasiswa</td>";
			echo "<td style=\"width:70%\">$data_mhsw[nama]</td>";
			echo "</tr>";
			echo "<tr>";
			echo "<td>NIM</td>";
			...
			echo "<th style=\"width:70%\">Item Penilaian</th>";
			echo "<th style=\"width:25%\">Nilai / Grade</th>";
			echo "</thead>";

			echo "<tr>";
			echo "<td align=center>1</td>";
			echo "<td>Grade Ketuntasan, rata-rata dari:<br>";
			echo "a. Grade Jurnal Penyakit = $grade_penyakit<br>";
			echo "b. Grade Jurnal Ketrampilan = $grade_ketrampilan</td>";
			echo "<td align=center>$ketuntasan %</td>";
			echo "</tr>";
			if ($id_stase!="M121")
			{
				echo "<tr>";
				echo "<td align=center>2</td>";
				echo "<td>Penilaian Bagian</td>";
			...
			else
			{
				...
				echo "<tr>";
				echo "<td align=center>2</td>";
				echo "<td>Penilaian Bagian, rata-rata dari:<br>";
				echo "a. Nilai Komprehensip = $nilai_kompre<br>";
				echo "b. Nilai Kedokteran Keluarga = $nilai_kdk</td>";
				echo "<td align=center>$nilai_bagian</td>";
				echo "</tr>";
			}
			echo "<tr>";
			echo "<td colspan=2 align=right>Nilai Akhir ( $persen_ketuntasan% x $nilai_bagian )</td>";
			echo "<td align=center><b>$nilai_akhir</b></td>";
			echo "</tr>";
			echo "<tr>";
			echo "<td colspan=2 align=right>Ekivalensi Nilai Huruf</td>";
			echo "<td align=center><b>$grade_akhir</b></td>";
			echo "</tr>";
			echo "</tr>";
			echo "<tr>";
			echo "<td colspan=3><i><font style=\"font-size:0.85em\">";
			echo "Nilai Akhir = Rasio Ketuntasan x Nilai Bagian<br><br>";
			echo "&nbsp;&nbsp;Grade Ketuntasan >= 70% --> Rasio Ketuntasan = 100%<br>";
			echo "&nbsp;&nbsp;60% <= Grade Ketuntasan < 70% --> Rasio Ketuntasan = 80%<br>";
			echo "&nbsp;&nbsp;50% <= Grade Ketuntasan < 60% --> Rasio Ketuntasan = 60%<br>";
			echo "&nbsp;&nbsp;Grade Ketuntasan < 50% --> Rasio Ketuntasan = 40%<br><br>";
			echo "Ctt: Grade Ketuntasan = (Grade Jurnal Penyakit + Grade Jurnal Ketrampilan)/2";
			echo "</font></i></td>";
			echo "</tr>";
			echo "</table><br><br>";
			}
