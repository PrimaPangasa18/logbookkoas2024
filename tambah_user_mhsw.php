                ...
                <table class="table table-bordered" style="width: 800px;">
                  <tr class="table-primary" style="border-width: 1px; border-color: #000;">
                    ...
                    <td style="width: 500px;">
                      <?php
                      echo "<input type=\"text\" name=\"user_name\" placeholder=\"Masukkan NIM\" class=\"form-control\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" required>";
                      ?>
                    </td>
                  </tr>
                  ...
                  <tr class="table-primary" style="border-width: 1px; border-color: #000;">
                    ...
                    <td style="width: 500px;">
                      <?php
                      echo "<input type=\"password\" id=\"form-password\" placeholder=\"Buat Password\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" name=\"user_pass\" class=\"form-control\" required>";
                      ?>
                      <br>
