			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						if ($_GET['cbd'] == "1") $kasus = "Radiodiagnostik";
						else $kasus = "Radioterapi";
						$kasus_up = strtoupper($kasus);
						?>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR PENILAIAN KASUS CBD - <?php echo "$kasus_up"; ?><br>KEPANITERAAN (STASE) RADIOLOGI</h2>
						<br>
						<?php
						echo "<form method=\"POST\" action=\"$_SERVER[PHP_SELF]\">";
						echo "<input type=\"hidden\" name=\"id_stase\" value=\"$id_stase\">";
						echo "<input type=\"hidden\" name=\"nim\" value=\"$data_mhsw[nim]\">";
						echo "<input type=\"hidden\" name=\"kasus\" value=\"$kasus\">";
						echo "<center>";
						...
						//Jenis Kasus
						echo "<tr class=\"table-primary\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Jenis Kasus</strong></td>";
						echo "<td style=\"font-weight:600;\">$kasus</td>";
						echo "</tr>";
						//Tanggal Ujian
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<th style=\"width:20%;text-align:center;\">Nilai</th>";
						echo "</thead>";
						//No 1
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td align=center class=\"td_mid\"><strong>1</strong></td>";
						echo "<td><strong>Kemampuan membuat permintaan dan mengintepretasi pemeriksaan radiologi</strong></td>";
						...
						echo "<td><strong>Kemampuan Penulisan</strong></td>";
						...
						echo "<td><strong>Penyajian</strong></td>";
						...
						echo "<td><strong>Tanya Jawab</strong></td>";
						...
						//Nilai Rata
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=2 align=right><strong>Nilai Rata-Rata</strong></td>";
						...
						<textarea name=\"umpan_balik\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" placeholder=\"<< Catatan >>\"></textarea></td>";
						echo "</tr>";
						echo "<tr  class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_cbd = mysqli_query($con, "INSERT INTO `radiologi_nilai_cbd`
				( `nim`, `dosen`, `tgl_ujian`,`kasus`,
					`aspek_1`, `aspek_2`,`aspek_3`,
					`aspek_4`, `aspek_5`,`aspek_6`,
					`nilai_rata`,`umpan_balik`,`saran`,
					`tgl_isi`,`tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]', '$_POST[dosen]','$_POST[tanggal_ujian]','$_POST[kasus]',
					'$aspek1','$aspek2','$aspek3',
					'$aspek4','$aspek5','$aspek6',
					'$rata','$umpan_balik','$saran',
					'$tgl','2000-01-01','0')");
