...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">FORM PENILAIAN KEPANITERAAN (STASE) RADIOLOGI</font></h4><br>";
		$id_stase = "M103";
		...
		if ($cek_stase>=1)
		{
			echo "</center><br><a href=\"#cbd1\"><i>Pengisian Formulir Penilaian Kasus CBD - Radiodiagnostik</i></a><br>";
			echo "<a href=\"#cbd2\"><i>Pengisian Formulir Penilaian Kasus CBD - Radioterapi</i></a><br>";
			echo "<a href=\"#jurnal\"><i>Pengisian Formulir Penilaian Journal Reading</i></a><br>";
			echo "<a href=\"#test\"><i>Preview Nilai Test dan Sikap/Perilaku</i></a><br><br>";

			//Pengisian Formulir Penilaian Kasus CBD - Radiodiagnostik
			echo "<a id=\"cbd1\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Pengisian Formulir Penilaian Kasus CBD - Radiodiagnostik</font></a><br><br>";
			...
			echo "</table>";
			if ($cek_nilai_cbd<1)
			echo "<br><center><a href=\"tambah_cbd.php?cbd=1\"><input type=\"button\" class=\"submit1\" name=\"tambah\" value=\"TAMBAH\"></a>";
			...
			echo "<br><center><a href=\"cetak_cbd.php?cbd=1\" target=\"_BLANK\"><input type=\"button\" class=\"submit1\" name=\"cetak\" value=\"CETAK\"></a>";
			echo "</center><br><br>";

			//Pengisian Formulir Penilaian Kasus CBD - Radioterapi
			echo "<a id=\"cbd2\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Pengisian Formulir Penilaian Kasus CBD - Radioterapi</font></a><br><br>";
			$kasus = "Radioterapi";
			$nilai_cbd = mysqli_query($con,"SELECT * FROM `radiologi_nilai_cbd` WHERE `nim`='$_COOKIE[user]' AND `kasus`='$kasus'");
			...
			echo "</table>";
			if ($cek_nilai_cbd<1)
			echo "<br><center><a href=\"tambah_cbd.php?cbd=2\"><input type=\"button\" class=\"submit1\" name=\"tambah\" value=\"TAMBAH\"></a>";
			$cek_approved_cbd = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `radiologi_nilai_cbd` WHERE `nim`='$_COOKIE[user]' AND `kasus`='$kasus' AND `status_approval`='1'"));
			if ($cek_approved_cbd>0)
			echo "<br><center><a href=\"cetak_cbd.php?cbd=2\" target=\"_BLANK\"><input type=\"button\" class=\"submit1\" name=\"cetak\" value=\"CETAK\"></a>";
			echo "</center><br><br>";
			...
			echo "<a id=\"test\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Preview Nilai Test dan Sikap/Perilaku</font></a><br><br>";
			...
			echo "<center><a href=\"cetak_nilai_radiologi.php\" target=\"_BLANK\"><input type=\"button\" id=\"cetak_nilai\" class=\"submit1\" name=\"cetak_nilai\" value=\"CETAK NILAI\"></a>";
			echo "</center><br><br>";
