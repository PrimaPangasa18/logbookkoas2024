...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==4)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">PENILAIAN KEPANITERAAN (STASE) RADIOLOGI</font></h4>";
		...
		echo "</center><br><a href=\"#cbd1\"><i>Penilaian Kasus CBD - Radiodiagnostik</i></a><br>";
		echo "<a href=\"#cbd2\"><i>Penilaian Kasus CBD - Radioterapi</i></a><br>";
		echo "<a href=\"#jurnal\"><i>Penilaian Journal Reading</i></a><br><br>";

		//Penilaian Kasus CBD - Radiodiagnostik
		echo "<a id=\"cbd1\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Kasus CBD - Radiodiagnostik</font></a><br><br>";
		...
		else
		{
		  ...
		  while ($data_cbd=mysqli_fetch_array($nilai_cbd))
		  {
		    ...
		    echo "<td>Penilaian Kasus CBD - $data_cbd[kasus]<br><br>";
		...
		echo "<a id=\"cbd1\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Kasus CBD - Radioterapi</font></a><br><br>";
		$kasus="Radioterapi";
		$nilai_cbd = mysqli_query($con,"SELECT * FROM `radiologi_nilai_cbd` WHERE `dosen`='$_COOKIE[user]' AND `kasus`='$kasus' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
