			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PENILAIAN KEPANITERAAN (STASE) RADIOLOGI</h2>
						<br>
						<?php
						...
						//Penilaian Kasus CBD - Radiodiagnostik
						echo "<br><br>";
						echo "<a id=\"cbd1\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Kasus CBD - Radiodiagnostik</a><br><br>";
						$kasus = "Radiodiagnostik";
						$nilai_cbd = mysqli_query($con, "SELECT * FROM `radiologi_nilai_cbd` WHERE `dosen`='$_COOKIE[user]' AND `kasus`='$kasus' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						//Penilaian Kasus CBD - Radioterapi
						echo "<br><br>";
						echo "<a id=\"cbd1\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Kasus CBD - Radioterapi</a><br><br>";
						$kasus = "Radioterapi";
						$nilai_cbd = mysqli_query($con, "SELECT * FROM `radiologi_nilai_cbd` WHERE `dosen`='$_COOKIE[user]' AND `kasus`='$kasus' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						$nilai_jurnal = mysqli_query($con, "SELECT * FROM `radiologi_nilai_jurnal` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
