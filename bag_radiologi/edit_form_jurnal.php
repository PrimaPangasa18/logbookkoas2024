			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT NILAI JOURNAL READING<br>KEPANITERAAN (STASE) RADIOLOGI</h2>
						<br>
						<?php
						$id_stase = "M103";
						$id = $_GET['id'];
				...
				`catatan`='$catatan', `nilai_rata`='$nilai_rata',`tgl_isi`='$tgl'
				WHERE `id`='$_POST[id]'");
