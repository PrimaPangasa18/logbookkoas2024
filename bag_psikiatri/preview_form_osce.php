...
<head>
	...
	<title>On-line Preview Ujian OSCE Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PREVIEW NILAI UJIAN OSCE<br>KEPANITERAAN (STASE) ILMU KESEHATAN JIWA</h2>
						<br>
						<?php
						$id_stase = "M093";
						$id = $_GET['id'];
						...
						echo "<td align=center class=\"td_mid\"><strong>$data_osce[aspek_1]</strong></td>";
						echo "</tr>";
						//No 2
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>20%</strong></td>";
						echo "<td align=center class=\"td_mid\"><strong>$data_osce[aspek_2]</strong></td>";
						echo "</tr>";
						//No 3
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>20%</strong></td>";
						echo "<td align=center class=\"td_mid\"><strong>$data_osce[aspek_3]</strong></td>";
						echo "</tr>";
						//No 4
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>20%</strong></td>";
						echo "<td align=center class=\"td_mid\"><strong>$data_osce[aspek_4]</strong></td>";
						echo "</tr>";
						//No 5
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center class=\"td_mid\"><strong>$data_osce[aspek_5]</strong></td>";
						echo "</tr>";
						//No 6
						echo "<tr class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">";
						...
						echo "<td align=center><strong>10%</strong></td>";
						echo "<td align=center class=\"td_mid\"><strong>$data_osce[aspek_6]</strong></td>";
						echo "</tr>";
						...
						echo "<td align=center class=\"td_mid\"><strong style=\"color:blue\">$data_osce[nilai_rata]</strong></td>";
						echo "</tr>";
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td colspan=3 align=right class=\"td_mid\"><strong>Konversi Nilai ke Huruf</strong></td>";
						...
						<textarea name=\"umpan_balik\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_osce[umpan_balik]</textarea></td>";
						echo "</tr>";
						echo "<tr  class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
						echo "<td><strong>Saran:</strong><br>
						<textarea name=\"saran\" rows=5 style=\"width:100%;margin-top:10px;font-family:Poppins;font-size:1em\" disabled>$data_osce[saran]</textarea></td>";
						echo "</tr>";
						echo "<tr  class=\"table-warning\" style=\"border-width: 1px; border-color: #000;\">
