		...
		<div class="main">
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">APPROVAL NILAI CBD - LEMBAR PENILAIAN FORMATIF KOMPETENSI KLINIK<p>KEPANITERAAN (STASE) ILMU KESEHATAN JIWA</h2>
						<br>
						<?php
						$id_stase = "M093";
						$id = $_GET['id'];
			...
			";
						...
						if ($_POST['approve'] == "APPROVE") {
							$dosen_cbd = mysqli_fetch_array(mysqli_query($con, "SELECT `dosen` FROM `psikiatri_nilai_cbd` WHERE `id`='$_POST[id]'"));
