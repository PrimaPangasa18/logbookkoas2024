			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN JIWA</h2>
						<br>
						<?php
						...
						echo "
								...
								<br><br>
								<a href=\"#jurnal\" class=\"btn btn-success me-3\">Penilaian Journal Reading</a>
								<a href=\"#cbd\" class=\"btn btn-primary me-3\">Penilaian CBD</a>
								<a href=\"#minicex\" class=\"btn me-3\" style=\"background-color: #800080; color: white;\">Penilaian Ujian MINI-CEX</a>
						...
						$nilai_jurnal = mysqli_query($con, "SELECT * FROM `psikiatri_nilai_jurnal` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						echo "<br>";
						//Penilaian Kasus CBD
						echo "<a id=\"cbd\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian CBD</a><br><br>";
						$nilai_cbd = mysqli_query($con, "SELECT * FROM `psikiatri_nilai_cbd` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
						echo "<table class=\"table table-bordered\" style=\"width:100%\" id=\"freeze2\">";
						echo "<thead class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">
		      <th style=\"width:5%;text-align:center;\">No</th>
		      <th style=\"width:15%;text-align:center;\">Tanggal Pengisian</th>
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						$nilai_minicex = mysqli_query($con, "SELECT * FROM `psikiatri_nilai_minicex` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
		      ...
		      <th style=\"width:15%;text-align:center;\">Status Approval</th>
						...
						$nilai_osce = mysqli_query($con, "SELECT * FROM `psikiatri_nilai_osce` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' ORDER BY `id`");
