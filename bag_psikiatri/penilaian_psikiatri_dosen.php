...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==4)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN JIWA</font></h4>";
		...
		echo "<br></center><a href=\"#jurnal\"><i>Penilaian Journal Reading</i></a><br>";
		echo "<a href=\"#cbd\"><i>Penilaian Kasus CBD</i></a><br>";
		echo "<a href=\"#minicex\"><i>Penilaian Ujian MINI-CEX</i></a><br>";
