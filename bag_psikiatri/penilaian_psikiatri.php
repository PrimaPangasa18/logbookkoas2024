...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">FORM PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN JIWA</font></h4><br>";
		$id_stase = "M093";
		...
		if ($cek_stase>=1)
		{
			echo "<br></center><a href=\"#jurnal\"><i>Pengisian Formulir Penilaian Journal Reading</i></a><br>";
			echo "<a href=\"#cbd\"><i>Pengisian Formulir Penilaian CBD</i></a><br>";
			echo "<a href=\"#minicex\"><i>Pengisian Formulir Penilaian Ujian MINI-CEX</i></a><br>";
			echo "<a href=\"#osce\"><i>Pengisian Formulir Penilaian Ujian OSCE</i></a><br>";
			...
			echo "<br><center><a href=\"cetak_osce.php\" target=\"_BLANK\"><input type=\"button\" class=\"submit1\" name=\"cetak\" value=\"CETAK\"></a>";
			echo "</center><br><br>";
			...
			echo "<br><br><br><center><a href=\"cetak_nilai_psikiatri.php\" target=\"_BLANK\"><input type=\"button\" id=\"cetak_nilai\" class=\"submit1\" name=\"cetak_nilai\" value=\"CETAK NILAI\"></a>";
			echo "</center><br><br>";
