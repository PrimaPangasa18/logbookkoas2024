			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORMULIR NILAI UJIAN OSCE<p>KEPANITERAAN (STASE) ILMU KESEHATAN JIWA</h2>
						<br>
						<?php
						$id_stase = "M093";
				...
				";
						...
						if ($_POST['usulkan'] == "USULKAN") {
							...
							$insert_osce = mysqli_query($con, "INSERT INTO `psikiatri_nilai_osce`
				( `nim`, `dosen`, `tgl_ujian`,
					`aspek_1`,`aspek_2`,`aspek_3`,`aspek_4`,
					`aspek_5`,`aspek_6`,
					`nilai_rata`,`umpan_balik`,`saran`,`tgl_isi`,
					`tgl_approval`, `status_approval`)
				VALUES
				( '$_POST[nim]','$_POST[dosen]','$_POST[tanggal_ujian]',
					'$aspek1','$aspek2','$aspek3','$aspek4',
					'$aspek5','$aspek6',
					'$nilai_rata','$umpan_balik','$saran','$tgl',
					'2000-01-01','0')");
