...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">FORM PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN KULIT DAN KELAMIN</font></h4><br>";
		$id_stase = "M114";
		...
		if ($cek_stase>=1)
		{
			echo "</center><br><a href=\"#cbd\"><i>Pengisian Formulir Penilaian Ujian Kasus</i></a><br>";
			echo "<a href=\"#test\"><i>Preview Nilai-Nilai OSCE, Ujian Teori dan Perilaku</i></a><br><br>";

			//Pengisian Formulir Penilaian CBD
			echo "<a id=\"cbd\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Pengisian Formulir Penilaian Ujian Kasus</font></a><br><br>";
			$nilai_cbd = mysqli_query($con,"SELECT * FROM `kulit_nilai_cbd` WHERE `nim`='$_COOKIE[user]'");
			...
			$cek_approved_cbd = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `kulit_nilai_cbd` WHERE `nim`='$_COOKIE[user]' AND `status_approval`='1'"));
			if ($cek_approved_cbd>0)
			echo "<br><center><a href=\"cetak_nilai_cbd.php\" target=\"_BLANK\"><input type=\"button\" class=\"submit1\" name=\"cetak\" value=\"CETAK\"></a>";
			echo "</center><br><br>";


			//Preview Nilai-Nilai OSCE, Ujian Teori dan Perilaku
			echo "<a id=\"test\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Preview Nilai-Nilai OSCE, Ujian Teori dan Perilaku</font></a><br><br>";
			$nilai_test = mysqli_query($con,"SELECT * FROM `kulit_nilai_test` WHERE `nim`='$_COOKIE[user]'");
			...
			echo "</table>";
			$cek_approved_test = mysqli_num_rows(mysqli_query($con,"SELECT `id` FROM `kulit_nilai_test` WHERE `nim`='$_COOKIE[user]' AND `status_approval`='1'"));
			...
			echo "<br><br><br><center><a href=\"cetak_nilai_kulit.php\" target=\"_BLANK\"><input type=\"button\" id=\"cetak_nilai\" class=\"submit1\" name=\"cetak_nilai\" value=\"CETAK NILAI\"></a>";
			echo "</center><br><br>";
