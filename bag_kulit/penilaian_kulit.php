...
<head>
	...
	<title>On-line Penilaian Bagian Kulit dan Kelamin Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">FORM PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN KULIT DAN KELAMIN</h2>
						<br>
						<?php
						$id_stase = "M114";
						...
						if ($cek_stase >= 1) {
							echo "
								...
								<br><br>
								<a href=\"#cbd\" class=\"btn btn-success me-3\">Pengisian Formulir Penilaian Ujian Kasus</a>
								<a href=\"#test\" class=\"btn btn-primary me-3\">Preview Nilai-Nilai OSCE, Ujian Teori dan Perilaku</a>
								<br><br>
								";
							echo "</center>";
							...
							echo "<br><br>";
							echo "<a id=\"cbd\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Pengisian Formulir Penilaian Ujian Kasus</a><br><br>";
						...
						<th style=\"width:15%;text-align:center;\">Status Approval</th>
							...
							echo "<a id=\"test\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Preview Nilai-Nilai OSCE, Ujian Teori dan Perilaku</a><br><br>";
			      ...
			      <th style=\"width:15%;text-align:center;\">Nilai</th>
							...
							echo "<br><br><br><a href=\"cetak_nilai_kulit.php\" target=\"_BLANK\">";
