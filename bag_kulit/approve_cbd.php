...
<head>
	...
	<title>On-line Approval Ujian Kasus Logbook Koas Pendidikan Dokter FK-UNDIP</title>
		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">APPROVAL NILAI UJIAN KASUS</h2>
						<br>
						<?php
						$id = $_GET['id'];
						$id_stase = "M114";
			...
			";
						...
						if ($_POST['approve'] == "APPROVE") {
							$cbd = mysqli_fetch_array(mysqli_query($con, "SELECT `dosen` FROM `kulit_nilai_cbd` WHERE `id`='$_POST[id]'"));
