...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==4)
	{
		...
		echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN KULIT DAN KELAMIN</font></h4>";
		...
		echo "</center><br><a href=\"#cbd\"><i>Penilaian Ujian Kasus</i></a><br><br>";

		//Pengisian Formulir Penilaian CBD
		echo "<a id=\"cbd\"><font style=\"font-size:1.125em;font-weight:bold;font-family:GEORGIA\">Penilaian Ujian Kasus</font></a><br><br>";
