...
<head>
	...
	<title>On-line Penilaian Bagian Kulit Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4" style="background-image: url('images/undip_watermark_color.png'), url('images/undip_watermark_color.png'); ">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">PENILAIAN KEPANITERAAN (STASE) ILMU KESEHATAN KULIT DAN KELAMIN</h2>
						<br>
						<?php
						...
						echo "
								...
								<br><br>
								<a href=\"#cbd\" class=\"btn btn-success me-3\">Penilaian Ujian Kasus</a>
								<br><br>
								";
						echo "</center>";
						...
						echo "<br><br>";
						echo "<a id=\"cbd\" style=\"font-size:1.2em;font-family:'Poppins', sans-serif;font-weight:800;\">Penilaian Ujian Kasus</a><br><br>";
						$nilai_cbd = mysqli_query($con, "SELECT * FROM `kulit_nilai_cbd` WHERE `dosen`='$_COOKIE[user]' AND `tgl_isi`>='$tgl_mulai' AND `tgl_isi`<='$tgl_selesai' $filter_approval ORDER BY `id`");
