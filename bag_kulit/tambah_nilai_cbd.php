...
<?php
	...
	if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE['level']==5)
	{
		...
		echo "<center><h4 id=\"top\"><font style=\"color:#006400;text-shadow:1px 1px black;\">FORMULIR NILAI UJIAN KASUS</font></h4>";
		...
		echo "<tr>";
			...
			echo "<td style=\"width:60%\"><textarea name=\"kasus\" style=\"width:97%;font-family:Tahoma;font-size:1em\" placeholder=\"<< Judul Kasus >>\" required></textarea></td>";
		echo "</tr>";
		...
		echo "<tr>";
			...
			echo "<td><input type=\"text\" name=\"tgl_isi\" class=\"tgl_isi\" style=\"font-size:0.85em\" value=\"$tgl\" required/></td>";
		echo "</tr>";
		//Jam kegiatan
		echo "<tr>";
			...
			echo "<td>";
				...
				echo "<option value=\"\">< Menit ></option>";
				...
				echo "<option value=\"\">< Zona Waktu ></option>";
		...
		if ($_POST[usulkan]=="USULKAN")
		{
			...
			$insert_kasus=mysqli_query($con,"INSERT INTO `kulit_nilai_cbd`
				( `nim`, `dosen`, `kasus`,
				...
				( '$_POST[nim]', '$_POST[dosen]', '$kasus',
					'$aspek_1', '$aspek_2', '$aspek_3', '$aspek_4', '$nilai_rata',
					'$umpan_balik','$saran',
					'$_POST[tgl_isi]','$jam_isi','2000-01-01', '0')");
