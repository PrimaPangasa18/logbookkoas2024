...
<head>
	...
	<title>On-line Tambah Ujian Kasus Logbook Koas Pendidikan Dokter FK-UNDIP</title>
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						...
						echo "<td style=\"width:60%\"><textarea name=\"kasus\" style=\" width: 100%;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" placeholder=\"<< Judul Kasus >>\" required></textarea></td>";
						echo "</tr>";
						...
						echo "<td><input type=\"text\" name=\"tgl_isi\" class=\"form-select tgl_isi\" style=\"font-size:1em;font-family:Poppins;border:0.5px solid black;border-radius:5px;\" value=\"$tgl\" required/></td>";
						echo "</tr>";
						//Jam kegiatan
						echo "<tr class=\"table-success\" style=\"border-width: 1px; border-color: #000;\">";
