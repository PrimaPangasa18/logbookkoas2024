...
#	2016-02-24 00:38:04 - bugfix, mysqli_fetch_field - null when invalid parameters
#	2016-02-24 01:02:44 - bugfix, mysqli_fetch_lengths - null when invalid parameters
...
#	2016-02-24 19:21:21 - bugfix, mysqli_num_fields - null when invalid parameters
...
if (!extension_loaded('mysql')) {
	...
	define('mysqli_num', MYSQLI_NUM);	# Columns are returned into the array having a
	...
	# mysqli_fetch_field - Get column information from a result and return as an object
	# object mysqli_fetch_field ( resource $result [, int $field_offset = 0 ] )
	...
	# mysqli_fetch_lengths - Get the length of each output in a result
	# array mysqli_fetch_lengths ( resource $result )
	# array mysqli_fetch_lengths ( mysqli_result $result )
	function mysqli_fetch_lengths($result) {
		# mysqli_fetch_lengths/mysqli_fetch_lengths = FALSE on error
	...
	function mysqli_fetch_object ($result, $class_name=NULL, $params=NULL) {
		...
		# mysqli_fetch_object = FALSE if there are no more rows
	...
	function mysql_list_processes($link_identifier = NULL) {
		...
		$temp = mysqli_query($con,"SHOW PROCESSLIST", mysql_ensure_link($link_identifier));
		if ($temp === null) {
			return false;
		}
		return $temp;
	...
	# mysqli_num_fields - Get number of fields in result
	# int mysqli_num_fields ( resource $result )
	# int mysqli_field_count ( mysqli $link )
	function mysqli_num_fields ($result) {

		# mysqli_num_fields/mysqli_fetch_fields = FALSE on failure
	...
	function mysqli_num_rows($result) {
		# mysqli_num_rows = FALSE on failure
