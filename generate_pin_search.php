...
if (!empty($_COOKIE['user']) AND !empty($_COOKIE['pass']) AND $_COOKIE[level]==2)
{
  ...
  echo "<center><h4><font style=\"color:#006400;text-shadow:1px 1px black;\">GENERATE OTP DOSEN/RESIDEN</font></h4><br>";
  ...
  if ($_POST['cari']=="CARI")
  {
    ...
    if ($jml>=1)
    {
      ...
      echo "<tr>";
        echo "<td>";
        echo "<font style=\"font-size:0.625em\"><i>(Klik username untuk generate OTP dosen)</i></font>";
        echo "</td>";
      echo "</tr>";
      echo "</table>";
      ...
      while ($data=mysqli_fetch_array($user_kunci))
      {
        ...
        echo "<tr class=\"genap\">";
          ...
          echo "<td><a href=\"generate_pin_admin.php?user_name=$data_dosen[nip]\">$data_dosen[nip]</a></td>";
