		...
		<div class="main">
			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					<div class="mb-3">
						<h3 class="fw-bold fs-4 mb-3">EDIT ISI LOGBOOK - KETERAMPILAN KLINIK</h3>
						<br>
						<h2 class="fw-bold fs-4 mb-3 text-center" style="color:#0A3967">EDIT ISI LOGBOOK KEPANITERAAN (STASE) - KETERAMPILAN KLINIK</h2>
						<br>
						<?php
						...
						<center>
							...
							<center>
								<div class="alert alert-warning" role="alert" style="width: 60%; margin: auto;">
									<!-- Penyakit (Level)-->
									<span style="font-weight: 600; font-family:'Poppins'; color:darkblue">Keterampilan (Level SKDI/Kepmenkes/IPSG/Muatan Lokal)</span>
								</div>
							</center>
							<br><br>
						</center>
						<center>
							<table class="table table-bordered" style="width:auto;">
								<tr class="table-primary" style="border-width: 1px; border-color: #000;">
									<!-- Keterampilan 1 -->
									<td style="width:300px" class="td_mid">
										<span><strong>Keterampilan - 1</strong></span>
									</td>
									<td style="width:500px">
										<div id="my_ketrampilan1" role="dialog" class="fix_style">
											...
											echo "<select name=\"ketrampilan1\" id=\"ketrampilan1\" class=\"form-select\" required>";
								...
								<tr class="table-primary" style="border-width: 1px; border-color: #000;">
									...
									<td style="width:500px">
										<div id="my_ketrampilan2" role="dialog" class="fix_style">
											...
											echo "<select name=\"ketrampilan2\" id=\"ketrampilan2\" class=\"form-select\">";
								...
								<tr class="table-primary" style="border-width: 1px; border-color: #000;">
									...
									<td style="width:500px">
										<div id="my_ketrampilan3" role="dialog" class="fix_style">
											...
											echo "<select name=\"ketrampilan3\" id=\"ketrampilan3\" class=\"form-select\">";
								...
								<tr class="table-primary" style="border-width: 1px; border-color: #000;">
									...
									<td style="width:500px">
										<div id="my_ketrampilan4" role="dialog" class="fix_style">
											...
											echo "<select name=\"ketrampilan4\" id=\"ketrampilan4\" class=\"form-select\">";
