...
$headers = ['A9' => 'No', 'B9' => 'Nama Mahasiswa', 'C9' => 'NIM', 'D9' => 'Angkatan', 'E9' => 'Refleksi Diri'];
...
$sheet->getColumnDimension('B')->setWidth(70); // Nama Mahasiswa
$sheet->getColumnDimension('C')->setWidth(15); // NIM
$sheet->getColumnDimension('D')->setWidth(12); // Angkatan
$sheet->getColumnDimension('E')->setWidth(100); // Refleksi Diri
...
while ($nim_mhsw = mysqli_fetch_array($mhsw)) {
      ...
      $sheet->setCellValue("E$row", $refleksi_diri['refleksi'] ?? 'Belum Mengisi Evaluasi')
...
$filename = 'rekap_evaluasi_stase.xlsx';
